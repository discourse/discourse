...
}))(a),s=n,d="[\\w-]+",c="("+d+"|@\\{"+d+"\\})",b=[],g=[],m=e=>({
className:"string",begin:"~?"+e+".*?"+e}),p=(e,r,t)=>({className:e,begin:r,
relevance:t}),u={$pattern:/[a-z-]+/,keyword:"and or not only",
attribute:r.join(" ")},h={begin:"\\(",end:"\\)",contains:g,keywords:u,
relevance:0}
;g.push(a.C_LINE_COMMENT_MODE,a.C_BLOCK_COMMENT_MODE,m("'"),m('"'),l.CSS_NUMBER_MODE,{
...
},l.IMPORTANT,{beginKeywords:"and not"},l.FUNCTION_DISPATCH);const f=g.concat({
begin:/\{/,end:/\}/,contains:b}),k={beginKeywords:"when",endsWithParent:!0,
contains:[{beginKeywords:"and not"}].concat(g)},v={begin:c+"\\s*:",
...
;return b.push(a.C_LINE_COMMENT_MODE,a.C_BLOCK_COMMENT_MODE,w,y,_,v,x,k,l.FUNCTION_DISPATCH),
