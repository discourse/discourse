...
},{match:/\b0b([01]_*)+\b/}]},O=(e="")=>({className:"subst",variants:[{
match:t(/\\/,e,/[0\\tnr"']/)},{match:t(/\\/,e,/u\{[0-9a-fA-F]{1,8}\}/)}]
}),L=(e="")=>({className:"subst",match:t(/\\/,e,/[\t ]*(?:[\r\n]|\r\n)/)
}),T=(e="")=>({className:"subst",label:"interpol",begin:t(/\\/,e,/\(/),end:/\)/
}),j=(e="")=>({begin:t(e,/"""/),end:t(/"""/,e),contains:[O(e),L(e),T(e)]
}),P=(e="")=>({begin:t(e,/"/),end:t(/"/,e),contains:[O(e),T(e)]}),K={
className:"string",
...
match:/\.\.\./,relevance:0},{match:t(/\s+&\s+/,a(y)),relevance:0}]},G={
begin:/</,end:/>/,keywords:k,contains:[...v,...B,...U,S,Z]};Z.contains.push(G)
;const V={begin:/\(/,end:/\)/,relevance:0,keywords:k,contains:["self",{
match:t(w,/\s*:/),keywords:"_|0",relevance:0
},...v,...B,..._,...M,I,K,...q,...U,Z]},W={begin:/</,end:/>/,contains:[...v,Z]
},R={begin:/\(/,end:/\)/,keywords:k,contains:[{
begin:n(a(t(w,/\s*:/)),a(t(w,/\s+/,w,/\s*:/))),end:/:/,relevance:0,contains:[{
className:"keyword",match:/\b_\b/},{className:"params",match:w}]
},...v,...B,...M,I,K,...U,Z,V],endsParent:!0,illegal:/["']/},X={
match:[/func/,/\s+/,n(z.match,w,b)],className:{1:"keyword",3:"title.function"},
contains:[W,R,d],illegal:[/\[/,/%/]},H={
match:[/\b(?:subscript|init[?!]?)/,/\s*(?=[<(])/],className:{1:"keyword"},
contains:[W,R,d],illegal:/\[|%/},J={match:[/operator/,/\s+/,b],className:{
...
},...B,..._,...M,I,K,...q,...U,Z,V]}}})();export default hljsGrammar;