...
!(function(e) {
  ...
  function v(e, n, t) {
      ...
      a +=
        ...
        f.map
          .call(e.attributes, function(e) {
            return (
              " " + e.nodeName + '="' + S(e.value).replace(/"/g, "&quot;") + '"'
            );
          })
          .join("") +
        ">";
    ...
    for (; e.length || n.length; ) {
      var s = o();
      if (((a += S(t.substring(r, s[0].offset))), (r = s[0].offset), s === e)) {
        for (
          i.reverse().forEach(l);
          u(s.splice(0, 1)[0]),
  ...
  function T(r) {
    ...
    function a(a) {
      ...
      for (var n = 0; n < a.c.length; n++) {
        var r,
          l = (r = a.c[n]).bK ? "\\.?(?:" + r.b + ")\\.?" : r.b;
        e(r, l);
      }
      a.tE && e("end", a.tE), a.i && e("illegal", a.i);
      var u = f(
        (function(e, n) {
          for (
            var t = /\[(?:[^\\\]]|\\.)*\]|\(\??|\\([1-9][0-9]*)|\\./,
  ...
  function w(n, e, a, t) {
    ...
    function r() {
      var e, n, t, r, a, i, o;
      if (!d.k) return S(M);
      for (r = "", n = 0, d.lR.lastIndex = 0, t = d.lR.exec(M); t; )
        (r += S(M.substring(n, t.index))),
          (a = d),
          (i = t),
          (o = E.cI ? i[0].toLowerCase() : i[0]),
          (e = a.k.hasOwnProperty(o) && a.k[o])
            ? ((b += e[1]), (r += c(e[0], S(t[0]))))
            : (r += S(t[0])),
          (n = d.lR.lastIndex),
          (t = d.lR.exec(M));
      return r + S(M.substr(n));
    }
    function o() {
      (p += (null != d.sL
        ? function() {
            var e = "string" == typeof d.sL;
            if (e && !C[d.sL]) return S(M);
            var n = e
              ? w(d.sL, M, !0, R[d.sL])
              : D(M, d.sL.length ? d.sL : void 0);
            return (
              0 < d.relevance && (b += n.relevance),
              e && (R[d.sL] = n.top),
    ...
    function u(e) {
      ...
      return (
        ...
        t.skip ? (M += n) : (t.eB && (M += n), o(), t.rB || t.eB || (M = n)),
        l(t),
        t.rB ? 0 : n.length
      );
    }
    function s(e) {
      ...
      if (r) {
        var a = d;
        for (
          a.skip ? (M += n) : (a.rE || a.eE || (M += n), o(), a.eE && (M = n));
          d.cN && (p += O),
            d.skip || d.sL || (b += d.relevance),
            (d = d.parent) !== r.parent;
    ...
    function g(e, n) {
      ...
      if (
        ...
        return (M += i.slice(n.index, n.index + 1)), 1;
    ...
    var E = L(n);
    if (!E)
      throw (console.error(B.replace("{}", n)),
      new Error('Unknown language: "' + n + '"'));
    T(E);
    for (var d = t || E, R = {}, p = "", v = d; v !== E; v = v.parent)
      v.cN && (p = c(v.cN, "", !0) + p);
    var M = "",
      b = 0;
    try {
      for (var h, N, _ = 0; (d.t.lastIndex = _), (h = d.t.exec(i)); )
        (N = g(i.substring(_, h.index), h)), (_ = h.index + N);
      for (g(i.substr(_)), v = d; v.parent; v = v.parent) v.cN && (p += O);
      return { relevance: b, value: p, i: !1, language: n, top: d };
    } catch (e) {
      if (e.message && -1 !== e.message.indexOf("Illegal"))
        return { i: !0, relevance: 0, value: S(i) };
      if (m)
        return {
          relevance: 0,
          value: S(i),
  ...
  function L(e) {
    return (e = (e || "").toLowerCase()), C[e] || C[g[e]];
  }
  function _(e) {
    var n = L(e);
