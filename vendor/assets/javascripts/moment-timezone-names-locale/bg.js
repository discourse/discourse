...
(function(global, factory) {
  ...
  moment.tz.localizedNames = function() {
    return [
      ...
      { value: "Africa/Asmera", name: "Асмара", id: "Africa/Asmera" },
      { value: "Africa/Bamako", name: "Бамако", id: "Africa/Bamako" },
      { value: "Africa/Bangui", name: "Бангуи", id: "Africa/Bangui" },
      { value: "Africa/Banjul", name: "Банджул", id: "Africa/Banjul" },
      { value: "Africa/Bissau", name: "Бисау", id: "Africa/Bissau" },
      { value: "Africa/Blantyre", name: "Блантайър", id: "Africa/Blantyre" },
      {
      ...
      { value: "Africa/Cairo", name: "Кайро", id: "Africa/Cairo" },
      {
      ...
      { value: "Africa/El_Aaiun", name: "Ел Аюн", id: "Africa/El_Aaiun" },
      { value: "Africa/Freetown", name: "Фрийтаун", id: "Africa/Freetown" },
      ...
      { value: "Africa/Mogadishu", name: "Могадишу", id: "Africa/Mogadishu" },
      ...
      { value: "America/Anchorage", name: "Анкъридж", id: "America/Anchorage" },
      { value: "America/Anguilla", name: "Ангуила", id: "America/Anguilla" },
      ...
      { value: "America/Boise", name: "Бойси", id: "America/Boise" },
      {
      ...
      { value: "America/Cayenne", name: "Кайен", id: "America/Cayenne" },
      {
      ...
      { value: "America/Creston", name: "Крестън", id: "America/Creston" },
      { value: "America/Cuiaba", name: "Чуяба", id: "America/Cuiaba" },
      ...
      { value: "America/Dawson", name: "Доусън", id: "America/Dawson" },
      {
        value: "America/Dawson_Creek",
        name: "Доусън Крийк",
        id: "America/Dawson_Creek"
      },
      { value: "America/Denver", name: "Денвър", id: "America/Denver" },
      { value: "America/Detroit", name: "Детройт", id: "America/Detroit" },
      { value: "America/Dominica", name: "Доминика", id: "America/Dominica" },
      { value: "America/Edmonton", name: "Едмънтън", id: "America/Edmonton" },
      ...
      { value: "America/Guayaquil", name: "Гуаякил", id: "America/Guayaquil" },
      { value: "America/Guyana", name: "Гаяна", id: "America/Guyana" },
      ...
      { value: "America/Jujuy", name: "Хухуй", id: "America/Jujuy" },
      ...
      { value: "America/New_York", name: "Ню Йорк", id: "America/New_York" },
      { value: "America/Nipigon", name: "Нипигон", id: "America/Nipigon" },
      { value: "America/Nome", name: "Ноум", id: "America/Nome" },
      { value: "America/Noronha", name: "Нороня", id: "America/Noronha" },
      {
      ...
      { value: "America/Regina", name: "Риджайна", id: "America/Regina" },
      { value: "America/Resolute", name: "Резолют", id: "America/Resolute" },
      {
      ...
      { value: "America/Santiago", name: "Сантяго", id: "America/Santiago" },
      {
      ...
      { value: "America/St_Kitts", name: "Сейнт Китс", id: "America/St_Kitts" },
      {
      ...
      { value: "America/Vancouver", name: "Ванкувър", id: "America/Vancouver" },
      {
        value: "America/Whitehorse",
        name: "Уайтхорс",
        id: "America/Whitehorse"
      },
      { value: "America/Winnipeg", name: "Уинипег", id: "America/Winnipeg" },
      ...
      { value: "Antarctica/Mawson", name: "Моусън", id: "Antarctica/Mawson" },
      {
        value: "Antarctica/McMurdo",
        name: "Макмърдо",
        id: "Antarctica/McMurdo"
      },
      { value: "Antarctica/Palmer", name: "Палмър", id: "Antarctica/Palmer" },
      ...
      { value: "Asia/Atyrau", name: "Атърау", id: "Asia/Atyrau" },
      ...
      { value: "Asia/Bangkok", name: "Банкок", id: "Asia/Bangkok" },
      ...
      { value: "Asia/Hong_Kong", name: "Хонконг", id: "Asia/Hong_Kong" },
      ...
      { value: "Asia/Jerusalem", name: "Йерусалим", id: "Asia/Jerusalem" },
      ...
      { value: "Asia/Kuching", name: "Кучин", id: "Asia/Kuching" },
      ...
      { value: "Asia/Nicosia", name: "Никозия", id: "Asia/Nicosia" },
      {
      ...
      { value: "Asia/Taipei", name: "Тайпе", id: "Asia/Taipei" },
      ...
      { value: "Asia/Vientiane", name: "Виентян", id: "Asia/Vientiane" },
      {
      ...
      { value: "Australia/Currie", name: "Къри", id: "Australia/Currie" },
      ...
      { value: "Australia/Perth", name: "Пърт", id: "Australia/Perth" },
      { value: "Australia/Sydney", name: "Сидни", id: "Australia/Sydney" },
      {
        value: "Etc/UTC",
        name: "Координирано универсално време",
        id: "Etc/UTC"
      },
      { value: "Europe/Amsterdam", name: "Амстердам", id: "Europe/Amsterdam" },
      { value: "Europe/Andorra", name: "Андора", id: "Europe/Andorra" },
      { value: "Europe/Astrakhan", name: "Астрахан", id: "Europe/Astrakhan" },
      ...
      { value: "Europe/Brussels", name: "Брюксел", id: "Europe/Brussels" },
      { value: "Europe/Bucharest", name: "Букурещ", id: "Europe/Bucharest" },
      { value: "Europe/Budapest", name: "Будапеща", id: "Europe/Budapest" },
      { value: "Europe/Busingen", name: "Бюзинген", id: "Europe/Busingen" },
      ...
      {
        value: "Europe/Dublin",
        name: "Ирландско стандартно времеДъблин",
        id: "Europe/Dublin"
      },
      { value: "Europe/Gibraltar", name: "Гибралтар", id: "Europe/Gibraltar" },
      { value: "Europe/Guernsey", name: "Гърнзи", id: "Europe/Guernsey" },
      { value: "Europe/Helsinki", name: "Хелзинки", id: "Europe/Helsinki" },
      {
      ...
      { value: "Europe/Jersey", name: "Джърси", id: "Europe/Jersey" },
      {
      ...
      {
        value: "Europe/London",
        name: "Британско лятно часово времеЛондон",
        id: "Europe/London"
      },
      {
      ...
      { value: "Europe/Skopje", name: "Скопие", id: "Europe/Skopje" },
      ...
      { value: "Europe/Ulyanovsk", name: "Уляновск", id: "Europe/Ulyanovsk" },
      ...
      { value: "Europe/Vienna", name: "Виена", id: "Europe/Vienna" },
      { value: "Europe/Vilnius", name: "Вилнюс", id: "Europe/Vilnius" },
      ...
      { value: "Indian/Christmas", name: "Рождество", id: "Indian/Christmas" },
      { value: "Indian/Cocos", name: "Кокосови острови", id: "Indian/Cocos" },
      { value: "Indian/Comoro", name: "Коморски острови", id: "Indian/Comoro" },
      { value: "Indian/Kerguelen", name: "Кергелен", id: "Indian/Kerguelen" },
      { value: "Indian/Mahe", name: "Мае", id: "Indian/Mahe" },
      { value: "Indian/Maldives", name: "Малдиви", id: "Indian/Maldives" },
      { value: "Indian/Mauritius", name: "Мавриций", id: "Indian/Mauritius" },
      { value: "Indian/Mayotte", name: "Майот", id: "Indian/Mayotte" },
      { value: "Indian/Reunion", name: "Реюнион", id: "Indian/Reunion" },
      { value: "Pacific/Apia", name: "Апия", id: "Pacific/Apia" },
      ...
      { value: "Pacific/Gambier", name: "Гамбие", id: "Pacific/Gambier" },
      {
      ...
      { value: "Pacific/Johnston", name: "Джонстън", id: "Pacific/Johnston" },
      {
        value: "Pacific/Kiritimati",
        name: "Киритимати",
        id: "Pacific/Kiritimati"
      },
      { value: "Pacific/Kosrae", name: "Кошрай", id: "Pacific/Kosrae" },
      {
      ...
      { value: "Pacific/Majuro", name: "Маджуро", id: "Pacific/Majuro" },
      {
        ...
        name: "Маркизки острови",
        id: "Pacific/Marquesas"
      },
      { value: "Pacific/Midway", name: "Мидуей", id: "Pacific/Midway" },
      ...
      { value: "Pacific/Ponape", name: "Понпей", id: "Pacific/Ponape" },
      {
      ...
      { value: "Pacific/Tarawa", name: "Тарауа", id: "Pacific/Tarawa" },
      {
        value: "Pacific/Tongatapu",
        name: "Тонгатапу",
        id: "Pacific/Tongatapu"
      },
      { value: "Pacific/Truk", name: "Чуюк", id: "Pacific/Truk" },
      { value: "Pacific/Wake", name: "Уейк", id: "Pacific/Wake" },
      { value: "Pacific/Wallis", name: "Уолис", id: "Pacific/Wallis" }
    ];
  };
