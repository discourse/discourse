(function() {
  ...
  (function(global) {
    ...
    Module.prototype.findDeps = function(pending) {
      ...
      for (var i = 0; i < deps.length; i++) {
        ...
        if (dep === "exports") {
          ...
          entry.module = findModule(
            resolve(dep, this.name),
            this.name,
            pending
          );
        }
    ...
    function missingModule(name, referrer) {
      throw new Error(
        "Could not find module `" + name + "` imported from `" + referrer + "`"
      );
    }
  ...
  define("ember-qunit", [
    ...
    exports,
    _emberQunitModuleFor,
    _emberQunitModuleForComponent,
    _emberQunitModuleForModel,
    _emberQunitAdapter,
    _emberTestHelpers,
    _qunit
  ) {
  ...
  define("ember-qunit/adapter", ["exports", "ember", "qunit"], function(
    exports,
    _ember,
    _qunit
  ) {
    ...
    exports["default"] = _ember["default"].Test.Adapter.extend({
      ...
      asyncStart: function asyncStart() {
        this.doneCallbacks.push(
          _qunit["default"].config.current
            ? _qunit["default"].config.current.assert.async()
            : null
        );
      },
      ...
      exception: function exception(error) {
        _qunit["default"].config.current.assert.ok(
          false,
          _ember["default"].inspect(error)
        );
      }
    });
  });
  define("ember-qunit/module-for-component", [
    ...
    "./qunit-module",
    "ember-test-helpers"
  ], function(exports, _qunitModule, _emberTestHelpers) {
    "use strict";

    exports["default"] = moduleForComponent;

    function moduleForComponent(name, description, callbacks) {
      _qunitModule.createModule(
        _emberTestHelpers.TestModuleForComponent,
        name,
        description,
        callbacks
      );
  ...
  define("ember-qunit/module-for-model", [
    ...
    function moduleForModel(name, description, callbacks) {
      _qunitModule.createModule(
        _emberTestHelpers.TestModuleForModel,
        name,
        description,
        callbacks
      );
    ...
    function createModule(Constructor, name, description, callbacks) {
      ...
      _qunit.module(moduleName, {
        ...
        beforeEach: function beforeEach() {
          ...
          return (_module2 = module).setup
            .apply(_module2, arguments)
            .then(function() {
  ...
  define("ember-test-helpers", [
    "exports",
    "ember",
    "ember-test-helpers/test-module",
    "ember-test-helpers/test-module-for-acceptance",
    "ember-test-helpers/test-module-for-integration",
    "ember-test-helpers/test-module-for-component",
    "ember-test-helpers/test-module-for-model",
    "ember-test-helpers/test-context",
    "ember-test-helpers/test-resolver"
  ], function(
    exports,
    _ember,
    _emberTestHelpersTestModule,
    _emberTestHelpersTestModuleForAcceptance,
    _emberTestHelpersTestModuleForIntegration,
    _emberTestHelpersTestModuleForComponent,
    _emberTestHelpersTestModuleForModel,
    _emberTestHelpersTestContext,
    _emberTestHelpersTestResolver
  ) {
    "use strict";
    ...
    exports.TestModuleForAcceptance =
      _emberTestHelpersTestModuleForAcceptance["default"];
    exports.TestModuleForIntegration =
      _emberTestHelpersTestModuleForIntegration["default"];
    exports.TestModuleForComponent =
      _emberTestHelpersTestModuleForComponent["default"];
  ...
  define("ember-test-helpers/-legacy-overrides", [
    "exports",
    "ember",
    "./has-ember-version"
  ], function(exports, _ember, _hasEmberVersion) {
    "use strict";
    ...
    function preGlimmerSetupIntegrationForComponent() {
      ...
      context.dispatcher =
        ...
        _ember["default"].EventDispatcher.create();
      ...
      context.send = function(actionName) {
        ...
        if (!hook) {
          throw new Error(
            "integration testing template received unexpected action " +
              actionName
          );
        }
  ...
  define("ember-test-helpers/abstract-test-module", [
    "exports",
    "./wait",
    "./test-context",
    "ember"
  ], function(exports, _wait, _testContext, _ember) {
    "use strict";
    ...
    var _default = (function() {
      ...
      _default.prototype.setup = function setup(assert) {
        ...
        return this.invokeSteps(this.setupSteps, this, assert).then(function() {
          ...
          return _this.invokeSteps(
            _this.contextualizedSetupSteps,
            _this.context,
            assert
          );
        });
      ...
      _default.prototype.invokeSteps = function invokeSteps(
        steps,
        context,
        assert
      ) {
  ...
  define("ember-test-helpers/build-registry", [
    "exports",
    "require",
    "ember"
  ], function(exports, _require, _ember) {
    ...
    var Owner = (function() {
      if (
        _ember["default"]._RegistryProxyMixin &&
        _ember["default"]._ContainerProxyMixin
      ) {
    ...
    exports["default"] = function(resolver) {
      ...
      if (_ember["default"].Application.buildRegistry) {
        fallbackRegistry = _ember["default"].Application.buildRegistry(
          namespace
        );
        fallbackRegistry.register(
          "component-lookup:main",
          _ember["default"].ComponentLookup
        );
        ...
        if (
          _ember["default"].ApplicationInstance &&
          _ember["default"].ApplicationInstance.setupRegistry
        ) {
      ...
      if (requirejs.entries["ember-data/setup-container"]) {
        ...
        var setupContainer = _require["default"]("ember-data/setup-container")[
          "default"
        ];
  ...
  define("ember-test-helpers/has-ember-version", ["exports", "ember"], function(
    exports,
    _ember
  ) {
    "use strict";
  ...
  define("ember-test-helpers/test-module-for-acceptance", [
    "exports",
    "./abstract-test-module",
    "ember",
    "./test-context"
  ], function(exports, _abstractTestModule, _ember, _testContext) {
    "use strict";
  ...
  define("ember-test-helpers/test-module-for-component", [
    ...
    var _default = (function(_TestModule) {
      ...
      _default.prototype.setupComponentIntegrationTest = function setupComponentIntegrationTest() {
        if (isPreGlimmer) {
          return _legacyOverrides.preGlimmerSetupIntegrationForComponent.apply(
            this,
            arguments
          );
        } else {
    ...
    function _setupComponentIntegrationTest() {
      ...
      context.$ = function(selector) {
        ...
        return selector
          ? _ember["default"].$(selector, element)
          : _ember["default"].$(element);
      };
  ...
  define("ember-test-helpers/test-module-for-integration", [
    "exports",
    "ember",
    "./abstract-test-module",
    "./test-resolver",
    ...
    var _default = (function(_AbstractTestModule) {
      ...
      _default.prototype.setupComponentIntegrationTest = function setupComponentIntegrationTest() {
        if (isPreGlimmer) {
          ...
          return _testModuleForComponent.setupComponentIntegrationTest.apply(
            this,
            arguments
          );
        }
      ...
      _default.prototype._contextualizeCallback = function _contextualizeCallback(
        context,
        key,
        callbackContext
      ) {
  ...
  define("ember-test-helpers/test-module-for-model", [
    ...
    "./test-module",
    "ember"
  ], function(exports, _require, _testModule, _ember) {
      ...
      _default.prototype.setupModel = function setupModel() {
        ...
        if (!adapterFactory) {
          if (requirejs.entries["ember-data/adapters/json-api"]) {
            adapterFactory = _require["default"](
  ...
  define("ember-test-helpers/test-module", [
    ...
    var _default = (function(_AbstractTestModule) {
            ...
            context.inject[typeName] = function(name, opts) {
              ...
              _ember["default"].run(function() {
                _ember["default"].set(
                  context,
                  alias,
                  module.container.lookup(typeName + ":" + name)
                );
              });
            };
          });
      ...
      _default.prototype.defaultSubject = function defaultSubject(
        options,
        factory
      ) {
    ...
    */
      ...
      _default.prototype._buildDeprecatedContext = function _buildDeprecatedContext(
        module,
        context
      ) {
        ...
        for (var i = 0, l = keysForDeprecation.length; i < l; i++) {
          this._proxyDeprecation(
            module,
            deprecatedContext,
            keysForDeprecation[i]
          );
        }
    ...
    */
      ...
      _default.prototype._proxyDeprecation = function _proxyDeprecation(
        obj,
        proxy,
        key
      ) {
      ...
      _default.prototype._setupContainer = function _setupContainer(isolated) {
        ...
        var items = _buildRegistry["default"](
          !isolated
            ? resolver
  ...
  define("ember-test-helpers/wait", ["exports", "ember"], function(
    exports,
    _ember
  ) {
    /* globals self */
    ...
    if (_ember["default"].__loader.registry["ember-testing/test/waiters"]) {
      _internalCheckWaiters = _ember["default"].__loader.require(
    ...
    function checkWaiters() {
      if (_internalCheckWaiters) {
        ...
        if (
          _ember["default"].Test.waiters.any(function(_ref) {
            var context = _ref[0];
            var callback = _ref[1];
    ...
    function wait(_options) {
      ...
      return new _ember["default"].RSVP.Promise(function(resolve) {
        var watcher = self.setInterval(function() {
          if (
            waitForTimers &&
            (_ember["default"].run.hasScheduledTimers() ||
              _ember["default"].run.currentRunLoop)
          ) {
            return;
          }
