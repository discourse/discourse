...
system "cp -n .vscode/settings.json.sample .vscode/settings.sample.json", exception: true
system "cp -n .vscode/tasks.json.sample .vscode/tasks.sample.json", exception: true
