  ...
  describe "#select" do
    ...
    context "while in a tutorial track" do
      ...
      context "when bot is mentioned" do
        it "selects the expected track" do
    ...
    context "when at the end of a tutorial track" do
      ...
      context "with generic replies" do
        ...
        it "creates the expected generic misunderstanding responses" do
          described_class.new(:reply, user, post_id: post.id).select
          new_post = Post.last
      ...
      it "creates the expected reply" do
      ...
      context "as an admin or moderator" do
        it "includes the commands that start the advanced user track" do
      ...
      context "when discobot is asked to roll dice" do
        ...
        it "returns results for a valid dice request" do
        ...
        it "limits the number of requested dice" do
        ...
        it "rejects an invalid dice combination" do
    ...
    context "when in a normal PM with discobot" do
      context "when discobot is replied to" do
        ...
        it "does not rate-limit the help message" do
    ...
    context "with random discobot mentions" do
      ...
      it "matches discobot's username case-insensitively" do
      ...
      context "with rate limiting random reply message in public topic" do
        ...
        it "does not reply while the rate limit is active" do
          Discourse.redis.set(
        ...
        it "does not reply after a recent reply in the topic" do
      ...
      context "when new and advanced user triggers overlap" do
        ...
        it "starts the expected track" do
          post.update!(
            raw:
