...
describe GithubLinkback do
  ...
  describe "#create" do
    ...
    context "with an access token" do
      ...
      it "creates linkbacks when the URL count is within the limit" do
      ...
      it "skips linkbacks when the URL count exceeds the limit" do
      ...
      it "counts unique URLs when applying the linkback limit" do
        SiteSetting.github_linkback_maximum_links = 1
