...
describe Topic do
  ...
  describe "validations" do
    describe "#subtype" do
      it "rejects Post Voting topics when post_voting_enabled is disabled" do
      ...
      it "rejects changing an existing topic to the Post Voting subtype" do
      ...
      it "allows the Post Voting subtype only on regular topics" do
        topic =
          Fabricate.build(:topic, archetype: Archetype.default, subtype: Topic::POST_VOTING_SUBTYPE)
  ...
  it "returns the topic's comments" do
  ...
  it "returns the topic's answers" do
