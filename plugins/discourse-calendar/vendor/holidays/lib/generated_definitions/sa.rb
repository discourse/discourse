...
module Holidays
  ...
  module SA # :nodoc:
    ...
    def self.holidays_by_month
      ...
      3 => [{:mday => 19, :year_ranges => { :limited => [2026] },:name => "Festival of Breaking the Fast", :regions => [:sa]},
            {:mday => 20, :year_ranges => { :limited => [2026] },:name => "Second Day of the Festival of Breaking the Fast", :regions => [:sa]},
            {:mday => 21, :year_ranges => { :limited => [2026] },:name => "Third Day of the Festival of Breaking the Fast", :regions => [:sa]},
            {:mday => 30, :year_ranges => { :limited => [2025] },:name => "Festival of Breaking the Fast", :regions => [:sa]},
