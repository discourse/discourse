  ...
  class Executor
    module FilterParameter
      ...
      class << self
        ...
        def execute_filter_condition(condition, options, resolver)
        ...
        def evaluate_type(type, left, right, operation, options)
        ...
        def compare_ordered_strings(left, right, operation)
        ...
        def compare_values(left, right, operation)
          case operation
          when "equals"
            left == right
          when "notEquals"
