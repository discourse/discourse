...
module DiscourseWorkflows
  module Item
    ...
    class << self
      def wrap(data = nil, paired_item: nil, **keyword_data)
      ...
      def normalize_items(execution_data)
      ...
      def normalize_paired_item(paired_item)
        case paired_item
        when Array
      ...
      def normalize_paired_item_entry(entry)
        entry.deep_stringify_keys.compact
      end

      def normalize_item_result(result)
