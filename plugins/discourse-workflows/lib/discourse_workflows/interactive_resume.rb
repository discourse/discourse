...
module DiscourseWorkflows
  class InteractiveResume
    ...
    class << self
      def action_id(execution_id:, resume_token:, action:, target_user_id: nil)
      ...
      def action_id?(action_id, expected_node_type:, allowed_actions:)
        from_action_id(
          action_id,
      ...
      def from_action_id(action_id, expected_node_type:, allowed_actions:)
