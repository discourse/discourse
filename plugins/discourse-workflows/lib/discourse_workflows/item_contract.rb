...
module DiscourseWorkflows
  module ItemContract
    ...
    class << self
      ...
      def validate_output_arrays!(result, source:, ports: nil)
      ...
      def validate_paired_item!(item, source:)
      ...
      def validate_item_keys!(item, source:)
      ...
      def valid_paired_item_entry?(entry)
