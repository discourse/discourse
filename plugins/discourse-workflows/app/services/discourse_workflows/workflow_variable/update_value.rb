...
module DiscourseWorkflows
  class WorkflowVariable::UpdateValue
    ...
    lock(:workflow_id) do
      model :workflow
      model :variable
      policy :value_is_valid, class_name: WorkflowVariable::Policy::ValueIsValid
      model :draft_was_clean, :capture_draft_was_clean, optional: true

      transaction do
        model :variable, :save_value
    ...
    def save_value(variable:, params:)
      variable.tap { |v| v.update(value: params.value) }
    end
