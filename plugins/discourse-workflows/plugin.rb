...
after_initialize do
  reloadable_patch do
    %w[
      ...
      DiscourseWorkflows::Registry.register_trigger(DiscourseWorkflows::Triggers.const_get(name))
    end
    ...
    %w[
      ...
      DiscourseWorkflows::Registry.register_action(DiscourseWorkflows::Actions.const_get(name))
    end

    %w[IfCondition Filter].each do |name|
      DiscourseWorkflows::Registry.register_condition(
        DiscourseWorkflows::Conditions.const_get(name),
      )
    end
