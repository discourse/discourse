...
RSpec.describe DiscourseWorkflows::ExpressionContextSchema do
  describe ".to_hash" do
    ...
    it "declares $helpers, $site_settings, $vars, $workflow_vars, $current_user, $execution as environment symbols" do
  ...
  describe "backend alignment" do
    ...
    it "JsSandbox exposes core environment symbols" do
      ...
      sandbox_symbols = %w[$site_settings $vars $workflow_vars $current_user $helpers]
