...
RSpec.describe DiscourseWorkflows::WorkflowSettingField::Destroy do
  ...
  describe ".call" do
    ...
    let(:params) { { workflow_id: workflow.id, setting_field_id: setting_field.id } }
    ...
    context "when everything's ok" do
      ...
      it "destroys the setting field" do
      ...
      it "logs a staff action" do
        ...
        expect(UserHistory.last).to have_attributes(
          custom_type: "discourse_workflows_setting_field_destroyed",
          subject: "priority",
        )
      end
