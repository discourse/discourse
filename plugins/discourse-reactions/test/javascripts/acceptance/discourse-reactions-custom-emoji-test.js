  ...
  acceptance(
    ...
    function (needs) {
      ...
      needs.settings({
        ...
        discourse_reactions_allow_choose_more: true,
      ...
      test("Shows EmojiPicker button when discourse_reactions_allow_choose_more is enabled", async function (assert) {
      ...
      test("Selected custom emoji is added to reactions when discourse_reactions_allow_choose_more is enabled", async function (assert) {
        await visit("/t/topic_with_reactions_and_likes/374");
        await triggerEvent(
          "#post_2 button.btn-toggle-reaction-like",
          "pointerover",
  ...
  acceptance(
    ...
    function (needs) {
      ...
      needs.settings({
        ...
        discourse_reactions_reaction_for_like: "heart",
        discourse_reactions_like_icon: "heart",
        discourse_reactions_allow_choose_more: false,
        glimmer_post_stream_mode: postStreamMode,
      });
      ...
      test("Does not show EmojiPicker button when discourse_reactions_allow_choose_more is disabled", async function (assert) {
        await visit("/t/topic_with_reactions_and_likes/374");
        await triggerEvent(
          "#post_2 button.btn-toggle-reaction-like",
          "pointerover",
