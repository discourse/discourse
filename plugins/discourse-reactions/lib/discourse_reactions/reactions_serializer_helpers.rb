...
module DiscourseReactions::ReactionsSerializerHelpers
  class << self
    def preload_post_reactions(posts, user)
    ...
    def reactions_for_post(post, scope = nil)
    ...
    def current_user_reaction_for_post(post, scope)
    ...
    def reaction_users_count_for_post(post, scope = nil)
    ...
    def like_action_for_post(post, scope)
    ...
    def current_user_used_main_reaction_for_post(post, scope)
    ...
    def op_reactions_data_for_topic(topic, scope)
