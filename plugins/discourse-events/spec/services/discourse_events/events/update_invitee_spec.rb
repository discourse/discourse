...
RSpec.describe(DiscourseEvents::Events::UpdateInvitee) do
  ...
  describe ".call" do
    ...
    context "when event creator updates another user's invitee" do
      ...
      it "updates the invitee status" do
        ...
        ).to(DiscourseEvents::Events::Invitee.statuses[:not_going])
      end
    end
    ...
    context "when everything is valid" do
      ...
      it "updates the invitee status" do
        expect { result }.to change { invitee.reload.status }.from(
          DiscourseEvents::Events::Invitee.statuses[:going],
        ).to(DiscourseEvents::Events::Invitee.statuses[:interested])
      end
    end
  end
end
