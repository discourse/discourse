...
RSpec.describe(DiscourseEvents::Events::ListInvitees) do
  ...
  describe ".call" do
    ...
    before do
      ...
      event.create_invitees(
        [
          { user_id: francis.id, status: DiscourseEvents::Events::Invitee.statuses[:going] },
          { user_id: francisco.id, status: DiscourseEvents::Events::Invitee.statuses[:interested] },
          { user_id: frank.id, status: DiscourseEvents::Events::Invitee.statuses[:not_going] },
          { user_id: franchesca.id, status: DiscourseEvents::Events::Invitee.statuses[:going] },
        ],
      )
    end
