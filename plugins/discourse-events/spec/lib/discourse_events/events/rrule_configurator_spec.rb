...
describe DiscourseEvents::Events::RRuleConfigurator do
  let(:time) { Time.now }
  ...
  describe ".rule" do
    context "with every_day recurrence" do
      it "generates the correct rule" do
        rule =
          DiscourseEvents::Events::RRuleConfigurator.rule(recurrence: "every_day", starts_at: time)
    ...
    context "with every_week recurrence (default)" do
      it "generates the correct rule" do
        rule =
          DiscourseEvents::Events::RRuleConfigurator.rule(recurrence: "every_week", starts_at: time)
