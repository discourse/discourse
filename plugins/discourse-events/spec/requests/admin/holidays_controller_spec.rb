      ...
      context "when the calendar plugin is enabled" do
        ...
        context "when an admin is signed in" do
          ...
          it "disables the holiday in the specified region and returns a 200 status code" do
            ...
            disabled_holiday = DiscourseEvents::Holidays::DisabledHoliday.last
      ...
      context "when the calendar plugin is enabled" do
        ...
        context "when an admin is signed in" do
          ...
          context "when there is a disabled holiday" do
            ...
            before { DiscourseEvents::Holidays::DisabledHoliday.create!(hong_kong_labour_day) }

            it "enables a holiday (by deleting its 'disabled' record) and returns a 200 status code" do
              expect(DiscourseEvents::Holidays::DisabledHoliday.count).to eq(1)
              ...
              expect(DiscourseEvents::Holidays::DisabledHoliday.count).to eq(0)
              expect(response.status).to eq(200)
            end
          end
