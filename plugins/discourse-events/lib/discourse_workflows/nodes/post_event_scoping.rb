...
if defined?(DiscourseWorkflows)
  module DiscourseWorkflows
    module Nodes
      # Shared filtering and payload building for the post event triggers.
      # Including classes must define a private `event` returning the
      # DiscoursePostEvent::Event the trigger fired for.
      module PostEventScoping
        ...
        def stats_data
          serialize_record(event, ::DiscoursePostEvent::EventStatsSerializer)
        end
      end
    end
  end
