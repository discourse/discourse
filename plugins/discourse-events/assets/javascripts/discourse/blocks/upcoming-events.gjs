...
/** @type {import("discourse/plugins/discourse-events/discourse/components/upcoming-events-list-view.gjs")} */
...
/**
 * Block registration for the events plugin's upcoming events
