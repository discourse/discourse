...
module Holidays
  ...
  module US # :nodoc:
    def self.defined_regions
      [:us_la, :us_ct, :us_de, :us_ga, :us_hi, :us_in, :us_ky, :us_nj, :us_nc, :us_nd, :us_pr, :us_tn, :us, :us_il, :us_vt, :us_ak, :us_ca, :us_dc, :us_me, :us_ma, :us_al, :us_ms, :us_ne, :us_mo, :us_sc, :us_wv, :us_ut, :us_ri, :us_nv, :us_ny, :us_nm, :us_md, :us_fl, :us_ia, :us_ks, :us_mi, :us_mn, :us_nh, :us_ok, :us_or, :us_pa, :us_tx, :us_va, :us_wa, :us_ar, :us_wi, :ca]
    end
    ...
    def self.holidays_by_month
      ...
      11 => [{:mday => 3, :name => "Election Day", :regions => [:us_il, :us_la, :us_ny]},
      ...
      12 => [{:mday => 24, :name => "Christmas Eve Day", :regions => [:us_ar, :us_ks, :us_mi, :us_nc, :us_sc, :us_tx, :us_wi]},
