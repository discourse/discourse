...
module DiscourseEvents
  class InviteesController < BaseController
    ...
    def index
      DiscourseEvents::Events::ListInvitees.call(
        params: {
        ...
        on_success do |invitees:, suggested_users:|
          render json: Events::InviteeListSerializer.new(invitees:, suggested_users:)
        end
    ...
    def update
      DiscourseEvents::Events::UpdateInvitee.call(
        ...
        on_success { |invitee:| render json: Events::InviteeSerializer.new(invitee) }
