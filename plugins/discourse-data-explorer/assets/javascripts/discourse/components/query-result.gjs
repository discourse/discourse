...
const CHART_FORMS = ["line", "bar", "stacked"];
...
export default class QueryResult extends Component {
  ...
  get defaultChartForm() {
    if (this.isMultiSeries) {
      return this.hasDates ? "stacked" : "bar";
    }
    return this.hasDates ? "line" : "bar";
  }

  get availableChartForms() {
    return this.isMultiSeries ? CHART_FORMS : ["line", "bar"];
  }
  ...
  get chartType() {
    return this.chartForm === "line" ? "line" : "bar";
  }
