...
module DiscourseDataExplorer
  module JsonapiRb
    ...
    #
    # Deep nested includes *and* the conditional-linkage perf optimization, together, require
    # this small owned patch. Verbatim copy of the gem's method with one changed line (safe to
    # own — the gem is dormant/frozen). See docs/api-modernization-exploration.md, Part 9.
