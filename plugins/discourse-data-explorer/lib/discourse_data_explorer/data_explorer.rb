...
module DiscourseDataExplorer
  module DataExplorer
    ...
    class << self
      ...
      def run_query_with_values(query, values = {}, opts = {})
        # Safety checks
      ...
      def rewrite_to_binds(sql, params, bind_oid_hints = {})
      ...
      def add_extra_data(pg_result, guardian: nil)
        needed_classes = {}
        ret = {}
        col_map = {}
      ...
      def placeholders_for(value, binds, oid_hint)
        if value.is_a?(Array)
      ...
      def bind_for(value, oid_hint = nil)
        case value
        when Integer
