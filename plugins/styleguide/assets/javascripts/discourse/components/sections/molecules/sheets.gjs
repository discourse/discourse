...
export default class Sheets extends Component {
  ...
  @tracked controlledSheetPresented = false;
  ...
  @action
  setControlledSheetPresented(value) {
    this.controlledSheetPresented = value;
  }
  ...
  <template>
    <StyleguideExample @title="Sheets">
      ...
      <StyleguideComponent @tag="controlled">
        <:sample>
          <DButton
            class="btn-default"
            @action={{fn this.setControlledSheetPresented true}}
          >Open Controlled Bottom Sheet</DButton>
          <DBottomSheet
            @presented={{this.controlledSheetPresented}}
            @onPresentedChange={{this.setControlledSheetPresented}}
            as |bs|
          >
            <bs.Content as |content|>
              <p>Controlled bottom sheet content here</p>
              <content.Trigger @action="dismiss">Close</content.Trigger>
            </bs.Content>
          </DBottomSheet>
        </:sample>
                ...
                <nested.Content as |nestedContent|>
                  ...
                  <nestedContent.Stack as |deepNested|>
                    ...
                    <deepNested.Content as |deepNestedContent|>
                      ...
                      <deepNestedContent.Trigger @action="dismiss">Close Deep
                        Nested</deepNestedContent.Trigger>
                    </deepNested.Content>
                  </nestedContent.Stack>
