...
const UserAbout = <template><StyleguideExample @title=".user-main .about.collapsed-info.no-background">
    ...
    <section class="about no-background">
        ...
        <div class="primary">
          ...
          <div class="primary-textual">
            ...
            <h3>
              ...
              {{@dummy.user.location}}
              {{icon "globe"}}
              <a href={{@dummy.user.website}} rel="nofollow noopener noreferrer" target="_blank">
      ...
      <div class="secondary">
        <dl>
          ...
          <DButton @icon="triangle-exclamation" @label="user.admin_delete" class="btn-danger" />
        </dl>
      </div>
    </section>
  </section>
