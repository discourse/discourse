...
<StyleguideExample @title=".btn-text - sizes (large, default, small)">
  {{#each @dummy.buttonSizes as |bs|}}
    <DButton @translatedLabel={{bs.text}} @disabled={{bs.disabled}} class={{bs.class}} />
  {{/each}}
</StyleguideExample>
...
<StyleguideExample @title=".btn-default .btn-icon-text - sizes (large, default, small)">
  {{#each @dummy.buttonSizes as |bs|}}
    <DButton @icon="plus" @translatedLabel={{bs.text}} @disabled={{bs.disabled}} class={{bs.class}} />
  {{/each}}
</StyleguideExample>
...
<StyleguideExample @title=".btn-primary .btn-icon-text - sizes (large, default, small)">
  {{#each @dummy.buttonSizes as |bs|}}
    <DButton @icon="plus" @translatedLabel={{bs.text}} @disabled={{bs.disabled}} class={{concatClass "btn-primary" bs.class}} />
  {{/each}}
</StyleguideExample>
...
<StyleguideExample @title=".btn-danger .btn-icon-text - sizes (large, default, small)">
  {{#each @dummy.buttonSizes as |bs|}}
    <DButton @icon="trash-can" @translatedLabel={{bs.text}} @disabled={{bs.disabled}} class={{concatClass "btn-danger" bs.class}} />
  {{/each}}
</StyleguideExample>
...
<StyleguideExample @title=".btn-flat - sizes (large, default, small)">
  {{#each @dummy.buttonSizes as |bs|}}
    <FlatButton @icon="trash-can" @disabled={{bs.disabled}} @translatedTitle={{bs.title}} />
  {{/each}}
</StyleguideExample>
...
<StyleguideExample @title="<DButton> btn-flat btn-text - sizes (large, default, small)">
  {{#each @dummy.buttonSizes as |bs|}}
    <DButton @disabled={{bs.disabled}} @translatedLabel={{bs.text}} class={{concatClass "btn-flat" bs.class}} />
  {{/each}}
</StyleguideExample>
...
<StyleguideExample @title="<DToggleSwitch>">
  <DToggleSwitch @state={{@dummy.toggleSwitchState}} {{on "click" (fn (mut @dummy.toggleSwitchState) (not @dummy.toggleSwitchState))}} />
