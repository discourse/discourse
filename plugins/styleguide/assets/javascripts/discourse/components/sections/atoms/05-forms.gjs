...
<StyleguideExample @title="Input">
  <Form as |form|>
    ...
    <form.Field @title="Secret" @name="secret" @description="An important password" as |field|>
      <field.Password />
    </form.Field>
  </Form>
</StyleguideExample>
...
<StyleguideExample @title="CheckboxGroup">
  <Form as |form|>
    <form.CheckboxGroup @title="I give explicit permission" as |checkboxGroup|>
      <checkboxGroup.Field @title="Use my email for any purpose." @name="contract" as |field|>
        <field.Checkbox>Including signing up for services I can't unsubscribe
          to.</field.Checkbox>
      </checkboxGroup.Field>
      <checkboxGroup.Field @title="Sign my soul away." @name="contract2" as |field|>
...
<StyleguideExample @title="Collection">
  <Form @data={{hash foo=(array (hash bar=1 baz=2) (hash bar=3 baz=4))}} as |form|>
...
<StyleguideExample @title="Row/Col">
  <Form as |form|>
    <form.Row as |row|>
      <row.Col @size={{6}}>
        <form.Field @title="Username" @name="username" @validation="required" as |field|>
          <field.Input />
        </form.Field>
      </row.Col>
      <row.Col @size={{4}}>
