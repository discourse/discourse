  ...
  class RoomHashtagDataSource
    class << self
      ...
      def find_by_ids(guardian, ids)
        visible_rooms(guardian, Voice::Room.where(id: ids)).map do |room|
      ...
      def visible_rooms(guardian, scope)
        scope
