...
RSpec.describe DiscourseChatIntegration::Manager do
  ...
  describe ".process_command" do
    describe "add new rule" do
      ...
      it "adds a new category rule" do
      ...
      it "supports all four filter types" do
        response =
      ...
      context "with tags enabled" do
        ...
        it "supports a category with multiple tags" do
          response =
    ...
    describe "help command" do
      it "returns the help response" do
    ...
    describe "status command" do
      it "returns the channel status" do
    ...
    describe "unknown command" do
      it "returns the unknown-command response" do
