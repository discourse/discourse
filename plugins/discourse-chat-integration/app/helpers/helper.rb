...
module DiscourseChatIntegration
  module Helper
    class << self
      def process_command(channel, tokens)
      ...
      def status_for_channel(channel)
      ...
      def delete_by_index(channel, index)
        rules = channel.rules.order_by_precedence
      ...
      def smart_create_rule(channel:, filter:, category_id: nil, tags: nil)
      ...
      def formatted_display_name(user)
