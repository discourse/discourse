  ...
  module Provider
    module TelegramProvider
      ...
      class << self
        ...
        def setup_webhook(access_token, new_secret)
          webhook_message = {
        ...
        def parse_base_url(value)
          ...
          if uri.is_a?(URI::HTTPS) && uri.host.present? && uri.userinfo.blank? &&
        ...
        def do_api_request(method_name, message, access_token: nil)
