...
module DiscourseSolved
  module SchemaUtils
    ...
    class << self
      ...
      def post_answer_meta(post, topic)
      ...
      def main_entity_meta(topic, crawler_posts)
