...
export default class SettingConditionEditor extends Component {
  ...
  <template>
    <div
      class="visual-editor-condition-editor visual-editor-condition-editor--setting"
    >
      <div class="visual-editor-condition-editor__field">
        <span class="visual-editor-condition-editor__legend">
          {{i18n
            "visual_editor.inspector.conditions.setting_editor.name_legend"
          }}
        </span>
        <input
          type="text"
          list="ve-setting-names"
          value={{@leaf.name}}
          placeholder={{i18n
            "visual_editor.inspector.conditions.setting_editor.name_placeholder"
          }}
          {{on "input" this.setName}}
        />
        <datalist id="ve-setting-names">
      ...
      <div class="visual-editor-condition-editor__field">
        <span class="visual-editor-condition-editor__legend">
          {{i18n
            "visual_editor.inspector.conditions.setting_editor.operator_legend"
          }}
        </span>
        <div
      ...
      {{#if (eq this.currentOperator "enabled")}}
        <div class="visual-editor-condition-editor__field">
          <span class="visual-editor-condition-editor__legend">
            {{i18n
              "visual_editor.inspector.conditions.setting_editor.value_legend"
            }}
          </span>
          <div
            class="visual-editor-condition-editor__segmented"
      ...
      {{else}}
        <div class="visual-editor-condition-editor__field">
          ...
          <textarea
            ...
            rows="3"
            placeholder={{i18n
              "visual_editor.inspector.conditions.setting_editor.value_list_placeholder"
            }}
          ...
          <span class="visual-editor-condition-editor__help">
            {{i18n
              "visual_editor.inspector.conditions.setting_editor.value_list_help"
            }}
          </span>
        </div>
      {{/if}}
