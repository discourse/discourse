# discourse-visual-editor

Drag-and-drop visual editor for the Discourse UI, built on the Blocks system. Lets permitted users compose Block Outlet layouts without writing code, with the resulting layouts persisted as theme fields.
...
- `visual_editor_enabled` — master switch (default: off).
- `visual_editor_allowed_groups` — groups whose members can use the editor (default: admins). Admins always have access regardless.
