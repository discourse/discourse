...
export default class ConditionLeafArgs extends Component {
  ...
  <template>
    <div class="visual-editor-condition-leaf-args">
      {{#each this.argRows as |row|}}
        <label class="visual-editor-condition-leaf-args__row">
          <span class="visual-editor-condition-leaf-args__name">
            {{row.name}}
      ...
      {{else}}
        <p class="visual-editor-condition-leaf-args__no-args">
