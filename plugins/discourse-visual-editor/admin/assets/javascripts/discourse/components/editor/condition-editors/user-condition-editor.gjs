...
export default class UserConditionEditor extends Component {
  ...
  <template>
    <div
      class="visual-editor-condition-editor visual-editor-condition-editor--user"
    >
      <div class="visual-editor-condition-editor__field">
        <span class="visual-editor-condition-editor__legend">
          {{i18n "visual_editor.inspector.conditions.user_editor.login_legend"}}
        </span>
        <div
      ...
      <div class="visual-editor-condition-editor__field">
        <span class="visual-editor-condition-editor__legend">
          {{i18n "visual_editor.inspector.conditions.user_editor.role_legend"}}
        </span>
        <div class="visual-editor-condition-editor__check-row">
          <label class="visual-editor-condition-editor__check">
            <input
              type="checkbox"
              checked={{@leaf.admin}}
            ...
            />
            <span>{{i18n
                "visual_editor.inspector.conditions.user_editor.admin"
              }}</span>
          </label>
          <label class="visual-editor-condition-editor__check">
            <input
            ...
            />
            <span>{{i18n
                "visual_editor.inspector.conditions.user_editor.moderator"
              }}</span>
          </label>
          <label class="visual-editor-condition-editor__check">
            <input
            ...
            />
            <span>{{i18n
                "visual_editor.inspector.conditions.user_editor.staff"
              }}</span>
          </label>
        </div>
      </div>
      ...
      <div class="visual-editor-condition-editor__field">
        <span class="visual-editor-condition-editor__legend">
          {{i18n "visual_editor.inspector.conditions.user_editor.trust_legend"}}
        </span>
        <div class="visual-editor-condition-editor__pair">
          <label class="visual-editor-condition-editor__pair-cell">
            <span>{{i18n
                "visual_editor.inspector.conditions.user_editor.trust_min"
              }}</span>
          ...
          <label class="visual-editor-condition-editor__pair-cell">
            <span>{{i18n
                "visual_editor.inspector.conditions.user_editor.trust_max"
              }}</span>
      ...
      <div class="visual-editor-condition-editor__field">
        <span class="visual-editor-condition-editor__legend">
          {{i18n "visual_editor.inspector.conditions.user_editor.groups_label"}}
        </span>
        <GroupChooser
          ...
          @options={{hash
            filterPlaceholder="visual_editor.inspector.conditions.user_editor.groups_placeholder"
          }}
        />
      </div>
    </div>
