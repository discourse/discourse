...
import {
  ...
  isFieldVisible,
  schemaToFields,
} from "discourse/plugins/discourse-visual-editor/discourse/lib/schema-to-fields";

module("Unit | Discourse Visual Editor | schemaToFields", function () {
...
module("Unit | Discourse Visual Editor | groupFields", function () {
...
module("Unit | Discourse Visual Editor | isFieldVisible", function () {
