...
module Chat
  ...
  #
  # @example
  #  Chat::StopMessageStreaming.call(channel_id: 2, message_id: 3, guardian: guardian)
  #
  class StopMessageStreaming
    ...
    def fetch_message(contract:, **)
      ::Chat::Message.find_by(id: contract.message_id, chat_channel_id: contract.channel_id)
    end
