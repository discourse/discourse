...
module("Discourse Chat | Component | chat-channel-card", function (hooks) {
  ...
  test("escapes channel title", async function (assert) {const self = this;

    this.channel.title = "<div class='xss'>evil</div>";

    await render(<template><ChatChannelCard @channel={{self.channel}} /></template>);

    assert.dom(".xss").doesNotExist();
  });

  test("escapes channel description", async function (assert) {const self = this;
  ...
  test("Archived channel", async function (assert) {const self = this;
  ...
  test("Muted channel", async function (assert) {const self = this;
  ...
  test("Joined channel", async function (assert) {const self = this;
  ...
  test("Joinable channel", async function (assert) {const self = this;
  ...
  test("Memberships count", async function (assert) {const self = this;
  ...
  test("No description", async function (assert) {const self = this;
  ...
  test("Description", async function (assert) {const self = this;
  ...
  test("Read restricted chatable", async function (assert) {const self = this;
