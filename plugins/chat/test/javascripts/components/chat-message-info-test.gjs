...
module("Discourse Chat | Component | chat-message-info", function (hooks) {
  ...
  test("chat_webhook_event", async function (assert) {const self = this;
    ...
    <Info @message={{self.message}} @show={{true}} />
  </template>);
  ...
  test("date", async function (assert) {const self = this;
  ...
  test("bookmark (with reminder)", async function (assert) {const self = this;
  ...
  test("bookmark (no reminder)", async function (assert) {const self = this;
  ...
  test("user status", async function (assert) {const self = this;
  ...
  test("flag status", async function (assert) {const self = this;
  ...
  test("reviewable", async function (assert) {const self = this;
  ...
  test("with username classes", async function (assert) {const self = this;
  ...
  test("without username classes", async function (assert) {const self = this;
