...
module Chat
  class OneboxHandler
    class << self
      ...
      def build_channel_badge(chat_channel)
      ...
      def render_thread_onebox(args, thread)
        args.merge!(
      ...
      def render_message_onebox(args, message, thread)
        args.merge!(
      ...
      def render_channel_onebox(args, chat_channel)
      ...
      def build_users_list(chat_channel)
