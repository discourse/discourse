...
describe Chat::Statistics do
  context "when calculating summary metrics" do
    ...
    fab!(:message4) do
      Fabricate(
        :chat_message,
        chat_channel: channel1,
        created_at: frozen_time - 11.days,
        user: user2,
      )
    end
    fab!(:message5) do
      Fabricate(
        :chat_message,
        chat_channel: channel4,
        created_at: frozen_time - 12.days,
        user: user3,
      )
    end
    fab!(:message6) do
      Fabricate(
        :chat_message,
        chat_channel: channel1,
        created_at: frozen_time - 13.days,
        user: user2,
      )
    end
    fab!(:message7) do
      Fabricate(
        :chat_message,
        chat_channel: channel1,
        created_at: frozen_time - 16.days,
        user: user1,
      )
    end
    fab!(:message8) do
    ...
    fab!(:message10) do
      Fabricate(
        :chat_message,
        chat_channel: channel1,
        created_at: frozen_time - 50.days,
        user: user4,
      )
    end
    fab!(:message10) do
      Fabricate(
        :chat_message,
        chat_channel: channel1,
        created_at: frozen_time - 62.days,
        user: user4,
      )
    end
  ...
  context "when calculating channel message metrics" do
    describe "#channel_messages" do
      ...
      fab!(:message3) do
        Fabricate(:chat_message, chat_channel: channel_3, created_at: now - 5.days)
      end
      fab!(:message4) do
        Fabricate(:chat_message, chat_channel: channel_1, created_at: now - 10.days)
      end
      fab!(:message5) do
        Fabricate(:chat_message, chat_channel: channel_2, created_at: now - 12.days)
      end
      fab!(:message6) do
        Fabricate(:chat_message, chat_channel: channel_3, created_at: now - 27.days)
      end
      fab!(:message7) do
        Fabricate(:chat_message, chat_channel: channel_1, created_at: now - 29.days)
      end
      fab!(:message8) do
        Fabricate(:chat_message, chat_channel: channel_2, created_at: now - 30.days)
      end
      fab!(:message9) do
        Fabricate(:chat_message, chat_channel: channel_3, created_at: now - 40.days)
      end
      fab!(:message10) do
    ...
    describe "#threaded_messages" do
      ...
      fab!(:message3) do
        Fabricate(:chat_message, chat_channel: channel_1, created_at: now - 5.days)
      end
      fab!(:message4) do
        Fabricate(:chat_message, chat_channel: channel_2, created_at: now - 10.days)
      end
      fab!(:message5) do
        Fabricate(:chat_message, chat_channel: channel_1, created_at: now - 12.days)
      end
      fab!(:message6) do
        Fabricate(:chat_message, chat_channel: channel_2, created_at: now - 20.days)
      end
      fab!(:message7) do
        Fabricate(:chat_message, chat_channel: channel_1, created_at: now - 21.days)
      end
      fab!(:message8) do
        Fabricate(:chat_message, chat_channel: channel_2, created_at: now - 30.days)
      end
      fab!(:message9) do
        Fabricate(:chat_message, chat_channel: channel_1, created_at: now - 40.days)
      end
      fab!(:message10) do
