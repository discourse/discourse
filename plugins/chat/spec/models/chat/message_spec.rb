...
describe Chat::Message do
  ...
  describe ".cook" do
    ...
    it "supports emoji plugin" do
      ...
      expect(cooked).to eq(
        "<p><img src=\"/images/emoji/twitter/grin.png?v=#{EMOJI_VERSION}\" title=\":grin:\" class=\"emoji only-emoji\" alt=\":grin:\" loading=\"lazy\" width=\"20\" height=\"20\"></p>",
      )
    end
    ...
    it "supports inline emoji" do
      ...
      expect(cooked).to eq(<<~HTML.chomp)
      <p><img src="/images/emoji/twitter/smiley.png?v=#{EMOJI_VERSION}" title=":smiley:" class="emoji only-emoji" alt=":smiley:" loading=\"lazy\" width=\"20\" height=\"20\"></p>
      HTML
    end
    ...
    it "supports emoji shortcuts" do
      ...
      expect(cooked).to eq(<<~HTML.chomp)
        <p>this is a replace test <img src="/images/emoji/twitter/stuck_out_tongue.png?v=#{EMOJI_VERSION}" title=":stuck_out_tongue:" class="emoji" alt=":stuck_out_tongue:" loading=\"lazy\" width=\"20\" height=\"20\"> <img src="/images/emoji/twitter/expressionless.png?v=#{EMOJI_VERSION}" title=":expressionless:" class="emoji" alt=":expressionless:" loading=\"lazy\" width=\"20\" height=\"20\"></p>
      HTML
    end
