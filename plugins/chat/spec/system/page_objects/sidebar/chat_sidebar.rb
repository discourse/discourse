...
module PageObjects
  module Pages
    class ChatSidebar < PageObjects::Pages::Base
      ...
      STARRED_CHANNELS_SECTION_SELECTOR =
      ...
      def has_no_dm_channels_section?
        has_no_css?(DM_CHANNELS_SECTION_SELECTOR)
      end

      def has_no_starred_channels_section?
        has_no_css?(STARRED_CHANNELS_SECTION_SELECTOR)
      end
      ...
      def starred_section
        find(STARRED_CHANNELS_SECTION_SELECTOR)
      end
