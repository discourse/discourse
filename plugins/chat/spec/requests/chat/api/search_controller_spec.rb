  ...
  describe "#index" do
    ...
    context "when logged in" do
      ...
      context "when searching with valid params" do
        ...
        it "does not expose scoped results from a readonly category channel" do
          readonly_group = Fabricate(:group, users: [current_user])
          category =
            Fabricate(
              :private_category,
          ...
          readonly_channel = Fabricate(:category_channel, chatable: category)
          restricted_message =
            Fabricate(
              :chat_message,
