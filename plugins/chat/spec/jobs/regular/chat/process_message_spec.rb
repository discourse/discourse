  ...
  context "with notifications (former notify_mentioned_spec.rb)" do
    ...
    shared_examples "creates different notifications with basic data" do
      ...
      it "works for desktop notifications" do
        ...
        expect(desktop_notification.data[:tag]).to eq(
          Chat::Mention.notification_tag(public_channel.id),
        )
      ...
      it "works for push notifications" do
        expected_payload = {
          ...
          tag: Chat::Mention.notification_tag(public_channel.id),
    ...
    describe "#execute" do
      ...
      describe "group mentions" do
        ...
        it "includes group mention specific data into desktop notifications" do
          desktop_notification = run_job_and_get_first_desktop_notification(message: message)
