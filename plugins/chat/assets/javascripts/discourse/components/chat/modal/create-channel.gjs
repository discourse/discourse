  ...
  <template>
    ...
    >
      <:body>
        ...
        <div class="chat-modal-create-channel__control -emoji">
          <label for="emoji" class="chat-modal-create-channel__label">
            {{i18n "chat.create_channel.emoji.label"}}
          </label>
