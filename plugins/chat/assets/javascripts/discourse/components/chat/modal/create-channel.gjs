...
<template><DModal @closeModal={{@closeModal}} class="chat-modal-create-channel" @inline={{@inline}} @title={{i18n0 "chat.create_channel.title"}} @flash={{this.flash}} @tagName="form" {{on "submit" this.onSave}}>
  <:body>
    <div class="chat-modal-create-channel__control -name">
      ...
      <Input name="name" class="chat-modal-create-channel__input" @type="text" @value={{this.name}} {{on "input" (withEventValue this.onNameChange)}} />
    </div>
    ...
    <div class="chat-modal-create-channel__control -slug">
      ...
      <Input name="slug" class="chat-modal-create-channel__input" @type="text" @value={{this.slug}} placeholder={{this.autoGeneratedSlug}} />
    </div>
    ...
    <div class="chat-modal-create-channel__control -description">
      ...
      <Input name="description" class="chat-modal-create-channel__input" @type="textarea" @value={{this.description}} />
    </div>
    ...
    <div class="chat-modal-create-channel__control">
      ...
      <CategoryChooser @value={{this.categoryId}} @onChange={{this.onCategoryChange}} @options={{hash formName="chatable_id" none="chat.create_channel.choose_category.none"}} />

      {{#if this.categoryPermissionsHint}}
        <div class={{concatClass "chat-modal-create-channel__hint" (if this.loadingPermissionHint "loading-permissions")}}>
    ...
    {{#if this.autoJoinAvailable}}
      <div class="chat-modal-create-channel__control -auto-join">
        <label class="chat-modal-create-channel__label">
          <Input name="auto_join_users" @type="checkbox" @checked={{this.autoJoinUsers}} />
          <div class="auto-join-channel">
            ...
            <p class="chat-modal-create-channel__label-description">
              {{#if this.categoryName}}
                {{i18n0 "chat.settings.auto_join_users_info" category=this.categoryName}}
              {{else}}
    ...
    <div class="chat-modal-create-channel__control -threading-toggle">
      <label class="chat-modal-create-channel__label">
        <Input name="threading_enabled" @type="checkbox" @checked={{this.threadingEnabled}} />
  ...
  <:footer>
    <button class="btn btn-primary create" disabled={{this.createDisabled}} type="submit">
