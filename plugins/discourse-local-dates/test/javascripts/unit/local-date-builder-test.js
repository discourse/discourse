          ...
          previews: [
            {
              current: true,
              formatted:
                "Sunday, March 22, 2020 <br /><svg class='fa d-icon d-icon-clock svg-icon fa-width-auto svg-string' aria-hidden='true' xmlns=\"http://www.w3.org/2000/svg\"><use href=\"#clock\" /></svg> 12:00 AM → 1:30 AM",
              timezone: "Paris",
            },
          ],
        }
          ...
          previews: [
            {
              current: true,
              formatted:
                "Sunday, March 22, 2020 <br /><svg class='fa d-icon d-icon-clock svg-icon fa-width-auto svg-string' aria-hidden='true' xmlns=\"http://www.w3.org/2000/svg\"><use href=\"#clock\" /></svg> 11:34 AM",
              timezone: "Paris",
            },
          ],
        }
          ...
          previews: [
            {
              current: true,
              formatted:
                "Tuesday, April 7, 2020 <br /><svg class='fa d-icon d-icon-clock svg-icon fa-width-auto svg-string' aria-hidden='true' xmlns=\"http://www.w3.org/2000/svg\"><use href=\"#clock\" /></svg> 2:54 PM",
              timezone: "Paris",
            },
            {
              formatted:
                "Tuesday, April 7, 2020 <br /><svg class='fa d-icon d-icon-clock svg-icon fa-width-auto svg-string' aria-hidden='true' xmlns=\"http://www.w3.org/2000/svg\"><use href=\"#clock\" /></svg> 1:54 PM",
              timezone: "London",
            },
            {
              formatted:
            ...
            {
              formatted:
                "Tuesday, April 7, 2020 <br /><svg class='fa d-icon d-icon-clock svg-icon fa-width-auto svg-string' aria-hidden='true' xmlns=\"http://www.w3.org/2000/svg\"><use href=\"#clock\" /></svg> 10:54 PM",
              timezone: "Sydney",
            },
          ],
        }
          ...
          previews: [
            {
              current: true,
              formatted:
                "Wednesday, May 13, 2020 <br /><svg class='fa d-icon d-icon-clock svg-icon fa-width-auto svg-string' aria-hidden='true' xmlns=\"http://www.w3.org/2000/svg\"><use href=\"#clock\" /></svg> 11:00 AM",
              timezone: "Los Angeles",
            },
            {
              formatted:
                "Wednesday, May 13, 2020 <br /><svg class='fa d-icon d-icon-clock svg-icon fa-width-auto svg-string' aria-hidden='true' xmlns=\"http://www.w3.org/2000/svg\"><use href=\"#clock\" /></svg> 6:00 PM",
              timezone: "UTC",
            },
          ],
        }
