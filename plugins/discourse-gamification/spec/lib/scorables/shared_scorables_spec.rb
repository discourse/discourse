...
RSpec.shared_examples "No Score Value" do
  ...
  describe "#{described_class} awards no score value" do
    before do
      class_action_fabricator_for_deleted_object
      class_action_fabricator_for_pm
      class_action_fabricator_for_wiki
      class_action_fabricator_for_themselves
      after_create_hook
    end
