...
describe "Wireframe inspector rich-text control" do
  ...
  RICH_EDITOR = ".wireframe-inspector-rich-text__editor .wf-rich-text-editor"

  before do
    SiteSetting.wireframe_enabled = true

    theme_dir = File.expand_path("../fixtures/themes/wireframe-rich-text-test-theme", __dir__)
