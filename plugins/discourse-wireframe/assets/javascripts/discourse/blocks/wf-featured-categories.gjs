  ...
  args: {
    categories: {
      ...
      ui: {
        ...
        label: i18n("wireframe.inspector.featured_categories.categories"),
        helpText: i18n(
          "wireframe.inspector.featured_categories.categories_help"
        ),
      },
    },
    description: {
      ...
      ui: {
        control: "toggle",
        label: i18n("wireframe.inspector.featured_categories.description"),
      },
    },
    allCategoriesLink: {
      type: "boolean",
      ...
      ui: {
        control: "toggle",
        label: i18n(
          "wireframe.inspector.featured_categories.all_categories_link"
        ),
      },
    },
    allCategoriesLabel: {
      ...
      ui: {
        label: i18n(
          "wireframe.inspector.featured_categories.all_categories_label"
        ),
      },
    },
  },
...
export default class WFFeaturedCategories extends Component {
  ...
  <template>
    <div class="wf-featured-categories">
      <div class="wf-featured-categories__grid">
        {{#each this.featuredCategories as |category|}}
          <CategoryCard
            ...
            @class={{concat
              "wf-featured-categories__card"
              (if @description " wf-featured-categories__card--has-description")
            }}
          />
        {{/each}}
      </div>
      ...
      {{#if @allCategoriesLink}}
        <div class="wf-featured-categories__footer">
          <a
            class="wf-featured-categories__all-link"
