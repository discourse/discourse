 ...
 * publish plan); it never reaches back into the editor session service. The
 ...
 */
export default class WireframeThemeService extends Service {
  @service blocks;
  @service site;
   ...
   * default with no live field). Exposed so the persistence peer can resolve a
