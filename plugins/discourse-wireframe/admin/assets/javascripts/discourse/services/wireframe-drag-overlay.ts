...
export interface ImageArgClaim {
  ...
  isPassive: boolean;
  /** Which variant a drop targets (default light). */
  variant?: "light" | "dark";
}
...
export default class WireframeDragOverlay extends Service {
   ...
   */
  #stickyDispatch: DropDispatch | null = null;
   ...
   */
  #dispatcher: ((payload: DropDispatch) => boolean) | null = null;
   ...
   */
  get slotPreview(): SlotPreview | null {
