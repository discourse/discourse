...
import { entryHasEmptyImageUploadArgs } from "discourse/plugins/discourse-wireframe/discourse/lib/empty-image-upload";
...
module("Unit | Wireframe | entryHasEmptyImageUploadArgs", function () {
