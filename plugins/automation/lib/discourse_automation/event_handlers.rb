...
module DiscourseAutomation
  module EventHandlers
    class << self
      def handle_post_created_edited(post, action)
        ...
        DiscourseAutomation::Automation
          ...
          .find_each do |automation|
            ...
            restricted_inbox_group_ids =
              automation.trigger_field("restricted_inbox_groups")["value"]
      ...
      def handle_user_updated(user, new_user: false)
        return if user.id < 0
      ...
      def handle_category_created_edited(category, action)
      ...
      def handle_topic_tags_changed(topic, old_tag_names, new_tag_names, user)
      ...
      def handle_topic_closed(topic, status)
      ...
      def handle_post_flag_created(post_action)
