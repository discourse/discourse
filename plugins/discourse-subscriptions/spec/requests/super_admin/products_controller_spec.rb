...
RSpec.describe DiscourseSubscriptions::SuperAdmin::ProductsController do
  before { SiteSetting.discourse_subscriptions_enabled = true }

  it "is a subclass of SuperAdminController" do
    expect(DiscourseSubscriptions::SuperAdmin::ProductsController < ::SuperAdmin::SuperAdminController).to eq(true)
  end
