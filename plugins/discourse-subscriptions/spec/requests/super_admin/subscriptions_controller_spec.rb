...
RSpec.describe DiscourseSubscriptions::SuperAdmin::SubscriptionsController do
  before { SiteSetting.discourse_subscriptions_enabled = true }

  it "is a subclass of SuperAdminController" do
    expect(DiscourseSubscriptions::SuperAdmin::SubscriptionsController < ::SuperAdmin::SuperAdminController).to eq(
      true,
    )
  end
