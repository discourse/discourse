...
RSpec.describe DiscourseSubscriptions::SuperAdmin::PlansController do
  before { SiteSetting.discourse_subscriptions_enabled = true }

  it "is a subclass of SuperAdminController" do
    expect(DiscourseSubscriptions::SuperAdmin::PlansController < ::SuperAdmin::SuperAdminController).to eq(true)
  end
