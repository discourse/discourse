...
RSpec.describe DiscourseSubscriptions::SuperAdmin::CouponsController do
  before { SiteSetting.discourse_subscriptions_enabled = true }

  it "is a subclass of SuperAdminController" do
    expect(DiscourseSubscriptions::SuperAdmin::CouponsController < ::SuperAdmin::SuperAdminController).to eq(true)
  end
