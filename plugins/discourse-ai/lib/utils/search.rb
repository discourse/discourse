      ...
      class << self
        def perform_search(
          ...
          should_try_semantic_search =
            SiteSetting.ai_embeddings_enabled &&
        ...
        def format_row(topic:, post: nil, hidden_tags: nil, excerpt: nil)
          row = {
            title: topic.title,
