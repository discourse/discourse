...
module DiscourseAi
  module Translation
    class << self
      ...
      def supported_locale_bases_cte
        <<~SQL
      ...
      def category_scope_condition(category_column:)
        case SiteSetting.ai_translation_category_scope
        when "all"
      ...
      def llm_model_for_agent(agent_id)
      ...
      def credits_available_for_agent_ids?(agent_ids)
      ...
      def credits_available_for_post_detection?
      ...
      def credits_available_for_topic_detection?
        credits_available_for_agent_ids?(
          [
            SiteSetting.ai_translation_locale_detector_agent,
            SiteSetting.ai_translation_topic_title_translator_agent,
      ...
      def credits_available_for_post_localization?
        credits_available_for_agent_ids?([SiteSetting.ai_translation_post_raw_translator_agent])
      end

      def credits_available_for_topic_localization?
        credits_available_for_agent_ids?(
          [
            SiteSetting.ai_translation_topic_title_translator_agent,
            SiteSetting.ai_translation_post_raw_translator_agent,
      ...
      def credits_available_for_category_localization?
        credits_available_for_agent_ids?(
          [
            SiteSetting.ai_translation_short_text_translator_agent,
            SiteSetting.ai_translation_post_raw_translator_agent,
      ...
      def credits_available_for_tag_localization?
        credits_available_for_agent_ids?([SiteSetting.ai_translation_short_text_translator_agent])
      end

      def credits_available_for_sidebar_localization?
        credits_available_for_agent_ids?([SiteSetting.ai_translation_short_text_translator_agent])
      end
    end
  end
