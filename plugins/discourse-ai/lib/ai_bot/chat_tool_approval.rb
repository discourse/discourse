...
module DiscourseAi
  module AiBot
    ...
    module ChatToolApproval
      ...
      class << self
        def build_action_id(action, reviewable_id)
        ...
        def pending_blocks(reviewable_id)
          [
            {
              type: "actions",
              schema_version: 1,
        ...
        def handle_interaction(interaction)
          ...
          begin
            ...
            resolve_message!(
              message,
              I18n.t(
                "discourse_ai.ai_bot.chat_tool_approval.#{status_key}",
        ...
        def resolve_message!(message, status_text)
        ...
        def append_error!(message, status_text)
          return if message.blank?
