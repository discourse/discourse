  ...
  module InferredConcepts
    class Finder
      ...
      def find_candidate_topics(
        ...
        query = query.where.not(topics: { id: exclude_topic_ids }) if exclude_topic_ids.present?
      ...
      def find_candidate_posts(
        ...
        # Apply additional filters
        query = query.where.not(posts: { id: exclude_post_ids }) if exclude_post_ids.present?
