  ...
  module Translation
    class Progress
      ...
      class << self
        ...
        def supported_target?(target_type)
        ...
        def detail_cache_key(target_type)
          [
            "discourse-ai",
        ...
        def detail_mutex_key(cache_key)
