...
module DiscourseAi
  module Translation
    class SidebarSectionLocalizer
      class << self
        def localize(sidebar_section, target_locale = I18n.locale, short_text_llm_model: nil)
          if sidebar_section.blank? || !sidebar_section.custom_section? || target_locale.blank?
            return
          end
