...
describe Jobs::SiteSettingLocalizationBackfill do
  before do
  ...
  it "does not enqueue when AI is disabled" do
    ...
    expect_not_enqueued_with(job: :localize_site_settings)
  end
  ...
  it "enqueues localize_site_settings with the hourly rate limit" do
    described_class.new.execute({})

    expect_job_enqueued(job: :localize_site_settings, args: { limit: 100 })
  end
