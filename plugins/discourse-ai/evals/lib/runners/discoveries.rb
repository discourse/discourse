    ...
    module Runners
      class Discoveries < Base
        ...
        def run_case(case_args, llm)
          ...
          persona, user = persona_for_discoveries
          context =
        ...
        def persona_for_discoveries
          persona_id = SiteSetting.ai_discover_persona
          persona_record = persona_id && AiPersona.find_by_id_from_cache(persona_id)

          persona_instance =
            persona_record&.class_instance&.new || DiscourseAi::Personas::Discover.new
