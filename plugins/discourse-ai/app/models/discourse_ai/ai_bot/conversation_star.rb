...
module DiscourseAi
  module AiBot
    class ConversationStar < ActiveRecord::Base
      ...
      class << self
        def conversations_query_for(user)
          Topic
        ...
        def starred_conversations_for(user, limit: MAX_STARS_PER_USER)
        ...
        def user_reached_star_limit?(user)
