export const AI_FEATURE_SETTING_GROUPS = {
  ai_helper: [
    ...
    {
      key: "agents",
      titleKey: "discourse_ai.features.ai_helper.setting_groups.agents",
      settings: [
  ...
  summarization: [
    ...
    },
    {
      ...
      settings: ["ai_summary_gists_enabled", "ai_summary_gists_agent"],
    },
    {
      key: "backfill",
  ...
  translation: [
    ...
    {
      key: "agents",
      titleKey: "discourse_ai.features.translation.setting_groups.agents",
      settings: [
  ...
  inference: [
    ...
    {
      key: "agents",
      titleKey: "discourse_ai.features.inference.setting_groups.agents",
      settings: [
