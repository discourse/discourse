!(function(t) {
    ...
    for (var a = [], i = 0; i < t.length; i++) {
      ...
      if (o) {
        ...
        var c = s.toString(n.preferredFormat || "rgb"),
          f = Yt
            ? "background-color:" + s.toRgbString()
            : "filter:" + s.toFilter();
        a.push(
          '<span title="' +
            c +
  ...
  function e(t, e) {
    function n() {
      if (
        (F.showPaletteOnly && (F.showPalette = !0),
        xt.text(
          F.showPaletteOnly ? F.togglePaletteMoreText : F.togglePaletteLessText
        ),
        F.palette)
      ) {
      ...
      st.toggleClass("sp-flat", T),
        ...
        st.addClass(F.className).addClass(F.containerClassName),
        C();
    }
    function r() {
      function t(t) {
        return (
          t.data && t.data.ignore
            ...
            : (m(
              ...
              _(),
              S(!0),
              F.hideAfterPaletteSelect && b()),
          !1
        );
      }
      if (
        (Xt && st.find("*:not(input)").attr("unselectable", "on"),
        n(),
        Ct && it.after(Pt).hide(),
        qt || wt.hide(),
        T)
      ...
      a(),
        At.bind("click.spectrum touchstart.spectrum", function(t) {
          ot || h(),
            t.stopPropagation(),
            jt(t.target).is("input") || t.preventDefault();
        }),
        (it.is(":disabled") || !0 === F.disabled) && R(),
        st.click(Lt),
        bt.change(u),
        bt.bind("paste", function() {
          setTimeout(u, 1);
        }),
        ...
        yt.bind("click.spectrum", function(t) {
          t.stopPropagation(), t.preventDefault(), v(), b();
        }),
        wt.attr("title", F.clearText),
        wt.bind("click.spectrum", function(t) {
          t.stopPropagation(), t.preventDefault(), (Ot = !0), _(), T && S(!0);
        }),
        _t.text(F.chooseText),
        _t.bind("click.spectrum", function(t) {
          t.stopPropagation(),
            t.preventDefault(),
        ...
        xt.bind("click.spectrum", function(t) {
          t.stopPropagation(),
            t.preventDefault(),
        ...
        Kt(
          ...
          function(t, e, r) {
            (Q = t / V),
              (Ot = !1),
              r.shiftKey && (Q = Math.round(10 * Q) / 10),
              _();
          },
          s,
          l
        ...
        Rt
          ? (m(Rt),
            x(),
            (Ft = F.preferredFormat || tinycolor(Rt).format),
            i(Rt))
          : x(),
        T && d();
    ...
    function a() {
      if (q && window.localStorage) {
        try {
          ...
          1 < t.length &&
            (delete window.localStorage[q],
            jt.each(t, function(t, e) {
              i(e);
            }));
        } catch (e) {}
        try {
      ...
      D
        ...
        : (it.trigger(t, [y()]),
          !1 === j.beforeShow(y()) ||
            ...
            (It(),
            (D = !0),
            jt(at).bind("keydown.spectrum", p),
            jt(at).bind("click.spectrum", g),
            jt(window).bind("resize.spectrum", E),
            Pt.addClass("sp-active"),
            st.removeClass("sp-hidden"),
            C(),
            x(),
            (Ht = y()),
            f(),
    ...
    function b() {
      D &&
        !T &&
        ((D = !1),
        jt(at).unbind("keydown.spectrum", p),
        jt(at).unbind("click.spectrum", g),
        jt(window).unbind("resize.spectrum", E),
        Pt.removeClass("sp-active"),
        st.addClass("sp-hidden"),
        j.hide(y()),
    ...
    function x() {
      ...
      var r = y({ format: e }),
        n = "";
      if (
        (Mt.removeClass("sp-clear-display"),
        ...
        if (
          ...
          Xt
            ? dt.css("filter", tinycolor(s).toFilter({ gradientType: 1 }, a))
    ...
    function k() {
      var t = Y,
        e = G;
      if (qt && Ot) gt.hide(), ht.hide(), ft.hide();
      else {
    ...
    function S(t) {
      var e = y(),
        r = "",
        n = !tinycolor.equals(e, Ht);
      e && ((r = e.toString(Ft)), i(e)),
        kt && it.val(r),
    ...
    function C() {
      D &&
        ...
        k(),
        F.showPalette && c(),
        it.trigger("reflow.spectrum"));
    }
    function P() {
      it.show(),
        At.unbind("click.spectrum touchstart.spectrum"),
        st.remove(),
        Pt.remove(),
        (Wt[Nt.id] = null);
    }
    ...
    var F = zt(e, t),
      ...
      U = [],
      Z = {},
      tt = F.selectionPalette.slice(0),
      et = F.maxSelectionSize,
      rt = "sp-dragging",
      nt = null,
      at = t.ownerDocument,
      it = (at.body, jt(t)),
      ot = !1,
      st = jt(Qt, at).addClass(N),
      lt = st.find(".sp-picker-container"),
      ct = st.find(".sp-color"),
      ft = st.find(".sp-dragger"),
      ut = st.find(".sp-hue"),
      ht = st.find(".sp-slider"),
      dt = st.find(".sp-alpha-inner"),
      pt = st.find(".sp-alpha"),
      gt = st.find(".sp-alpha-handle"),
      bt = st.find(".sp-input"),
      vt = st.find(".sp-palette"),
      mt = st.find(".sp-initial"),
      yt = st.find(".sp-cancel"),
      wt = st.find(".sp-clear"),
      _t = st.find(".sp-choose"),
      xt = st.find(".sp-palette-toggle"),
      kt = it.is("input"),
      St = kt && "color" === it.attr("type") && $t(),
      Ct = kt && !T,
      Pt = Ct
        ? jt(Gt)
            .addClass(N)
        ...
        : jt([]),
      At = Ct ? Pt : it,
      Mt = Pt.find(".sp-preview-inner"),
      Rt = F.color || (kt && it.val()),
      Ht = !1,
      Ft = F.preferredFormat,
      Tt = !F.showButtons || F.clickoutFiresChange,
      Ot = !Rt,
      qt = F.allowEmpty && !St;
    r();
    var Nt = {
  ...
  function Bt(t, e) {
    var r = 0,
      ...
      c = s.clientHeight + jt(o).scrollTop(),
      f = e.offset();
    return (
      (f.top += i),
      (f.left -= Math.min(
        f.left,
        f.left + n > l && n < l ? Math.abs(f.left + n - l) : 0
      )),
      (f.top -= Math.min(
        f.top,
        f.top + a > c && a < c ? Math.abs(a + i - r) : r
      )),
      f
    );
  }
  ...
  function Kt(o, s, e, t) {
    ...
    function n(t) {
      (t.which ? 3 == t.which : 2 == t.button) ||
        ...
        (!1 !== e.apply(o, arguments) &&
          ...
          (h = jt(o).offset()),
          jt(f).bind(a),
          jt(f.body).addClass("sp-dragging"),
          r(t),
          l(t)));
    }
    function c() {
      u &&
        (jt(f).unbind(a),
        jt(f.body).removeClass("sp-dragging"),
        setTimeout(function() {
          t.apply(o, arguments);
        }, 0)),
        (u = !1);
    ...
    (a.selectstart = l),
      (a.dragstart = l),
      (a["touchmove mousemove"] = r),
      (a["touchend mouseup"] = c),
      jt(o).bind("touchstart mousedown", n);
  }
  function Vt(n, a, i) {
    var o;
    return function() {
  ...
  (jt.fn.spectrum = function(r) {
      ...
      this.each(function() {
        ...
        if (t) {
          ...
          "get" == r
            ...
            : "destroy" == r
            ? (t.destroy(), jt(this).removeData(i))
            : e.apply(t, a);
        }
      }),
      n
    ...
    (jt.fn.spectrum.load = !0),
    (jt.fn.spectrum.loadOpts = {}),
    (jt.fn.spectrum.draggable = Kt),
    (jt.fn.spectrum.defaults = a),
    (jt.fn.spectrum.inputTypeColorSupport = function $t() {
    ...
    (jt.spectrum = {}),
    (jt.spectrum.localization = {}),
    (jt.spectrum.palettes = {}),
    ...
    (function() {
      ...
      function a(t, e, r) {
        ...
        if (i == o) n = a = 0;
          ...
          var l = i - o;
          switch (((a = 0.5 < s ? l / (2 - i - o) : l / (i + o)), i)) {
            case t:
              n = (e - r) / l + (e < r ? 6 : 0);
              break;
            case e:
      ...
      function h(t, e) {
        ...
        var r = B(t).toRgb();
        return (
          (r.r = I(0, D(255, r.r - E((-e / 100) * 255)))),
          (r.g = I(0, D(255, r.g - E((-e / 100) * 255)))),
          (r.b = I(0, D(255, r.b - E((-e / 100) * 255)))),
          B(r)
        );
      }
      function d(t, e) {
      ...
      function w(t, e) {
        e = e || 6;
        for (
          var r = B(t).toHsv(), n = r.h, a = r.s, i = r.v, o = [], s = 1 / e;
          e--;
      ...
      function T(t) {
        ...
        return (e = X.rgb.exec(t))
          ...
          : (e = X.hex6.exec(t))
          ? { r: C(e[1]), g: C(e[2]), b: C(e[3]), format: r ? "name" : "hex" }
          : !!(e = X.hex3.exec(t)) && {
              r: C(e[1] + "" + e[1]),
              g: C(e[2] + "" + e[2]),
              b: C(e[3] + "" + e[3]),
      ...
      (B.prototype = {
        ...
        setAlpha: function(t) {
          return (
            (this._a = x(t)), (this._roundA = E(100 * this._a) / 100), this
          );
        },
        toHsv: function() {
        ...
        toRgbString: function() {
          return 1 == this._a
            ? "rgb(" + E(this._r) + ", " + E(this._g) + ", " + E(this._b) + ")"
            : "rgba(" +
                E(this._r) +
                ", " +
                E(this._g) +
        ...
        (B.readability = function(t, e) {
          var r = B(t),
            ...
            l =
              ...
              Math.max(a.b, i.b) -
              Math.min(a.b, i.b);
          return { brightness: Math.abs(o - s), color: l };
        }),
        ...
        (B.mostReadable = function(t, e) {
          for (var r = null, n = 0, a = !1, i = 0; i < e.length; i++) {
            var o = B.readability(t, e[i]),
              s = 125 < o.brightness && 500 < o.color,
