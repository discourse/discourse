...
OmniAuth.config.before_request_phase do |env|
  ...
  # If the client provided an origin, store in secure session to redirect back
  request.secure_session[:destination_url] = request.params["origin"] if request.params[
    "origin"
  ].present?
end
