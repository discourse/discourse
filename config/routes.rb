...
Discourse::Application.routes.draw do
  ...
  # used for private uploads
  get "uploads/:site/private/:tree:sha(.:extension)" => "uploads#show", private: true, constraints: { site: /\w+/, tree: /([a-z0-9]+\/)+/i, sha: /\h{40}/, extension: /[a-z0-9\.]+/i }
