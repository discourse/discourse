...
module Discourse
  class Application < Rails::Application
    ...
    config.assets.precompile += ['vendor.js', 'common.css', 'desktop.css', 'mobile.css', 'admin.js', 'admin.css', 'shiny/shiny.css', 'preload_store.js', 'browser-update.js', 'embed.css', 'break_string.js', 'plugins.css', 'plugins.js']
    ...
    Rails.configuration.assets.paths << "#{Rails.root}/plugins/.plugindata/assets"
