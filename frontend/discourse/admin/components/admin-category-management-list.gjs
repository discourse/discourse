...
export default class AdminCategoryManagementList extends Component {
  ...
  get titleLabel() {
    return `admin.config.category_management.types.${this.args.typeId}.title`;
  }

  get descriptionLabel() {
    return `admin.config.category_management.types.${this.args.typeId}.description`;
  }
  ...
  <template>
    <div
      ...
      {{didUpdate this.typeChanged @typeId}}
    >
      <DPageSubheader
      ...
      <PluginOutlet
        ...
        @outletArgs={{lazyHash typeId=@typeId categories=this.categories}}
      />
