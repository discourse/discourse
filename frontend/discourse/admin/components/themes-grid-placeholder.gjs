...
export default class ThemesGridPlaceholder extends Component {
  ...
  <template>
    {{#if (eq this.randomVariant 0)}}
      ...
      >
        <rect fill={{this.safeThemeColors.tertiary}} height="200" width="800" />
    ...
    {{else if (eq this.randomVariant 1)}}
      ...
      >
        ...
        <rect fill="url(#{{this.gradientId}}-a)" height="200" width="800" />
        <rect fill="url(#{{this.gradientId}}-b)" height="200" width="800" />
        <rect fill="url(#{{this.gradientId}}-c)" height="200" width="800" />
        <rect fill="url(#{{this.gradientId}}-d)" height="200" width="800" />
        <rect fill="url(#{{this.gradientId}}-e)" height="200" width="800" />
        <rect fill="url(#{{this.gradientId}}-f)" height="200" width="800" />
      </svg>
    ...
    {{else if (eq this.randomVariant 3)}}
      <svg
        ...
        xmlns="http://www.w3.org/2000/svg"
      >
        <rect fill={{this.safeThemeColors.tertiary}} height="1" width="2" />
        <defs>
          <linearGradient
            gradientUnits="userSpaceOnUse"
            id="{{this.gradientId}}-a"
