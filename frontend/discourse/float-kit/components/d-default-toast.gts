...
interface DDefaultToastSignature {
  ...
  Args: {
    ...
    close: () => void;
    isFront: boolean;
    progressBarStyle: string | TrustedHTML;
    onProgressComplete: (event: AnimationEvent) => void;
  };
}

/**
 * The default body rendered for a toast instance.
 */
export default class DDefaultToast extends Component<DDefaultToastSignature> {
  get data() {
