 ...
 * @property {string} [guard] - Guard name that must pass for this transition
 * @property {string} target - Target state to transition to
 */

/**
 * @typedef {string | TransitionTarget | TransitionTarget[]} TransitionDef
 */

/**
 * @typedef {Object} StateConfig
 * @property {Object<string, TransitionDef>} [messages] - Map of message types to transitions
 * @property {MachineDefinition[]} [machines] - Nested child machines within this state
 */

/**
 * @typedef {Object} MachineDefinition
 * @property {string} name - Unique name identifying the machine within the group
 * @property {string} initial - Initial state for the machine
 * @property {Object<string, StateConfig>} states - Map of state names to configurations
 * @property {boolean} [silentOnly] - If true, state changes do not trigger reactive updates
 */

/**
 * @typedef {Object} GuardMessage
 * @property {string} type - The message type that triggered the transition
 * @property {boolean} [skipClosing] - Whether to skip closing animation
 * @property {boolean} [skipOpening] - Whether to skip opening animation
 */
 ...
 *
 * @type {Object<string, (previousStates: string[], message: GuardMessage) => boolean>}
 */
export const GUARDS = {
...
/**
 * Machine definitions for the sheet's primary state machine group.
 * Includes staging, longRunning, skipOpening, skipClosing, openness,
 * scrollContainerTouch, backStuck, frontStuck, and elementsReady machines.
 *
        ...
        machines: [
          {
            ...
            initial: "ended",
            states: {
              ended: { messages: { SCROLL_START: "ongoing" } },
...
/**
 * Machine definitions for the sheet's position state machine group.
 * Includes active and position machines that manage sheet stacking and transitions.
 *
 * @type {MachineDefinition[]}
 */
