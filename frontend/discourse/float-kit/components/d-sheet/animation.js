/**
 * Animation engine for d-sheet components, providing spring physics and bezier easing.
 * Handles animation configuration, progress calculation, and interpolation for sheet transitions.
 * Supports spring-based animations (with presets like "gentle", "snappy", "bouncy") and traditional
 * cubic-bezier easing functions. Generates frame-by-frame progress values for smooth animations,
 * with browser-native CSS calc() expressions for optimal performance.
 */
...
/** Max iterations for Newton-Raphson refinement. @type {number} */
const NEWTON_RAPHSON_ITERATIONS = 4;

/** Convergence threshold for binary subdivision. @type {number} */
const BINARY_SUBDIVISION_THRESHOLD = 1e-7;

/** Max iterations for binary subdivision. @type {number} */
const BINARY_SUBDIVISION_ITERATIONS = 10;

/** Number of precomputed samples along the bezier curve. @type {number} */
const BEZIER_SAMPLE_SIZE = 11;

/** Interval between precomputed bezier samples. @type {number} */
const BEZIER_SAMPLE_INTERVAL = 0.1;

/** Minimum derivative value before falling back to binary subdivision. @type {number} */
...
/** Default duration in frames for non-spring animations. @type {number} */
const DEFAULT_ANIMATION_DURATION = 250;

/** Default spring stiffness. @type {number} */
const SPRING_STIFFNESS_DEFAULT = 300;

/** Default spring damping coefficient. @type {number} */
const SPRING_DAMPING_DEFAULT = 34;

/** Default spring mass. @type {number} */
const SPRING_MASS_DEFAULT = 1;

/** Default precision threshold for spring settlement. @type {number} */
...
/** Scaling factor for converting stiffness to spring constant. @type {number} */
const SPRING_CONSTANT_SCALE = 0.000001;

/** Scaling factor for converting damping to damping constant. @type {number} */
const DAMPING_CONSTANT_SCALE = 0.001;

/** Scaling factor for deriving velocity stability threshold. @type {number} */
const VELOCITY_THRESHOLD_SCALE = 22;

/** Scaling factor for deriving position stability threshold. @type {number} */
