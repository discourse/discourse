...
export default class DScrollView extends Component {
  ...
  get startSentinelDataScroll() {
    return `sentinel sentinel-start axis-${this.axis}`;
  }

  get endSentinelDataScroll() {
    return `sentinel sentinel-end axis-${this.axis}`;
  }
  ...
  get startSpacerDataScroll() {
    return `spacer spacer-start axis-${this.axis}`;
  }

  get endSpacerDataScroll() {
    return `spacer spacer-end axis-${this.axis}`;
  }
    ...
    <div data-d-scroll={{this.viewDataAttribute}} ...attributes>
      ...
      >
        {{#if this.needsSwipeTrapObserver}}
          <div
            data-d-scroll={{this.startSentinelDataScroll}}
        ...
        {{#if this.needsSwipeTrapObserver}}
          <div
            data-d-scroll={{this.endSentinelDataScroll}}
            {{this.registerEndSpy
