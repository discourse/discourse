...
/** A single link entry, edited through the repeatable `items` arg. */
interface LinkItem {
  label?: string;
  url?: string;
  icon?: string;
...
export default class LinkList extends Component<LinkListSignature> {
  get items(): LinkItem[] {
