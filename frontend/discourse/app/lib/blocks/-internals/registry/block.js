 ...
 * reach the server (via the visual editor's save) would round-trip back as
 * string refs that fail to resolve, even though the underlying class is
 * imported and decorated.
 *
 ...
 * api-initializers, the editor's session-draft layer publishes).
 *
