...
/**
 * Valid `ui.control` values for arg schema UI hints. These drive how the
 * visual editor's inspector renders each arg. Block authors override the
 * default control choice via `ui: { control: "..." }` in the arg schema.
 */
