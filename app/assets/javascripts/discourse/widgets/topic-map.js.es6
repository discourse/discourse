...
createWidget("topic-map-summary", {
  ...
  html(attrs, state) {
    ...
    contents.push(
      h("li", [
        h("h4", { attributes: { role: "presentation" } }, I18n.t("created_lowercase")),
    ...
    contents.push(
      h(
        ...
        h("a", { attributes: { href: attrs.lastPostUrl } }, [
          h("h4", { attributes: { role: "presentation" } }, I18n.t("last_reply_lowercase")),
    ...
    contents.push(
      h("li", [
        ...
        h("h4", { attributes: { role: "presentation" } }, I18n.t("replies_lowercase", { count: attrs.topicReplyCount }))
      ])
    );
    contents.push(
      h("li.secondary", [
        numberNode(attrs.topicViews, { className: attrs.topicViewsHeat }),
        h("h4", { attributes: { role: "presentation" } }, I18n.t("views_lowercase", { count: attrs.topicViews }))
      ])
    );
    ...
    if (attrs.participantCount > 0) {
      contents.push(
        h("li.secondary", [
          ...
          h("h4", { attributes: { role: "presentation" } }, I18n.t("users_lowercase", { count: attrs.participantCount }))
        ])
      );
    }
    ...
    if (attrs.topicLikeCount) {
      contents.push(
        h("li.secondary", [
          ...
          h("h4", { attributes: { role: "presentation" } }, I18n.t("likes_lowercase", { count: attrs.topicLikeCount }))
        ])
      );
    }
    ...
    if (attrs.topicLinkLength > 0) {
      contents.push(
        h("li.secondary", [
          ...
          h("h4", { attributes: { role: "presentation" } }, I18n.t("links_lowercase", { count: attrs.topicLinkLength }))
        ])
      );
    }
