import { cloak, uncloak } from "discourse/widgets/post-stream-opinion";
...
export default MountWidget.extend({
  ...
  didInsertElement() {
    ...
    this.appEvents.on("post-stream-opinion:refresh", this, "_debouncedScroll");
    const opts = {
      passive: true,
    };
    ...
    this.appEvents.on("post-stream-opinion:posted", this, "_posted");
    ...
    this.appEvents.on("post-stream-opinion:refresh", this, "_refresh");
  ...
  willDestroyElement() {
    ...
    this.appEvents.off("post-stream-opinion:refresh", this, "_debouncedScroll");
    ...
    this.appEvents.off("post-stream-opinion:refresh", this, "_refresh");
    this.appEvents.off("post-stream-opinion:posted", this, "_posted");
  },
