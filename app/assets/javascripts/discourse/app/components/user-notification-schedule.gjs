...
export default class UserNotificationSchedule extends Component {<template><div class="control-group notification-schedule" data-setting-name="user-notification-schedule">
  <label class="control-label">{{iN "user.notification_schedule.title"}}</label>
  ...
  {{#if this.model.user_notification_schedule.enabled}}
    <div class="instruction">{{iN "user.notification_schedule.tip"}}</div>
