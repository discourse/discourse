...
<template><div class="calendar-date-time-input" {{didInsert this.setupInternalDateTime}} {{didInsert this.setupPikaday}} {{didUpdate this.changeMinDate @minDate}} {{didUpdate this.changeDate @date}} {{didUpdate this.changeTime @time}}>
