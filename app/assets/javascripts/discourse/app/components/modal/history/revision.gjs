          ...
          <ul class="nav nav-pills">
            <li>
              <a
                ...
                title={{iN "post.revisions.displays.inline.title"}}
                aria-label={{iN "post.revisions.displays.inline.title"}}
              >
                {{dIcon "far-square"}}
            ...
            <li>
              <a
                ...
                title={{iN "post.revisions.displays.side_by_side.title"}}
                aria-label={{iN "post.revisions.displays.side_by_side.title"}}
              >
                {{dIcon "table-columns"}}
