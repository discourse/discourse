...
<template><DModal @bodyClass="reject-reason-reviewable-modal__explain-reviewable" @closeModal={{@closeModal}} @title={{i18n "review.reject_reason.title"}} class="reject-reason-reviewable-modal">
  <:body>
