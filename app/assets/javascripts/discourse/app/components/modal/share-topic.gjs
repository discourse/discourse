...
) {<template><DModal @title={{if this.post (iN "post.share.title" post_number=this.post.post_number) (iN "topic.share.title")}} @subtitle={{if this.post this.displayDate}} @closeModal={{@closeModal}} @flash={{this.flash}} @flashType={{this.flashType}} class="share-topic-modal">
  <form>
    <div class="input-group invite-link">
      <label for="invite-link">
        {{if this.post (iN "post.share.instructions" post_number=this.post.post_number) (iN "topic.share.instructions")}}
      </label>
