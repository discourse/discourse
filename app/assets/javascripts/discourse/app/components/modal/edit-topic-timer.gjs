...
<template><DModal @title={{i18n0 "topic.topic_status_update.title"}} @flash={{this.flash}} @closeModal={{@closeModal}} autoFocus="false" id="topic-timer-modal" class="edit-topic-timer-modal">
  <:body>
    {{#if this.topicTimer}}
