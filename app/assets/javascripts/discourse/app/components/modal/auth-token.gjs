...
<template><DModal @title={{i18n "user.auth_tokens.was_this_you"}} @closeModal={{@closeModal}}>
  <:body>
    <div>
    ...
    <div>
      ...
      <ul>
        ...
        <li>{{icon @model.icon}}
          {{i18n "user.auth_tokens.browser_and_device" browser=@model.browser device=@model.device}}</li>
      </ul>
    </div>
