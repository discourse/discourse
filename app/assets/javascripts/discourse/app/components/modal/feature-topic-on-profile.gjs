...
<template><DModal @closeModal={{@closeModal}} class="feature-topic-on-profile choose-topic-modal" id="choosing-topic" @title={{i18n "user.feature_topic_on_profile.title"}}>
  <:body>
