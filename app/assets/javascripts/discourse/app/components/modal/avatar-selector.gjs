...
<template><DModal @bodyClass="avatar-selector" @closeModal={{@closeModal}} @title={{i18n "user.change_avatar.title"}} class="avatar-selector-modal">
  <:body>
      ...
      {{#if this.allowAvatarUpload}}
        <div class="avatar-choice">
          ...
          <label class="radio" for="gravatar">
            ...
            <span>
              {{htmlSafe (i18n "user.change_avatar.gravatar" gravatarName=this.siteSettings.gravatar_name gravatarBaseUrl=this.siteSettings.gravatar_base_url gravatarLoginUrl=this.siteSettings.gravatar_login_url)}}
              {{this.user.email}}
            </span>
          </label>

          <DButton @action={{this.refreshGravatar}} @translatedTitle={{i18n "user.change_avatar.refresh_gravatar_title" gravatarName=this.siteSettings.gravatar_name}} @disabled={{this.gravatarRefreshDisabled}} @icon="arrows-rotate" class="btn-default avatar-selector-refresh-gravatar" />
