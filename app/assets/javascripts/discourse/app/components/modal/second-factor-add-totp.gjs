...
export default class SecondFactorAddTotp extends Component {
  <template>
    <DModal
      ...
      @title={{iN "user.second_factor.totp.add"}}
    ...
    >
      <:body>
        <ConditionalLoadingSpinner @condition={{this.loading}}>
            ...
            <div class="controls">
              ...
              <p>
                ...
                {{else}}
                  ...
                  >{{iN "user.second_factor.show_key_description"}}</a>
                {{/if}}
              </p>
            </div>
          </div>
          ...
          <div class="control-group">
            <label class="control-label input-prepend">{{iN
            ...
            <div class="controls">
              <input
                ...
                type="text"
                placeholder={{iN "user.second_factor.totp.default_name"}}
