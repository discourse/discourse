import { cloak, uncloak } from "discourse/widgets/post-stream-sponsor";
...
export default MountWidget.extend({
  ...
  didInsertElement() {
    ...
    this.appEvents.on("post-stream-sponsor:refresh", this, "_debouncedScroll");
    const opts = {
      passive: true,
    };
    ...
    this.appEvents.on("post-stream-sponsor:posted", this, "_posted");
    ...
    this.appEvents.on("post-stream-sponsor:refresh", this, "_refresh");
  ...
  willDestroyElement() {
    ...
    this.appEvents.off("post-stream-sponsor:refresh", this, "_debouncedScroll");
    ...
    this.appEvents.off("post-stream-sponsor:refresh", this, "_refresh");
    this.appEvents.off("post-stream-sponsor:posted", this, "_posted");
  },
