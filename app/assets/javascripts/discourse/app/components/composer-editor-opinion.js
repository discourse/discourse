...
export default Component.extend(ComposerUploadUppy, {
  ...
  composerModelContentKey: "replyOpinion",
  ...
  replyPlaceholder(requiredCategoryMissing) {
    if (requiredCategoryMissing) {
      return "composer.reply_opinion_placeholder_choose_category";
    } else {
  ...
  _afterMentionComplete(value) {
    this.composer.set("replyOpinion", value);
  ...
  @discourseComputed(
    "composer.replyOpinion",
    "composer.replyOpinionLength",
  ...
  _handleImageScaleButtonClick(event) {
    ...
    const matchingPlaceholder =
      this.get("composer.replyOpinion").match(IMAGE_MARKDOWN_REGEX);
