...
const Tags = <template>{{#if @siteSettings.tagging_enabled}}
  <div class="control-group tag-notifications">
    ...
    <div class="controls tracking-controls tracking-controls__watched-tags">
      ...
      <TagChooser @tags={{@model.watched_tags}} @blockedTags={{@selectedTags}} @everyTag={{true}} @unlimitedTagCount={{true}} @options={{hash allowAny=false}} />
    </div>
    ...
    <div class="controls tracking-controls tracking-controls__tracked-tags">
      ...
      <TagChooser @tags={{@model.tracked_tags}} @blockedTags={{@selectedTags}} @everyTag={{true}} @unlimitedTagCount={{true}} @options={{hash allowAny=false}} />
    </div>
    ...
    <div class="controls tracking-controls tracking-controls__watched-first-post-tags">
      ...
      <TagChooser @tags={{@model.watching_first_post_tags}} @blockedTags={{@selectedTags}} @everyTag={{true}} @unlimitedTagCount={{true}} @options={{hash allowAny=false}} />
    </div>
    ...
    <div class="controls tracking-controls tracking-controls__muted-tags">
      ...
      <TagChooser @tags={{@model.muted_tags}} @blockedTags={{@selectedTags}} @everyTag={{true}} @unlimitedTagCount={{true}} @options={{hash allowAny=false}} />
    </div>
    <div class="instructions">{{i18n "user.muted_tags_instructions"}}</div>
  </div>

  <PluginOutlet @name="user-preferences-tags" @connectorTagName="div" @outletArgs={{hash model=@model save=@save}} />
