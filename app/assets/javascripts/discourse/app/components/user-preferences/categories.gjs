...
const Categories = <template><div class="control-group category-notifications">
  ...
  <div class="controls tracking-controls tracking-controls__watched-categories">
    ...
    {{/if}}
    <CategorySelector @categories={{@model.watchedCategories}} @blockedCategories={{@selectedCategories}} @onChange={{fn (mut @model.watchedCategories)}} />
  </div>
  ...
  <div class="controls tracking-controls tracking-controls__tracked-categories">
    ...
    {{/if}}
    <CategorySelector @categories={{@model.trackedCategories}} @blockedCategories={{@selectedCategories}} @onChange={{fn (mut @model.trackedCategories)}} />
  </div>
  ...
  <div class="controls tracking-controls tracking-controls__watched-first-categories">
    ...
    <CategorySelector @categories={{@model.watchedFirstPostCategories}} @blockedCategories={{@selectedCategories}} @onChange={{fn (mut @model.watchedFirstPostCategories)}} />
  </div>
  ...
  {{#if @siteSettings.mute_all_categories_by_default}}
    <div class="controls tracking-controls tracking-controls__regular-categories">
      ...
      <CategorySelector @categories={{@model.regularCategories}} @blockedCategories={{@selectedCategories}} @onChange={{fn (mut @model.regularCategories)}} />
    </div>
  ...
  {{else}}
    <div class="controls tracking-controls tracking-controls__muted-categories">
      ...
      <CategorySelector @categories={{@model.mutedCategories}} @blockedCategories={{@selectedCategories}} @onChange={{fn (mut @model.mutedCategories)}} />
    </div>
...
<span>
  <PluginOutlet @name="user-preferences-categories" @connectorTagName="div" @outletArgs={{hash model=@model save=@save}} />
</span>

<br />

<span>
  <PluginOutlet @name="user-custom-controls" @connectorTagName="div" @outletArgs={{hash model=@model}} />
</span></template>;
