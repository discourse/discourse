...
<template><div class="reviewable-user-info">
  <div class="reviewable-user-fields">
    ...
    <ReviewableField @classes="reviewable-user-details name" @name={{i18n "review.user.name"}} @value={{this.reviewable.payload.name}} />

    <ReviewableField @classes="reviewable-user-details email" @name={{i18n "review.user.email"}} @value={{this.reviewable.payload.email}} />

    <ReviewableField @classes="reviewable-user-details bio" @name={{i18n "review.user.bio"}} @value={{this.reviewable.payload.bio}} />
    ...
    <ReviewableField @classes="reviewable-user-details reject-reason" @name={{i18n "review.user.reject_reason"}} @value={{this.reviewable.reject_reason}} />
