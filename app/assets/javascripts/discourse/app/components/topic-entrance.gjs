...
<template><DButton @action={{action "enterTop"}} @translatedAriaLabel={{i18n0 "topic_entrance.sr_jump_top_button" date=this.topDate}} title={{i18n0 "topic_entrance.jump_top_button_title"}} class="btn-default full jump-top">
  {{icon "backward-step"}}
  {{htmlSafe this.topDate}}
</DButton>

<DButton @action={{action "enterBottom"}} @translatedAriaLabel={{i18n0 "topic_entrance.sr_jump_bottom_button" date=this.bottomDate}} title={{i18n0 "topic_entrance.jump_bottom_button_title"}} class="btn-default full jump-bottom">
