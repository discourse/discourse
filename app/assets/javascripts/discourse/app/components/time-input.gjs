...
<template><ComboBox @value={{this.time}} @content={{this.timeOptions}} @onChange={{action "onChangeTime"}} @options={{hash translatedNone="--:--" allowAny=true filterable=false autoInsertNoneItem=false translatedFilterPlaceholder="--:--"}} /></template>}
