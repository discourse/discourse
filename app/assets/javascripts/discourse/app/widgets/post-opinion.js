...
createWidget("post-article-opinion", {
...
export default createWidget("post-opinion", {
  ...
  html(attrs) {
    ...
    return this.attach("post-article-opinion", attrs);
  },
