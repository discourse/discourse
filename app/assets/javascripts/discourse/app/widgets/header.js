...
export default createWidget("header", {
      ...
      if (state.searchVisible) {
        panels.push(
          this.attach("search-menu", {
            forceTopicContext: state.forceTopicContext,
          })
        );
  ...
  toggleSearchMenu() {
    ...
    if (this.state.searchVisible) {
      ...
      this.state.forceTopicContext = false;
    }
  },
