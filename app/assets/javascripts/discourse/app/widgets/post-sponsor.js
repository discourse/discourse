...
createWidget("post-article-sponsor", {
    ...
    if (attrs.replyToUsername) {
      rows.push(
        h("div.row", [
          ...
          this.attach("post-body-sponsor", attrs),
        ])
      );
    } else {
      rows.push(
...
export default createWidget("post-sponsor", {
  ...
  html(attrs) {
    ...
    return this.attach("post-article-sponsor", attrs);
  },
