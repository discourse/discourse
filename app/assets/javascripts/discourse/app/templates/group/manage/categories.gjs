...
export default RouteTemplate(<template><form class="groups-form form-vertical groups-notifications-form">
  ...
  <div class="control-group">
    ...
    <CategorySelector @categories={{@controller.model.watchingCategories}} @blockedCategories={{@controller.selectedCategories}} @onChange={{fn (mut @controller.model.watchingCategories)}} />
  ...
  <div class="control-group">
    ...
    <CategorySelector @categories={{@controller.model.trackingCategories}} @blockedCategories={{@controller.selectedCategories}} @onChange={{fn (mut @controller.model.trackingCategories)}} />
  ...
  <div class="control-group">
    ...
    <CategorySelector @categories={{@controller.model.watchingFirstPostCategories}} @blockedCategories={{@controller.selectedCategories}} @onChange={{fn (mut @controller.model.watchingFirstPostCategories)}} />
  ...
  <div class="control-group">
    ...
    <CategorySelector @categories={{@controller.model.regularCategories}} @blockedCategories={{@controller.selectedCategories}} @onChange={{fn (mut @controller.model.regularCategories)}} />
  ...
  <div class="control-group">
    ...
    <CategorySelector @categories={{@controller.model.mutedCategories}} @blockedCategories={{@controller.selectedCategories}} @onChange={{fn (mut @controller.model.mutedCategories)}} />
