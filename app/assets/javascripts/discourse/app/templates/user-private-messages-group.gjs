...
export default RouteTemplate(<template><MessagesSecondaryNav>
  ...
  {{#if @controller.viewingSelf}}
    <DNavigationItem @route="userPrivateMessages.group.new" @ariaCurrentContext="subNav" class="user-nav__messages-group-new">
      {{icon "circle-exclamation"}}
      <span>{{@controller.newLinkText}}</span>
    </DNavigationItem>

    <DNavigationItem @route="userPrivateMessages.group.unread" @ariaCurrentContext="subNav" class="user-nav__messages-group-unread">
      {{icon "circle-plus"}}
      <span>{{@controller.unreadLinkText}}</span>
    </DNavigationItem>

    <DNavigationItem @route="userPrivateMessages.group.archive" @ariaCurrentContext="subNav" class="user-nav__messages-group-archive">
      {{icon "box-archive"}}
...
{{#in-element @controller.navigationControlsButton}}
  <GroupNotificationsTracking @levelId={{@controller.group.group_user.notification_level}} @onChange={{@controller.changeGroupNotificationLevel}} />
{{/in-element}}
