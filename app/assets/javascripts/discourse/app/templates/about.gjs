        ...
        <div class="contents clearfix body-page">
          ...
          <ul class="nav-pills">
            <li class="nav-item-about"><LinkTo
                @route="about"
                class="active"
              >{{iN "about.simple_title"}}</LinkTo></li>
            {{#if @controller.faqOverridden}}
              <li class="nav-item-guidelines"><LinkTo @route="guidelines">{{iN
                    "guidelines"
                  }}</LinkTo></li>
              <li class="nav-item-faq"><LinkTo @route="faq">{{iN
                    "faq"
                  }}</LinkTo></li>
            ...
            {{#if @controller.site.tos_url}}
              <li class="nav-item-tos"><LinkTo @route="tos">{{iN
                    "tos"
                  }}</LinkTo></li>
            {{/if}}
            {{#if @controller.site.privacy_policy_url}}
              <li class="nav-item-privacy"><LinkTo @route="privacy">{{iN
                    "privacy"
                  }}</LinkTo></li>
            {{/if}}
          </ul>
