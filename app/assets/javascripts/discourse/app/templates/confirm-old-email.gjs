...
export default RouteTemplate(<template><div id="simple-container">
  <div class="confirm-old-email">
    ...
    {{#if @controller.model.old_email}}
      <p>
        {{i18n "user.change_email.authorizing_old.old_email" email=@controller.model.old_email}}
      </p>
    {{/if}}
    <p>
      {{i18n "user.change_email.authorizing_old.new_email" email=@controller.model.new_email}}
    </p>
