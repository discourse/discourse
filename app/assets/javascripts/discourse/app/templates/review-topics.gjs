        ...
        <tr class="reviewable-topic">
          <td class="topic-title">
            <div class="combined-title">
              ...
              <a href={{rt.relative_url}} rel="noopener noreferrer" target="_blank">{{replaceEmoji rt.title}}</a>
            </div>
          </td>
          ...
          <td class="reviewable-details">
            <ReviewableClaimedTopic @topicId={{rt.id}} @claimedBy={{rt.claimed_by}} @onClaim={{fn (mut rt.claimed_by)}} />
