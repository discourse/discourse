              ...
              {{#each @controller.model.invites as |invite|}}
                <tr>
                  ...
                  {{#if @controller.model.can_see_invite_details}}
                    ...
                    <td>
                      <span title={{i18n "user.invited.days_visited"}}>{{htmlSafe invite.user.days_visited}}</span>
                      /
                      <span title={{i18n "user.invited.account_age_days"}}>{{htmlSafe invite.user.days_since_created}}</span>
                    </td>
                ...
                <tr>
                  <td class="invite-type">
                    ...
                    {{#each invite.groups as |g|}}
                      <p class="invite-extra"><a href="/g/{{g.name}}">{{icon "users"}}
                          {{g.name}}</a></p>
                    {{/each}}

                    {{#if invite.topic}}
                      <p class="invite-extra"><a href={{invite.topic.url}}>{{icon "file"}} {{invite.topic.title}}</a></p>
                    {{/if}}
                  </td>
