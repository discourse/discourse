...
export default RouteTemplate(<template><Layout @model={{@controller.model}}>
  <:navigation>
    <FilterNavigation @queryString={{@controller.q}} @updateTopicsListQueryParams={{@controller.updateTopicsListQueryParams}} @canBulkSelect={{@controller.canBulkSelect}} @bulkSelectHelper={{@controller.bulkSelectHelper}} />
  </:navigation>
  <:list>
