export default {
  inputRules: [
    ...
    // TODO: auto-link (https://github.com/markdown-it/markdown-it/blob/master/lib/rules_inline/autolink.mjs)
  ],
  plugins: ({ Plugin, Slice, Fragment }) =>
    new Plugin({
      props: {
        // Auto-linkify plain-text pasted URLs
        // TODO URLs copied from HTML will go through the regular HTML parsing
        //  it would be nice to auto-linkify them too
        clipboardTextParser(text, $context, plain, view) {
          // TODO a less naive regex
