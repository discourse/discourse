  ...
  acceptance(
    ...
    function (needs) {
      ...
      test("Share Modal", async function (assert) {
        await visit("/t/internationalization-localization/280");
        await click(".topic-post-shim:first-child button.share");
      ...
      test("Copy Link Button", async function (assert) {
        await visit("/t/internationalization-localization/280");
        await click(
          ".topic-post-shim:first-child button.post-action-menu__copy-link"
        );
      ...
      test("Marking a topic as wiki", async function (assert) {
        ...
        await click(
          ".topic-post-shim:nth-of-type(1) button.show-post-admin-menu"
        );
      ...
      test("Deleting a topic", async function (assert) {
        ...
        await visit("/t/internationalization-localization/280");
        await click(".topic-post-shim:nth-of-type(1) button.show-more-actions");
        await click(".topic-post-shim:nth-of-type(1) button.delete");
