...
module("Integration | Component | Widget | button", function (hooks) {
  ...
  test("icon only button", async function (assert) {const self = this;

    this.set("args", { icon: "far-face-smile" });

    await render(<template><MountWidget @widget="button" @args={{self.args}} /></template>);
  ...
  test("icon and text button", async function (assert) {const self = this;
  ...
  test("emoji and text button", async function (assert) {const self = this;
  ...
  test("text only button", async function (assert) {const self = this;
  ...
  test("translatedTitle", async function (assert) {const self = this;
  ...
  test("translatedLabel skips no-text class in icon", async function (assert) {const self = this;
