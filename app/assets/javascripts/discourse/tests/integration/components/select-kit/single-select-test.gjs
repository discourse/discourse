...
module("Integration | Component | select-kit/single-select", function (hooks) {
  ...
  test("content", async function (assert) {const self = this;
    ...
    await render(<template><SingleSelect @content={{self.content}} /></template>);
  ...
  test("accessibility", async function (assert) {const self = this;
  ...
  test("value", async function (assert) {const self = this;

    setDefaultState(this);

    await render(<template>
      <SingleSelect @value={{self.value}} @content={{self.content}} @nameProperty={{self.nameProperty}} @valueProperty={{self.valueProperty}} @onChange={{self.onChange}} />
    </template>);
  ...
  test("options.filterable", async function (assert) {const self = this;

    setDefaultState(this, { filterable: true });

    await render(<template>
      <SingleSelect @value={{self.value}} @content={{self.content}} @nameProperty={{self.nameProperty}} @valueProperty={{self.valueProperty}} @onChange={{self.onChange}} @options={{hash filterable=self.filterable}} />
    </template>);
  ...
  test("options.limitMatches", async function (assert) {const self = this;

    setDefaultState(this, { limitMatches: 1, filterable: true });

    await render(<template>
      <SingleSelect @value={{self.value}} @content={{self.content}} @nameProperty={{self.nameProperty}} @valueProperty={{self.valueProperty}} @onChange={{self.onChange}} @options={{hash limitMatches=self.limitMatches filterable=self.filterable}} />
    </template>);
  ...
  test("valueAttribute (deprecated)", async function (assert) {const self = this;
    ...
    await render(<template>
      <SingleSelect @value={{self.value}} @content={{self.content}} @valueAttribute="value" />
    </template>);
  ...
  test("none:string", async function (assert) {const self = this;

    I18n.translations[I18n.locale].js.test = { none: "(default)" };
    setDefaultState(this, { value: 1 });

    await render(<template>
      <SingleSelect @value={{self.value}} @content={{self.content}} @nameProperty={{self.nameProperty}} @valueProperty={{self.valueProperty}} @onChange={{self.onChange}} @options={{hash none="test.none"}} />
    </template>);
  ...
  test("none:object", async function (assert) {const self = this;

    setDefaultState(this, { none: { value: null, name: "(default)" } });

    await render(<template>
      <SingleSelect @value={{self.value}} @content={{self.content}} @nameProperty={{self.nameProperty}} @valueProperty={{self.valueProperty}} @onChange={{self.onChange}} @options={{hash none=self.none}} />
    </template>);
  ...
  test("content is a basic array", async function (assert) {const self = this;
  ...
  test("selected value can be 0", async function (assert) {const self = this;
  ...
  test("prevents propagating click event on header", async function (assert) {const self = this;
    ...
    await render(<template>
      <DButton @icon="xmark" @action={{self.onClick}}>
        <SingleSelect @value={{self.value}} @content={{self.content}} @options={{hash preventsClickPropagation=true}} />
      </DButton>
    </template>);
  ...
  test("labelProperty", async function (assert) {const self = this;
    ...
    await render(<template>
      <SingleSelect @labelProperty="foo" @value={{self.value}} @content={{self.content}} />
    </template>);
  ...
  test("titleProperty", async function (assert) {const self = this;
    ...
    await render(<template>
      <SingleSelect @titleProperty="foo" @value={{self.value}} @content={{self.content}} />
    </template>);
  ...
  test("langProperty", async function (assert) {const self = this;
    ...
    await render(
      <template><SingleSelect @langProperty="foo" @value={{self.value}} @content={{self.content}} /></template>
    );
  ...
  test("name", async function (assert) {const self = this;
    ...
    await render(
      <template><SingleSelect @value={{self.value}} @content={{self.content}} /></template>
    );
  ...
  test("row index", async function (assert) {const self = this;
  ...
  test("options.verticalOffset", async function (assert) {const self = this;

    setDefaultState(this, { verticalOffset: -50 });
    await render(<template>
      <SingleSelect @value={{self.value}} @content={{self.content}} @nameProperty={{self.nameProperty}} @valueProperty={{self.valueProperty}} @onChange={{self.onChange}} @options={{hash verticalOffset=self.verticalOffset}} />
    </template>);
    await this.subject.expand();
  ...
  test("options.expandedOnInsert", async function (assert) {const self = this;

    setDefaultState(this);
    await render(<template>
      <SingleSelect @value={{self.value}} @content={{self.content}} @options={{hash expandedOnInsert=true}} />
    </template>);

    assert.dom(".single-select.is-expanded").exists();
  });

  test("options.formName", async function (assert) {const self = this;

    setDefaultState(this);
    await render(<template>
      <SingleSelect @value={{self.value}} @content={{self.content}} @options={{hash formName="foo"}} />
    </template>);
