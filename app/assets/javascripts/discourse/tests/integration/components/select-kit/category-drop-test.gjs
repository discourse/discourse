...
import CategoryDrop, { ALL_CATEGORIES_ID, NO_CATEGORIES_ID } from "select-kit/components/category-drop";
...
module("Integration | Component | select-kit/category-drop", function (hooks) {
  ...
  test("caretUpIcon", async function (assert) {const self = this;
  ...
  test("none", async function (assert) {const self = this;
  ...
  test("[not staff - TL0] displayCategoryDescription", async function (assert) {const self = this;
    ...
    await render(<template>
      <CategoryDrop @category={{self.category}} @categories={{self.categories}} @parentCategory={{self.parentCategory}} />
    </template>);
  ...
  test("[not staff - TL1] displayCategoryDescription", async function (assert) {const self = this;
  ...
  test("[staff - TL0] displayCategoryDescription", async function (assert) {const self = this;
  ...
  test("hideParentCategory (default: false)", async function (assert) {const self = this;
  ...
  test("hideParentCategory (true)", async function (assert) {const self = this;

    initCategoriesWithParentCategory(this);

    await render(<template>
      <CategoryDrop @category={{self.category}} @categories={{self.categories}} @parentCategory={{self.parentCategory}} @options={{hash hideParentCategory=true}} />
    </template>);
  ...
  test("allow_uncategorized_topics (true)", async function (assert) {const self = this;
  ...
  test("allow_uncategorized_topics (false)", async function (assert) {const self = this;
  ...
  test("countSubcategories (default: false)", async function (assert) {const self = this;
  ...
  test("countSubcategories (true)", async function (assert) {const self = this;

    initCategories(this);

    await render(<template>
      <CategoryDrop @category={{self.category}} @categories={{self.categories}} @parentCategory={{self.parentCategory}} @options={{hash countSubcategories=true}} />
    </template>);
  ...
  test("shortcuts:default", async function (assert) {const self = this;
  ...
  test("shortcuts:category is set", async function (assert) {const self = this;
  ...
  test("shortcuts with parentCategory/subCategory=true:default", async function (assert) {const self = this;

    initCategoriesWithParentCategory(this);

    await render(<template>
      <CategoryDrop @category={{self.category}} @categories={{self.categories}} @parentCategory={{self.parentCategory}} @options={{hash subCategory=true}} />
    </template>);
  ...
  test("shortcuts with parentCategory/subCategory=true:category is selected", async function (assert) {const self = this;
  ...
  test("category url", async function (assert) {const self = this;
