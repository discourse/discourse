...
module("Integration | Component | FloatKit | d-tooltip", function (hooks) {
  ...
  test("@label", async function (assert) {
    await render(<template><DTooltip @inline={{true}} @label="label" /></template>);

    assert.dom(".fk-d-tooltip__label").hasText("label");
  });

  test("@icon", async function (assert) {
    await render(<template><DTooltip @inline={{true}} @icon="check" /></template>);
  ...
  test("@content", async function (assert) {
    await render(
      <template><DTooltip @inline={{true}} @label="label" @content="content" /></template>
    );
    await hover();
  ...
  test("@onRegisterApi", async function (assert) {const self = this;
    ...
    await render(
      <template><DTooltip @inline={{true}} @onRegisterApi={{self.onRegisterApi}} /></template>
    );
  ...
  test("@onShow", async function (assert) {const self = this;
    ...
    await render(<template><DTooltip @inline={{true}} @onShow={{self.onShow}} /></template>);
  ...
  test("@onClose", async function (assert) {const self = this;
    ...
    await render(<template><DTooltip @inline={{true}} @onClose={{self.onClose}} /></template>);
    await hover();
    await close();
  ...
  test("@identifier", async function (assert) {
    await render(
      <template><DTooltip @inline={{true}} @label="label" @identifier="tip" /></template>
    );
  ...
  test("<:trigger>", async function (assert) {
    await render(
      <template><DTooltip @inline={{true}}><:trigger>label</:trigger></DTooltip></template>
    );
  ...
  test("<:content>", async function (assert) {
    await render(
      <template><DTooltip @inline={{true}}><:content>content</:content></DTooltip></template>
    );
  ...
  test("@component", async function (assert) {const self = this;
    ...
    await render(
      <template><DTooltip @inline={{true}} @label="test" @component={{self.component}} @data={{hash message="content"}} /></template>
    );
  ...
  test("@closeOnEscape", async function (assert) {
    await render(
      <template><DTooltip @inline={{true}} @label="label" @closeOnEscape={{true}} /></template>
    );
    await hover();
    await close();
    ...
    await render(
      <template><DTooltip @inline={{true}} @label="label" @closeOnEscape={{false}} /></template>
    );
    await hover();
    await close();
  ...
  test("@closeOnClickOutside", async function (assert) {
    await render(
      <template><span class="test">test</span><DTooltip @inline={{true}} @label="label" @closeOnClickOutside={{true}} /></template>
    );
    await hover();
    ...
    await render(
      <template><span class="test">test</span><DTooltip @inline={{true}} @label="label" @closeOnClickOutside={{false}} /></template>
    );
    await hover();
    await triggerEvent(".test", "pointerdown");
  ...
  test("@maxWidth", async function (assert) {
    await render(
      <template><DTooltip @inline={{true}} @label="label" @maxWidth={{20}} /></template>
    );
    await hover();
  ...
  test("a tooltip can be closed by identifier", async function (assert) {
    await render(
      <template><DTooltip @inline={{true}} @label="label" @identifier="test">test</DTooltip></template>
    );
    await hover();
