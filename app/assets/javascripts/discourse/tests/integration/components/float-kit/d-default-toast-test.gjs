...
module(
  ...
  function (hooks) {
    ...
    test("icon", async function (assert) {const self = this;
      ...
      await render(<template><DDefaultToast @data={{self.toast.options.data}} /></template>);

      assert.dom(".fk-d-default-toast__icon-container .d-icon-check").exists();
    });

    test("no icon", async function (assert) {const self = this;
    ...
    test("progress bar", async function (assert) {const self = this;

      this.toast = new DToastInstance(this, {});

      await render(
        <template><DDefaultToast @data={{self.toast.options.data}} @showProgressBar={{true}} @onRegisterProgressBar={{(noop)}} /></template>
      );

      assert.dom(".fk-d-default-toast__progress-bar").exists();
    });

    test("no progress bar", async function (assert) {const self = this;

      this.toast = new DToastInstance(this, {});

      await render(
        <template><DDefaultToast @data={{self.toast.options.data}} @showProgressBar={{false}} /></template>
      );
    ...
    test("no title", async function (assert) {const self = this;
    ...
    test("message", async function (assert) {const self = this;
    ...
    test("no message", async function (assert) {const self = this;
    ...
    test("actions", async function (assert) {const self = this;
