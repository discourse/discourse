...
import { selectKit } from "select-kit/mixins/plugin-api";
...
class PluginApi {
  ...
  * Example:
  *
  * selectKit("topic-footer-mobile-dropdown").appendContent((component) => [{
  *   name: "discourse",
  *   id: 1
  * }])
  */
  selectKit(pluginApiKey) {
    return selectKit(pluginApiKey);
  }
}
