...
Discourse.SiteContent = Discourse.Model.extend({
  ...
  **/
  save: function() {
    return Discourse.ajaxUncaughtError("/admin/site_contents/" + this.get('content_type'), {
      type: 'PUT',
...
Discourse.SiteContent.reopenClass({
  ...
  find: function(type) {
    return Discourse.ajaxUncaughtError("/admin/site_contents/" + type).then(function (data) {
