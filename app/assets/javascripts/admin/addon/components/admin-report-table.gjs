    ...
    <tr>
      {{#if this.model.computedLabels}}
        {{#each this.model.computedLabels as |label|}}
          <AdminReportTableHeader @showSortingUI={{this.showSortingUI}} @currentSortDirection={{this.sortDirection}} @currentSortLabel={{this.sortLabel}} @label={{label}} @sortByLabel={{fn this.sortByLabel label}} />
        {{/each}}
      {{else}}
  ...
  <tbody>
    ...
    {{#if this.showTotal}}
      ...
      <tr class="admin-report-table-row">
        ...
        <td class="admin-report-table-cell number y">{{this.formattedTotal}}</td>
      </tr>
    {{/if}}
    ...
    {{#if this.showAverage}}
      ...
      <tr class="admin-report-table-row">
        <td class="admin-report-table-cell date x">—</td>
        <td class="admin-report-table-cell number y">{{this.averageForSample}}</td>
      </tr>
    {{/if}}
  </tbody>
</table>
...
<div class="pagination">
  {{#each this.pages as |pageState|}}
    <DButton @translatedLabel={{pageState.page}} @action={{fn this.changePage pageState.index}} class={{pageState.class}} />
  {{/each}}
</div></template>}
