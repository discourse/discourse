...
<template><div class="penalty-post-controls">
  <label>
    <div class="penalty-post-label">
      {{htmlSafe (i18n0 "admin.user.penalty_post_actions")}}
    </div>
  </label>
  <ComboBox @value={{this.postAction}} @content={{this.penaltyActions}} @onChange={{this.penaltyChanged}} />
</div>
