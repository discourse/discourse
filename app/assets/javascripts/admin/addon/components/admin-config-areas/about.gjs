...
export default class AdminConfigAreasAbout extends Component {
  ...
  get extraGroups() {
    return {
      aboutPageExtraGroups: this.#lookupSettingFromData("about_page_extra_groups"),
      aboutPageExtraGroupsInitialMembers: this.#lookupSettingFromData("about_page_extra_groups_initial_members"),
      aboutPageExtraGroupsOrder: this.#lookupSettingFromData("about_page_extra_groups_order"),
      aboutPageExtraGroupsShowDescription: this.#lookupSettingFromData("about_page_extra_groups_show_description"),
    }
  }
