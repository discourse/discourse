...
const ApiKeysList = <template><div class="container admin-api_keys">
  ...
  {{else}}
    <AdminConfigAreaEmptyList @ctaLabel="admin.api_keys.add" @ctaRoute="adminApiKeys.new" @ctaClass="admin-api_keys__add-api_key" @emptyLabel="admin.api_keys.no_api_keys" />
  {{/if}}
</div></template>;
