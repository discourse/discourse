...
<div class="admin-webhooks__summary">
  <h1>
    ...
    <DButton @action={{@controller.edit}} @icon="far-pen-to-square" @title="admin.web_hooks.edit" class="no-text admin-webhooks__edit-button" />

    <DButton @action={{@controller.destroyWebhook}} @icon="xmark" @title="delete" class="destroy btn-danger admin-webhooks__delete-button" />
  </h1>
