...
<DashboardProblems @loadingProblems={{@controller.loadingProblems}} @problems={{@controller.problems}} @problemsTimestamp={{@controller.problemsTimestamp}} @refreshProblems={{action "refreshProblems"}} />
<nav>
