...
export default RouteTemplate(<template><div class="admin-controls">
  <nav>
    <ul class="nav nav-pills">
      <li><LinkTo @route="adminUser" @model={{@controller.model}}>{{dIcon "caret-left"}}
...
<div class="admin-container tl3-requirements">
  ...
  <br />
  <p>{{i18n "admin.user.tl3_requirements.table_title" count=@controller.model.tl3Requirements.time_period}}</p>
  ...
  <table class="table" style="width: auto;">
    ...
    <tbody>
      <tr>
        ...
        <td>{{checkIcon @controller.model.tl3Requirements.met.topics_replied_to}}</td>
        <td>{{#if @controller.model.tl3Requirements.capped_topics_replied_to}}&ge;
      ...
      <tr>
        ...
        <td>{{checkIcon @controller.model.tl3Requirements.met.topics_viewed}}</td>
      ...
      <tr>
        ...
        <td>{{checkIcon @controller.model.tl3Requirements.met.topics_viewed_all_time}}</td>
        <td>{{@controller.model.tl3Requirements.topics_viewed_all_time}}</td>
        <td>{{@controller.model.tl3Requirements.min_topics_viewed_all_time}}</td>
      </tr>
      <tr>
        <th>{{i18n "admin.user.tl3_requirements.posts_read"}}</th>
        <td>{{checkIcon @controller.model.tl3Requirements.met.posts_read}}</td>
      ...
      <tr>
        ...
        <td>{{checkIcon @controller.model.tl3Requirements.met.days_visited}}</td>
        <td>
        ...
        <td>{{@controller.model.tl3Requirements.min_days_visited_percent}}%</td>
      </tr>
      <tr>
        <th>{{i18n "admin.user.tl3_requirements.posts_read_all_time"}}</th>
        <td>{{checkIcon @controller.model.tl3Requirements.met.posts_read_all_time}}</td>
        <td>{{@controller.model.tl3Requirements.posts_read_all_time}}</td>
        <td>{{@controller.model.tl3Requirements.min_posts_read_all_time}}</td>
      </tr>
      <tr>
        <th>{{i18n "admin.user.tl3_requirements.flagged_posts"}}</th>
        <td>{{checkIcon @controller.model.tl3Requirements.met.flagged_posts}}</td>
        <td>{{@controller.model.tl3Requirements.num_flagged_posts}}</td>
        <td>{{i18n "max_of_count" count=@controller.model.tl3Requirements.max_flagged_posts}}</td>
      </tr>
      <tr>
        <th>{{i18n "admin.user.tl3_requirements.flagged_by_users"}}</th>
        <td>{{checkIcon @controller.model.tl3Requirements.met.flagged_by_users}}</td>
        <td>{{@controller.model.tl3Requirements.num_flagged_by_users}}</td>
        <td>{{i18n "max_of_count" count=@controller.model.tl3Requirements.max_flagged_by_users}}</td>
      </tr>
      <tr>
        <th>{{i18n "admin.user.tl3_requirements.likes_given"}}</th>
        <td>{{checkIcon @controller.model.tl3Requirements.met.likes_given}}</td>
      ...
      <tr>
        ...
        <td>{{checkIcon @controller.model.tl3Requirements.met.likes_received}}</td>
      ...
      <tr>
        ...
        <td>{{checkIcon @controller.model.tl3Requirements.met.likes_received_days}}</td>
        <td>{{@controller.model.tl3Requirements.num_likes_received_days}}</td>
        <td>{{@controller.model.tl3Requirements.min_likes_received_days}}</td>
      </tr>
      <tr>
        <th>{{i18n "admin.user.tl3_requirements.likes_received_users"}}</th>
        <td>{{checkIcon @controller.model.tl3Requirements.met.likes_received_users}}</td>
        <td>{{@controller.model.tl3Requirements.num_likes_received_users}}</td>
        <td>{{@controller.model.tl3Requirements.min_likes_received_users}}</td>
      </tr>
      <tr>
        <th>{{i18n "admin.user.tl3_requirements.silenced"}}</th>
        <td>{{checkIcon @controller.model.tl3Requirements.met.silenced}}</td>
        <td>{{@controller.model.tl3Requirements.penalty_counts.silenced}}</td>
        <td>0</td>
      </tr>
      <tr>
        <th>{{i18n "admin.user.tl3_requirements.suspended"}}</th>
        <td>{{checkIcon @controller.model.tl3Requirements.met.suspended}}</td>
        <td>{{@controller.model.tl3Requirements.penalty_counts.suspended}}</td>
        <td>0</td>
      </tr>
    </tbody>
  </table>
