...
export default RouteTemplate(<template><div class="sections">
  ...
  <div class="main-section">
    <AdminReport @dataSourceName="suspicious_logins" @filters={{@controller.lastWeekFilters}} />

    <AdminReport @dataSourceName="staff_logins" @filters={{@controller.lastWeekFilters}} />
