...
export default class Toasts extends Service {
   ...
   * @param {Boolean} [options.autoClose=true] - When true, the toast will auto close after the duration
   * @param {Boolean} [options.forceAutoClose=false] - When true, mouseover will not cancel the auto-close timer
