...
class AdminDashboardSectionConfiguration
  ...
  class << self
    def available_plugin_section_ids
    ...
    def all_known_section_ids
      builtin_section_ids + available_plugin_section_ids
    end

    def builtin_section_ids
    ...
    def plugin_setting_definition(section_id, key)
    ...
    def update_setting(section_id:, key:, attrs:)
      section_id = section_id.to_s
      key = key.to_s
    ...
    def update(input_sections, actor:)
      sanitized =
