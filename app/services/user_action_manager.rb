...
class UserActionManager
  ...
  class << self
    def topic_rows(topic)
      ...
      row = {
        action_type:
          topic.private_message? ? UserAction::NEW_PRIVATE_MESSAGE : UserAction::NEW_TOPIC,
    ...
    def notification_rows(post, user, notification_type, acting_user_id)
      action =
    ...
    def post_action_rows(post_action)
