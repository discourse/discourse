class UsernameChanger
  ...
  def initialize(user, new_username, actor = nil)
    ...
    username = Regexp.quote(@old_username)
  ...
  def change
    ...
    # TODO: these calls needs to be moved into a background job
    # Optionally make them runnable in foreground for rake tasks
    update_posts
    update_revisions
  ...
  def post_condition_args
    { mentioned: UserAction::MENTION, user_id: @user.id }
  end
