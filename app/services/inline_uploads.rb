...
class InlineUploads
  ...
  class << self
    def process(markdown, on_missing: nil)
  ...
  class << self
    ...
    def match_bbcode_img(markdown, external_src: false)
    ...
    def match_md_reference(markdown)
    ...
    def match_anchor(markdown, external_href: false)
    ...
    def match_img(markdown, external_src: false, uploads: nil)
    ...
    def matched_uploads(node)
      ...
      if GlobalSetting.cdn_url &&
           (cdn_url = GlobalSetting.cdn_url.sub(%r{https?://}, "(https?://)"))
