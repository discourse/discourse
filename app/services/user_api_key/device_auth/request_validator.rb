...
class UserApiKey::DeviceAuth::RequestValidator
  ...
  class << self
    ...
    def public_key_str(params, client)
    ...
    def validate_client_scopes!(client, scopes)
    ...
    def validate_public_key_constraints!(public_key)
    ...
    def validate_param_lengths!(params)
    ...
    def validate_param_length!(params, param_name, max_length)
