...
class UserApiKey::DeviceAuth::CodeRegistry
  ...
  class << self
    ...
    def load_by_user_code(user_code)
    ...
    def load_by_request_token(request_token)
    ...
    def user_code_matches_grant?(user_code, grant)
    ...
    def reserve_user_code!(device_code)
    ...
    def reserve_request_token!(device_code)
      MAX_COLLISION_ATTEMPTS.times do
