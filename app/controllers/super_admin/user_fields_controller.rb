...
class SuperAdmin::UserFieldsController < SuperAdmin::SuperAdminController
  def self.columns
    columns = %i[
      name
      field_type
  ...
  def create
    field = UserField.new(params.require(:user_field).permit(*SuperAdmin::UserFieldsController.columns))
  ...
  def update
    ...
    SuperAdmin::UserFieldsController.columns.each do |col|
