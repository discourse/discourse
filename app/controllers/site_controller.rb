  ...
  def basic_info
    results = {
      ...
      apple_touch_icon_url:
        UrlHelper.absolute(SiteSetting.site_apple_touch_icon_url),
      favicon_url: UrlHelper.absolute(SiteSetting.site_favicon_url),
      title: SiteSetting.title,
      description: SiteSetting.site_description,
      header_primary_color:
        ColorScheme.hex_for_name('header_primary') || '333333',
      header_background_color:
        ColorScheme.hex_for_name('header_background') || 'ffffff',
    ...
    DiscourseHub.stats_fetched_at = Time.zone.now if request.user_agent ==
      'Discourse Hub'
