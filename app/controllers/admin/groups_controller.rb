class Admin::GroupsController < Admin::AdminController
  ...
  def bulk_perform
    ...
    if group.present?
      ...
      valid_emails = {}
      valid_usernames = {}
      valid_users = User.joins(:primary_email).where("username_lower IN (:users) OR user_emails.email IN (:users)", users: users).pluck(:id, :username_lower, :"user_emails.email")
