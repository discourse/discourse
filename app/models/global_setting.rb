...
class GlobalSetting
  ...
  class << self
    ...
    def database_config(variables_overrides: {})
    ...
    def get_message_bus_redis_replica_host
    ...
    def get_message_bus_redis_replica_port
      ...
      if GlobalSetting.smtp_address
        settings = {
          ...
          enable_starttls_auto:
            !GlobalSetting.smtp_force_tls && GlobalSetting.smtp_enable_start_tls,
