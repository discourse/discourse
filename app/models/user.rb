...
class User < ActiveRecord::Base
  ...
  def password=(password)
    ...
    # We intentionally want to prepare expiry of the previous unexpired password at the User level since calling this method indicates intention to have a new unexpired password ; this also removes all in-mem passwords since it loads from db
    # Calling passwords.reload removes all previous in-mem only passwords
    ...
    @raw_password =
      passwords.build(salt:, password:, should_expire_previous_passwords: true).password
  end
