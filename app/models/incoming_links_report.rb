...
class IncomingLinksReport
  ...
  class << self
    ...
    def per_user(start_date:, end_date:, category_id:, include_subcategories:)
    ...
    def link_count_per_user(start_date:, end_date:, category_id:, include_subcategories:)
      per_user(
    ...
    def topic_count_per_user(start_date:, end_date:, category_id:, include_subcategories:)
      per_user(
        start_date: start_date,
        end_date: end_date,
        category_id: category_id,
    ...
    def per_domain(domains, options = {})
    ...
    def topic_count_per_domain(domains, options = {})
    ...
    def link_count_per_topic(start_date:, end_date:, category_id:, include_subcategories:)
      public_incoming_links(category_id: category_id, include_subcategories: include_subcategories)
        .where(
    ...
    def public_incoming_links(category_id: nil, include_subcategories: nil)
