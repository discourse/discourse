module Jobs
  class MigrateUrlSiteSettings < Jobs::Onceoff
    SETTINGS = [
      %w[logo_url logo],
      %w[logo_small_url logo_small],
      %w[digest_logo_url digest_logo],
      %w[mobile_logo_url mobile_logo],
      %w[large_icon_url large_icon],
      %w[favicon_url favicon],
      %w[apple_touch_icon_url apple_touch_icon],
      %w[default_opengraph_image_url opengraph_image],
      %w[twitter_summary_large_image_url twitter_summary_large_image],
      %w[push_notifications_icon_url push_notifications_icon]
    ]
      ...
      SETTINGS.each do |old_setting, new_setting|
        ...
        upload =
          UploadCreator.new(
            file,
            "#{new_setting}",
            origin: UrlHelper.absolute(old_url), for_site_setting: true
          )
