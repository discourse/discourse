      ...
      case entity
        when 'user'
          ...
          user_data.each do |user|
            ...
            user_array.push(user['id']).push(user['name']).push(user['username']).push(user['email']).push(user.user_stat['topic_count']).push(user.user_stat['post_count']).push(user.user_stat['likes_given']).push(user.user_stat['likes_received']).push(user.user_stat['topics_entered']).push(user.user_stat['posts_read_count']).push(user.user_stat['time_read'])
