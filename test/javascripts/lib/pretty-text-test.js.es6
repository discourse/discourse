...
QUnit.test("Links", assert => {
  ...
  assert.cooked(
    ...
    `<p>Youtube: <a href="http://www.youtube.com/watch?v=1MrpeBRkM5A" class="${INLINE_ONEBOX_CSS_CLASS}">http://www.youtube.com/watch?v=1MrpeBRkM5A</a></p>`,
    "allows links to contain query params"
  );

  assert.cooked(
    "Derpy: http://derp.com?__test=1",
    `<p>Derpy: <a href="http://derp.com?__test=1" class="${INLINE_ONEBOX_CSS_CLASS}">http://derp.com?__test=1</a></p>`,
  ...
  assert.cooked(
    ...
    `<p>Batman: <a href="http://en.wikipedia.org/wiki/The_Dark_Knight_(film)" class="${INLINE_ONEBOX_CSS_CLASS}">http://en.wikipedia.org/wiki/The_Dark_Knight_(film)</a></p>`,
  ...
  assert.cooked(
    ...
    `<ol>\n<li>View <span class="mention">@eviltrout</span>\'s profile here: <a href="http://meta.discourse.org/u/eviltrout/activity" class="${INLINE_ONEBOX_CSS_CLASS}">http://meta.discourse.org/u/eviltrout/activity</a><br>next line.</li>\n</ol>`,
  ...
  assert.cooked(
    ...
    '<p><a href="http://discourse.org">http://discourse.org</a> and ' +
      `<a href="http://discourse.org/another_url" class="${INLINE_ONEBOX_CSS_CLASS}">http://discourse.org/another_url</a> and ` +
      `<a href="http://www.imdb.com/name/nm2225369" class="${INLINE_ONEBOX_CSS_CLASS}">http://www.imdb.com/name/nm2225369</a></p>`,
