...
class HtmlToMarkdown
  ...
  ALLOWED_IMG_SRCS = %w[http:// https:// www.].freeze
  ...
  ALLOWED = %w[kbd del ins small big sub sup dl dd dt mark].freeze
  ALLOWED.each do |tag|
  ...
  TRAVERSABLES = %w[aside font span thead tbody tfoot u center].freeze
