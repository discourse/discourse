...
module NestedReplies
  module Sort
    ...
    class << self
      def sql_order_expression(algorithm, posts_table: "posts")
      ...
      def hot_score_values(post, scores)
        if scores.present?
