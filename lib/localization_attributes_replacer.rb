...
module LocalizationAttributesReplacer
  class << self
    def localize_category(category, locale)
    ...
    def replace_category_attributes(category, crawl_locale)
    ...
    def replace_topic_attributes(topic, crawl_locale)
    ...
    def replace_post_attributes(post, crawl_locale)
