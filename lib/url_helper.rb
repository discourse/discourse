...
class UrlHelper
  ...
  class << self
    ...
    def encode_component(url_component)
    ...
    def cook_url(url, secure: false, local: nil)
    ...
    def normalize_with_ruby_uri(url)
      u = URI.parse(url)
