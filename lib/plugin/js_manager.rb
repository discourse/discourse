...
module Plugin
  class JsManager
    ...
    class << self
      ...
      def required_plugin_stub(plugin_name)
        message =
      ...
      def test_js_asset_exists?(plugin_directory_name)
      ...
      def read_manifest(plugin_directory_name)
      ...
      def digested_logical_path_for(plugin_directory_name, entrypoint_name)
      ...
      def import_paths_for(plugin_directory_name, entrypoint_name)
        read_manifest(plugin_directory_name)[entrypoint_name]["imports"].map do
          "js/plugins/#{it.delete_suffix(".js")}"
        end
      end

      def external_plugin_imports(plugin_directory_name, entrypoint_name)
      ...
      def has_source_files_in_dir(plugin_directory_name, dir)
