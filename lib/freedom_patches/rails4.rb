...
module FreedomPatches
  module Rails4
    def self.distance_of_time_in_words(
      from_time, to_time = 0, include_seconds = false, options = {}
    )
      ...
      I18n.with_options locale: options[:locale],
        ...
        when 90..1439
          locale.t :about_x_hours,
                   count: (distance_in_minutes.to_f / 60.0).round
        when 1440..2519
        ...
        when 129600..525599
          ...
          leap_years =
            (fyear > tyear) ? 0 : (fyear..tyear).count { |x| Date.leap?(x) }
          minute_offset_for_leap_year = leap_years * 1440

          minutes_with_offset =
            distance_in_minutes - minute_offset_for_leap_year
