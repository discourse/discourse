  ...
  class Transpiler
    ...
    def self.create_new_context
      ...
      load_file_in_context(
        ctx,
        "discourse/node_modules/ember-source/dist/ember-template-compiler.js",
      )
      load_file_in_context(
        ctx,
        "discourse/node_modules/babel-plugin-ember-template-compilation/src/plugin.js",
        wrap_in_module: "babel-plugin-ember-template-compilation/index",
      )
      load_file_in_context(
        ctx,
        "discourse/node_modules/babel-plugin-ember-template-compilation/src/expression-parser.js",
        wrap_in_module: "babel-plugin-ember-template-compilation/expression-parser",
      )
      load_file_in_context(
        ctx,
        "discourse/node_modules/babel-plugin-ember-template-compilation/src/js-utils.js",
        wrap_in_module: "babel-plugin-ember-template-compilation/js-utils",
      )
      load_file_in_context(
        ctx,
        "discourse/node_modules/babel-plugin-ember-template-compilation/src/public-types.js",
        wrap_in_module: "babel-plugin-ember-template-compilation/public-types",
      )
      load_file_in_context(
        ctx,
        "discourse/node_modules/babel-import-util/src/index.js",
        wrap_in_module: "babel-import-util",
      )
      load_file_in_context(
        ctx,
        "discourse/node_modules/ember-cli-htmlbars/lib/colocated-babel-plugin.js",
      ...
      load_file_in_context(
        ctx,
        "discourse/node_modules/handlebars/dist/handlebars.js",
