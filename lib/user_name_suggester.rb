...
module UserNameSuggester
  ...
  class << self
    def suggest(*input, current_username: nil, allow_generic_fallback: true)
      name =
        input.find do |item|
    ...
    def parse_name_from_email(name_or_email)
    ...
    def find_available_username_based_on(name, current_username = nil)
      offset = nil
      i = 1
    ...
    def fix_username(name, allow_generic_fallback: true)
    ...
    def truncate(name, max_grapheme_clusters)
