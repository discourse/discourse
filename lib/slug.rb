...
module Slug
  ...
  class << self
    def for(string, default = "topic", max_length = MAX_LENGTH, method: nil)
    ...
    def prettify_slug(slug, max_length:)
    ...
    def encoded_generator(string, downcase: true)
