  ...
  def validate_each(record, attribute, value)
    ...
    if value.nil?
      ...
      record.errors.add(
        attribute,
        :too_short,
        count: SiteSetting.min_admin_password_length
      )
    elsif value.length < SiteSetting.min_password_length
      record.errors.add(
        attribute,
        :too_short,
        count: SiteSetting.min_password_length
      )
    ...
    elsif SiteSetting.block_common_passwords &&
          CommonPasswords.common_password?(value)
