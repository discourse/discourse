...
class FinalDestination
  module SSRFDetector
    ...
    class << self
      ...
      def host_bypasses_checks?(hostname)
      ...
      def lookup_and_filter_ips(name, timeout: nil)
        begin
      ...
      def lookup_ips(name, timeout: nil)
