...
class FileHelper
  class << self
    ...
    def is_supported_playable_media?(filename)
  ...
  class << self
    ...
    def optimize_image!(filename, allow_pngquant: false)
    ...
    def image_optim(allow_pngquant: false, strip_image_metadata: true)
    ...
    def supported_gravatar_extensions
    ...
    def supported_playable_media_regexp
