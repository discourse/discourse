...
def write_stylesheet(path, task_name, contents)
  header = <<~SCSS
    // DO NOT EDIT THIS FILE!!!
    // Update it by running `rake javascript:#{task_name}`
  SCSS
  ...
  basename = File.basename(path)
  output_path = "#{Rails.root}/app/assets/stylesheets/#{path}"
...
def dependencies
  [
    ...
    { source: "photoswipe/dist/photoswipe.umd.min.js", public: true },
    { source: "photoswipe/dist/photoswipe-lightbox.umd.min.js", public: true },
    { source: "photoswipe/dist/photoswipe.css", public: true },
...
task "javascript:update" => "clean_up" do
  ...
  dependencies.each do |f|
    ...
    # Also vendor PhotoSwipe CSS into our SCSS so it's compiled with core styles
    if f[:source] == "photoswipe/dist/photoswipe.css"
      photoswipe_css = File.read(src)
      write_stylesheet("common/base/photoswipe.scss", "update", photoswipe_css)
    end
  end
