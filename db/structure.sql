...
--
-- Name: linkedin_user_infos; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--

CREATE TABLE linkedin_user_infos (
    id integer NOT NULL,
    user_id integer NOT NULL,
    screen_name character varying(255) NOT NULL,
...
--
-- Name: linkedin_user_infos_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE linkedin_user_infos_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: linkedin_user_infos_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE linkedin_user_infos_id_seq OWNED BY linkedin_user_infos.id;
...
ALTER TABLE ONLY linkedin_user_infos ALTER COLUMN id SET DEFAULT nextval('linkedin_user_infos_id_seq'::regclass);
...
--
-- Name: linkedin_user_infos_pkey; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--

ALTER TABLE ONLY linkedin_user_infos
    ADD CONSTRAINT linkedin_user_infos_pkey PRIMARY KEY (id);
...
--
-- Name: index_linkedin_user_infos_on_linkedin_user_id; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE UNIQUE INDEX index_linkedin_user_infos_on_linkedin_user_id ON linkedin_user_infos USING btree (linkedin_user_id);


--
-- Name: index_linkedin_user_infos_on_user_id; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE UNIQUE INDEX index_linkedin_user_infos_on_user_id ON linkedin_user_infos USING btree (user_id);
...
INSERT INTO schema_migrations (version) VALUES ('20130306230817');