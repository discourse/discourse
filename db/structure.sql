...
--
-- Name: staff_action_logs; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--
...
--
-- Name: staff_action_logs_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE staff_action_logs_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: staff_action_logs_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE staff_action_logs_id_seq OWNED BY staff_action_logs.id;
...
ALTER TABLE ONLY staff_action_logs ALTER COLUMN id SET DEFAULT nextval('staff_action_logs_id_seq'::regclass);
...
--
-- Name: staff_action_logs_pkey; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--

ALTER TABLE ONLY staff_action_logs
    ADD CONSTRAINT staff_action_logs_pkey PRIMARY KEY (id);
...
--
-- Name: index_blocked_emails_on_email; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE UNIQUE INDEX index_blocked_emails_on_email ON screened_emails USING btree (email);


--
-- Name: index_blocked_emails_on_last_match_at; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE INDEX index_blocked_emails_on_last_match_at ON screened_emails USING btree (last_match_at);
...
--
-- Name: index_incoming_links_on_created_at_and_domain; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--
...
--
-- Name: index_staff_action_logs_on_action_and_id; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE INDEX index_staff_action_logs_on_action_and_id ON staff_action_logs USING btree (action, id);


--
-- Name: index_staff_action_logs_on_staff_user_id_and_id; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE INDEX index_staff_action_logs_on_staff_user_id_and_id ON staff_action_logs USING btree (staff_user_id, id);


--
-- Name: index_staff_action_logs_on_subject_and_id; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE INDEX index_staff_action_logs_on_subject_and_id ON staff_action_logs USING btree (subject, id);


--
-- Name: index_staff_action_logs_on_target_user_id_and_id; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE INDEX index_staff_action_logs_on_target_user_id_and_id ON staff_action_logs USING btree (target_user_id, id);
