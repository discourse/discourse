...
class AddLocaleToSearchDataPrimaryKeys < ActiveRecord::Migration[8.0]
  ...
  def up
    ...
    # Create GIN index concurrently for locale-aware searching
  ...
  def down
    ...
    execute <<~SQL
      ...
      ALTER TABLE post_search_data ALTER COLUMN locale DROP DEFAULT;
    SQL
    ...
    execute <<~SQL
      ...
      -- Make locale nullable again
      ALTER TABLE topic_search_data ALTER COLUMN locale DROP NOT NULL;
      ALTER TABLE topic_search_data ALTER COLUMN locale DROP DEFAULT;
    SQL
  end
end
