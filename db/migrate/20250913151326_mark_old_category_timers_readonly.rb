...
class MarkOldCategoryTimersReadonly < ActiveRecord::Migration[8.0]
  def up
    ...
    change_column_default :categories, :auto_close_based_on_last_post, from: true, to: nil
  ...
  def down
    ...
    change_column_default :categories, :auto_close_based_on_last_post, from: nil, to: true
