class RenamePrivatePersonal < ActiveRecord::Migration[5.1]
  ...
  def up
    ...
    setting :min_private_message_title_length,
    ...
    setting :private_email_time_window_seconds,
  ...
  def down
    ...
    setting :min_personal_message_title_length,
    ...
    setting :personal_email_time_window_seconds,
            :private_email_time_window_seconds
