...
class BackfillFontThemeableSiteSettings < ActiveRecord::Migration[7.2]
  def up
    font_themeable_site_settings = %w[base_font heading_font]

    font_themeable_site_settings.each do |setting|
