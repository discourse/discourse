...
#### [Elastic Email][ee] &mdash; 3k emails/month (100 max/day)
...
NOTE: Elastic Email currently doesn't fully integrate with Discourse's internal unsubscribe mechanism. Their policy insists on an additional UNSUBSCRIBE link at the bottom of each sent email. If this is a problem for your needs, consider using other providers. [See discussion here](https://meta.discourse.org/t/remove-or-merge-elastic-email-unsubscribe/70236).
