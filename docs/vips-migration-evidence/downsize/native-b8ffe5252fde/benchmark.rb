...
fixture_inputs = %w[static.gif tiny_animated.gif static.webp animated.webp static.avif multipage.avif dominant-color-semitransparent.png dominant-color-low-alpha-16bit.png].map do |filename|
