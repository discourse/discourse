**Set up Discourse in the cloud in under 30 minutes** with zero knowledge of Rails or Linux shell. We recommend [DigitalOcean][do], but these steps will work on any **Docker-compatible** cloud provider or local server. If you are having trouble with your install and ask for help on [meta](https://meta.discourse.org/), mention that you are following "INSTALL-cloud.md".
