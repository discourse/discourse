...
describe 'S3Helper' do
  ...
  it 'can correctly set the purge policy' do
    ...
    stub_request(:get, 'https://bob.s3.amazonaws.com/?lifecycle').to_return(
      status: 200, body: @lifecycle, headers: {}
    )

    stub_request(:put, 'https://bob.s3.amazonaws.com/?lifecycle').with do |req|
  ...
  describe '#list' do
    it 'creates the prefix correctly' do
      { 'some/bucket' => 'bucket/testing', 'some' => 'testing' }
