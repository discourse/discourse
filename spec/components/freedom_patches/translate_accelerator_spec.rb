...
describe 'translate accelerator' do
  before(:all) do
    ...
    I18n.load_path +=
      Dir["#{Rails.root}/spec/fixtures/i18n/translate_accelerator.*.yml"]
    I18n.reload!
  end
  ...
  describe 'with overrides' do
    ...
    it 'can be searched' do
      ...
      expect(I18n.search('Overwritten')).to include(
            'wat' => 'Overwritten value'
          )
    ...
    it 'returns override if it exists before falling back' do
      ...
      expect(I18n.with_locale(:ru) { I18n.t('got', default: '') }).to eq(
            'winter'
          )
