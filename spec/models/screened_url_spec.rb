...
describe ScreenedUrl do
  ...
  describe 'normalize' do
    ...
    it 'downcases domains' do
      record1 =
        described_class.new(
          valid_params.merge(
            domain: 'DuB30.com', url: 'DuB30.com/Gems/Gems-of-Power'
          )
        )
      record1.normalize
      ...
      record2 =
        described_class.new(
          valid_params.merge(domain: 'DuB30.com', url: 'DuB30.com')
        )
      record2.normalize
    ...
    it 'strips www. from domains' do
      record1 =
        described_class.new(
          valid_params.merge(
            domain: 'www.DuB30.com', url: 'www.DuB30.com/Gems/Gems-of-Power'
          )
        )
      record1.normalize
      expect(record1.domain).to eq('dub30.com')
      ...
      record3 =
        described_class.new(
          valid_params.merge(
            domain: 'www.trolls.spammers.com',
            url: 'WWW.DuB30.com/Gems/Gems-of-Power'
          )
        )
      record3.normalize
    ...
    it "doesn't modify the url argument" do
      expect { described_class.new(valid_params).normalize }.to_not change do
        valid_params[:url]
      end
    end
    ...
    it "doesn't modify the domain argument" do
      ...
      expect { described_class.new(params).normalize }.to_not change do
        params[:domain]
      end
    end
  end
  ...
  describe 'find_match' do
    it 'returns nil when there is no match' do
      expect(described_class.find_match('http://spamspot.com/buy/it')).to eq(
            nil
          )
    end
    ...
    it 'ignores case of the domain' do
      match =
        described_class.create(
          valid_params.merge(url: 'spamexchange.com/Good/Things')
        )
      expect(
        described_class.find_match('http://SPAMExchange.com/Good/Things')
      ).to eq(match)
    end
  end
  ...
  describe '#watch' do
    ...
    context 'url is already being blocked' do
      ...
      it "doesn't create a new record" do
        expect { described_class.watch(url, domain) }.to_not change do
