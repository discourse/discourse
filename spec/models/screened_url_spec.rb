...
RSpec.describe ScreenedUrl do
  ...
  describe "normalize" do
    ...
    it "downcases domains" do
      record1 =
        described_class.new(
          valid_params.merge(domain: "DuB30.com", url: "DuB30.com/Gems/Gems-of-Power"),
        )
      record1.normalize
    ...
    it "strips www. from domains" do
      record1 =
        described_class.new(
          valid_params.merge(domain: "www.DuB30.com", url: "www.DuB30.com/Gems/Gems-of-Power"),
        )
      record1.normalize
      expect(record1.domain).to eq("dub30.com")
    ...
    it "doesn't modify the url argument" do
      expect { described_class.new(valid_params).normalize }.to_not change { valid_params[:url] }
    end

    it "doesn't modify the domain argument" do
      params = valid_params.merge(domain: domain.upcase)
      expect { described_class.new(params).normalize }.to_not change { params[:domain] }
    end
  end
