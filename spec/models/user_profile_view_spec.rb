...
RSpec.describe UserProfileView do
  ...
  it "increases the user's profile view count" do
  ...
  it "does not create duplicate anonymous profile views" do
    time = Time.zone.now
  ...
  it "does not duplicate profile views or log IPs for signed-in users" do
    time = Time.zone.now
