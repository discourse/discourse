...
RSpec.describe UserProfileView do
  ...
  it "increases user's profile view count" do
  ...
  it "does not create duplicated profile view for anon user" do
    time = Time.zone.now
  ...
  it "does not create duplicated profile view or log IP for signed in user" do
    time = Time.zone.now
  ...
  it "does not create a profile view for the system user" do
