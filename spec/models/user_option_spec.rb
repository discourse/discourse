...
RSpec.describe UserOption do
  ...
  describe "defaults" do
    ...
    it "redirects to top when a reason exists" do
    ...
    it "sets the digest frequency correctly" do
    ...
    it "sets the disabled digest frequency correctly" do
    ...
    it "disables sidebar_show_count_of_new_items from its default site setting" do
    ...
    it "sets composition_mode from the default site setting" do
  ...
  describe "#mailing_list_mode" do
    ...
    it "returns false when mailing-list mode is disabled" do
    ...
    it "returns the stored value when mailing-list mode is allowed" do
  ...
  describe ".redirected_to_top" do
    ...
    it "has no reason when redirect_users_to_top_page is disabled" do
