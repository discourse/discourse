...
RSpec.describe TopicTag do
  ...
  describe "#after_create" do
    it "increases Tag#staff_topic_count and Tag#public_topic_count for a regular topic in a public category" do
      expect { topic_tag }.to change { tag.reload.staff_topic_count }.by(1).and change {
              tag.reload.public_topic_count
            }.by(1)
    end

    it "onlies increase Tag#staff_topic_count for a regular topic in a read restricted category" do
    ...
    it "increases Tag#pm_topic_count for a private message topic" do
  ...
  describe "#after_destroy" do
    it "decreases Tag#staff_topic_count and Tag#public_topic_count for a regular topic in a public category" do
      topic_tag
    ...
    it "onlies decrease Topic#topic_count for a regular topic in a read restricted category" do
    ...
    it "decreases Tag#pm_topic_count for a private message topic" do
      topic.archetype = Archetype.private_message
      topic_tag
