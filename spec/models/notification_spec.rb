...
RSpec.describe Notification do
  context "with the notification observer enabled" do
    ...
    describe "message bus" do
      ...
      it "publishes the updated unread count for each new notification" do
        messages =
    ...
    describe "private message" do
      ...
      let(:target) do
        post.topic.topic_allowed_users.reject { |a| a.user_id == post.user_id }[0].user
      end
      ...
      it "creates and rolls up private message notifications" do
    ...
    describe "#url" do
      ...
      it "returns the topic root with sort=new&collapse_replies=true for a consolidated topic-bucket notification" do
        ...
        expect(notification.url).to eq(
          "/t/#{topic.slug}/#{topic.id}?sort=new&collapse_replies=true",
        )
      end
    ...
    describe "data" do
      ...
      it "provides a data hash" do
        expect(notification.data_hash).to be_present
      end

      it "parses the JSON notification data" do
  ...
  context "with the notification observer disabled" do
    fab!(:user)
    ...
    describe ".prioritized_list" do
      ...
      fab!(:unread_regular_1) do
        create(high_priority: false, read: false, created_at: 6.minutes.ago)
      end
      ...
      fab!(:unread_regular_2) do
        create(high_priority: false, read: false, created_at: 3.minutes.ago)
      end
    ...
    describe "#recent_report" do
      ...
      describe "for a user that does not want to be notify on liked" do
        ...
        it "excludes all types of like notifications" do
          notification = pm
          regular
          liked_consolidated
      ...
      describe "#consolidate_membership_requests" do
        ...
        it "consolidates membership requests into a new notification" do
    ...
    describe ".populate_acting_user" do
      ...
      fab!(:notification3) do
        Fabricate(
          :notification,
          user: user,
          data: { mentioned_by_username: user3.username }.to_json,
        )
      end
