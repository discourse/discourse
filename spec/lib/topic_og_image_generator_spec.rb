...
RSpec.describe TopicOgImageGenerator do
  ...
  describe "#generate" do
    ...
    it "renders SVG assets without applying filters" do
      ...
      filtered_upload = generate_upload.call(filtered_svg)
      unfiltered_upload = generate_upload.call(unfiltered_svg)

      expect(filtered_upload.sha1).to eq(unfiltered_upload.sha1)
    end
  end
