...
RSpec.describe Email::Sender do
  ...
  context "with attachments" do
    ...
    it "changes the hashtags to the ref with a # symbol beforehand rather than the full name of the resource" do
      ...
      Email::Sender.new(message, :valid_type).send
      expected = <<~HTML
      <a href=\"#{Discourse.base_url}#{category.url}\" data-type=\"category\" data-ref=\"dev\" style=\"text-decoration: none; font-weight: bold; color: #006699;\"><span>#dev</span>
      HTML
