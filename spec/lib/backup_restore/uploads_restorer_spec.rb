...
RSpec.describe BackupRestore::UploadsRestorer do
  ...
  context "when currently stored locally" do
    ...
    context "when uploads previously stored locally" do
      ...
      context "with regular source and regular target" do
      ...
      context "with regular source and multisite target", type: :multisite do
        let(:source_site_type) { no_multisite }
      ...
      context "with multisite source and regular target" do
      ...
      context "with multisite source and multisite target", type: :multisite do
        let(:source_site_type) { multisite }
        let(:target_site_type) { multisite }
