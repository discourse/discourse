...
RSpec.describe TopicsFilter, "#filter_from_query_string" do
  ...
  describe "when filtering with multiple filters" do
    ...
    it "returns the right topics when query string is `status:closed tags:tag1,tag2`" do
      expect(
        TopicsFilter
          .new(guardian: Guardian.new)
  ...
  describe "when filtering with the `in` filter" do
    ...
    describe "when query string is `in:pinned`" do
      ...
      it "does not return pinned topics that have expired" do
    ...
    describe "when query string is `in:bookmarked`" do
      ...
      it "returns topics that are bookmarked" do
        expect(
          TopicsFilter
    ...
    TopicUser.notification_levels.keys.each do |notification_level|
      describe "when query string is `in:#{notification_level}`" do
        ...
        it "returns topics that the user has notification level set to #{notification_level}" do
          expect(
            TopicsFilter
              .new(guardian: Guardian.new(user))
              .filter_from_query_string("in:#{notification_level}")
    ...
    describe "when query string is `in:watching_first_post`" do
      ...
      it "works with comma-separated notification levels" do
        user_watching_topic =
          Fabricate(:topic).tap do |topic|
            TopicUser.change(
              user.id,
  ...
  describe "when filtering by categories" do
    ...
    describe "when query string is `category:category`" do
      it "returns topics from specified category and its subcategories" do
        expect(
          TopicsFilter
            .new(guardian: Guardian.new)
      ...
      it "returns topics from specified category, its subcategories and sub-subcategories" do
    ...
    describe "when query string is `category:category,category2`" do
      it "returns topics from any of the specified categories and its subcategories" do
        expect(
          TopicsFilter
            .new(guardian: Guardian.new)
    ...
    describe "when query string is `category:category =category:category2`" do
      it "returns topics and subcategory topics from category but only topics from category2" do
        expect(
          TopicsFilter
            .new(guardian: Guardian.new)
            .filter_from_query_string("category:category =category:category2")
    ...
    describe "when query string is `-category:category`" do
      it "does not return any topics from specified category or its subcategories" do
        expect(
          TopicsFilter
            .new(guardian: Guardian.new)
            .filter_from_query_string("-category:category")
    ...
    describe "when query string is `-category:category2,category`" do
      it "does not return any topics from either specified categories or their subcategories" do
        expect(
          TopicsFilter
            .new(guardian: Guardian.new)
    ...
    describe "when query string is `-category:category -category:category2-subcategory`" do
      it "does not return any topics from either specified category or their subcategories" do
        expect(
          TopicsFilter
            .new(guardian: Guardian.new)
    ...
    describe "when query string is `-=category:category`" do
      it "does not return any topics from the specified category only" do
        expect(
          TopicsFilter
            .new(guardian: Guardian.new)
            .filter_from_query_string("-=category:category")
    ...
    describe "when query string is `-=category:category,category2`" do
      it "does not return any topics from the specified categories only" do
        expect(
          TopicsFilter
            .new(guardian: Guardian.new)
            .filter_from_query_string("-=category:category,category2")
    ...
    describe "when query string is `category:category2 -=category:category2-subcategory`" do
      it "returns topics from category2 and its subcategories but not from the category2-subcategory" do
        expect(
          TopicsFilter
            .new(guardian: Guardian.new)
      ...
      describe "when max category nesting is 3" do
        ...
        it "returns topics from category2, category2's sub-categories and category2's sub-sub-categories but not from the category2-subcategory only" do
          expect(
            TopicsFilter
              .new(guardian: Guardian.new)
              .filter_from_query_string(
    ...
    describe "when `slug_generation_method` site setting is set to encoded" do
      ...
      describe "when query string is `category:日本語`" do
        it 'returns topics from category with slug "日本語"' do
          expect(
            TopicsFilter
              .new(guardian: Guardian.new)
      ...
      describe "when query string is `category:日本語:안녕하세요`" do
        ...
        it "returns topics from category with slug '안녕하세요'" do
          expect(
            TopicsFilter
              .new(guardian: Guardian.new)
  ...
  describe "when filtering by status" do
    ...
    it "onlies return topics that have been deleted when query string is `status:deleted` and user can see deleted topics" do
      expect(
        TopicsFilter
    ...
    it "ignores status filter when query string is `status:deleted` and user cannot see deleted topics" do
      expect(
        TopicsFilter
          .new(guardian: Guardian.new)
          .filter_from_query_string("status:deleted")
    ...
    it "onlies return topics that have been archived when query string is `status:archived`" do
      expect(
        TopicsFilter
          .new(guardian: Guardian.new)
    ...
    it "onlies return topics that are visible when query string is `status:listed`" do
    ...
    it "onlies return topics that are not visible when query string is `status:unlisted`" do
    ...
    it "onlies return topics that are not in any read-restricted category when query string is `status:public`" do
    ...
    describe "when query string is `status:closed status:unlisted`" do
      ...
      it "onlies return topics that have been closed and are not visible" do
        expect(
          TopicsFilter
            .new(guardian: Guardian.new)
    ...
    describe "when query string is `status:noreplies`" do
      ...
      it "onlies return topics that have no replies" do
        expect(
          TopicsFilter
            .new(guardian: Guardian.new)
    ...
    describe "when query string is `status:single_user`" do
      ...
      it "onlies return topics that have a single participant" do
        topic_ids =
          TopicsFilter
            .new(guardian: Guardian.new)
  ...
  describe "when filtering by tags" do
    ...
    describe "when filtering by a tag synonym" do
      it "returns topics tagged with the target tag when query string is `tag:synonym1`" do
        expect(
          TopicsFilter
            .new(guardian: Guardian.new)
      ...
      it "returns topics tagged with the target tag or other tags when query string is `tags:synonym1,tag2`" do
        expect(
          TopicsFilter
            .new(guardian: Guardian.new)
      ...
      it "excludes topics tagged with the target tag when query string is `-tag:synonym1`" do
        expect(
          TopicsFilter
            .new(guardian: Guardian.new)
            .filter_from_query_string("-tag:synonym1")
    ...
    it "does not filter any topics by tags when tagging is disabled" do
    ...
    describe "when query string is `tag:tag1+tag2`" do
      it "onlies return topics that are tagged with all of the specified tags" do
        expect(
          TopicsFilter
            .new(guardian: Guardian.new)
    ...
    it "onlies return topics that are tagged with all of the specified tags when query string is `tags:tag1+tag2`" do
      expect(
        TopicsFilter
          .new(guardian: Guardian.new)
          .filter_from_query_string("tags:#{tag.name}+#{tag2.name}")
    ...
    it "returns topics tagged with period-delimited tag names" do
    ...
    it "onlies return topics that are tagged with tag1 and tag2 when query string is `tags:tag1 tags:tag2`" do
    ...
    describe "when query string is `tags:front-end,back-end tags:pri-high,pri-low`" do
      ...
      it "onlies return topics that are tagged with front-end+pri-high, front-end+pri-low, back-end+pri-high, back-end+pri-low" do
      ...
      it "returns topics that are tagged with front-end+back-end+pri-low or front-end+back-end+pri-high" do
    ...
    describe "when query string is `tags:front-end tags:pri-high,pri-low`" do
      ...
      it "onlies return topics tagged with front-end and or pri-high or pri-low" do
        topic_with_front_end_pri_high = Fabricate(:topic, tags: [front_end, pri_high])
        topic_with_front_end_pri_low = Fabricate(:topic, tags: [front_end, pri_low])
    ...
    describe "when query string is `tags:tag1,tag2,tag3`" do
      it "onlies return topics that are tagged with either tag1, tag2 or tag3" do
    ...
    describe "when query string is `tags:tag1+tag2+tag3`" do
      it "onlies return topics that are tagged with tag1, tag2 and tag3" do
    ...
    it "onlies return topics that are tagged with tag1 and tag2 but not tag3 when query string is `tags:tag1 tags:tag2 -tags:tag3`" do
    ...
    it "onlies return topics that are tagged with any of the specified tags when query string is `tags:tag1,tag2`" do
      expect(
        TopicsFilter
          .new(guardian: Guardian.new)
          .filter_from_query_string("tags:#{tag.name},#{tag2.name}")
    ...
    it "does not return any topics when query string is `tags:tag1+tag2+invalid`" do
      expect(
        TopicsFilter
          .new(guardian: Guardian.new)
    ...
    it "stills filter topics by specificed tags when query string is `tags:tag1,tag2,invalid`" do
      expect(
        TopicsFilter
          .new(guardian: Guardian.new)
          .filter_from_query_string("tags:tag1,tag2,invalid")
    ...
    it "does not return any topics when query string is `tags:group-only-tag` because specified tag is hidden to user" do
      expect(
        TopicsFilter
          .new(guardian: Guardian.new)
    ...
    it "returns the right topics when query string is `tags:group-only-tag` and user has access to specified tag" do
      group.add(admin)
    ...
    it "onlies return topics that are not tagged with all of the specified tags when query string is `-tags:tag1+tag2`" do
      expect(
        TopicsFilter
          .new(guardian: Guardian.new)
    ...
    it "onlies return topics that are not tagged with any of the specified tags when query string is `-tags:tag1,tag2`" do
      expect(
        TopicsFilter
          .new(guardian: Guardian.new)
          .filter_from_query_string("-tags:tag1,tag2")
    ...
    describe "when query string is `tags:tag_name`" do
      ...
      it "returns topics even when tag contains underscore" do
        expect(
          TopicsFilter
            .new(guardian: Guardian.new)
    ...
    describe "when query string contains multiple tags with underscores" do
      ...
      it "returns topics when filtering with comma-separated underscore tags" do
        expect(
          TopicsFilter
            .new(guardian: Guardian.new)
      ...
      it "returns topics when filtering with plus-separated underscore tags" do
        expect(
          TopicsFilter
            .new(guardian: Guardian.new)
            .filter_from_query_string("tags:tag_one+tag_two")
  ...
  describe "when filtering by tag_groups" do
    ...
    it "onlies return topics that are tagged with any of the specified tag_group when query string is tag_group:tag_group_name" do
      expect(
        TopicsFilter
          .new(guardian: Guardian.new)
    ...
    it "onlies return topics that are not excluded by the specified tag_group when query string is -tag_group:tag_group_name" do
      expect(
        TopicsFilter
          .new(guardian: Guardian.new)
          .filter_from_query_string("-tag_group:#{tag_group.name}")
    ...
    it "returns the right topics when query string is `tag_group:staff_tag_group` and user has access to specified tag" do
      group.add(admin)
    ...
    it "does not return any topics when query string is `tag_group:staff_tag_group` because specified tag is hidden to user" do
      expect(
        TopicsFilter
          .new(guardian: Guardian.new)
          .filter_from_query_string("tag_group:#{staff_tag_group.name}")
  ...
  describe "when filtering by tag_groups with special characters" do
    ...
    it "filters by tag group name with spaces using double quotes" do
      expect(
        TopicsFilter
          .new(guardian: Guardian.new)
    ...
    it "filters by tag group name with spaces using single quotes" do
      expect(
        TopicsFilter
          .new(guardian: Guardian.new)
          .filter_from_query_string("tag_group:'My Tag Group'")
    ...
    it "filters by tag group name with ampersand" do
      expect(
        TopicsFilter
          .new(guardian: Guardian.new)
    ...
    it "filters by tag group name with parentheses" do
      expect(
        TopicsFilter
          .new(guardian: Guardian.new)
    ...
    it "performs case-insensitive tag group lookup" do
      expect(
        TopicsFilter
          .new(guardian: Guardian.new)
          .filter_from_query_string('tag_group:"MY TAG GROUP"')
    ...
    it "handles exclude prefix with quoted tag group names" do
      expect(
        TopicsFilter
          .new(guardian: Guardian.new)
          .filter_from_query_string('-tag_group:"My Tag Group"')
    ...
    it "maintains backward compatibility with unquoted tag group names" do
  ...
  describe "when filtering by locale" do
    ...
    describe "when query string is `locale:ja,es`" do
      it "returns topics with locale ja or es" do
        expect(
          TopicsFilter
            .new(guardian: Guardian.new)
    ...
    describe "when query string is `-locale:en`" do
      it "returns topics without locale en" do
        expect(
          TopicsFilter
            .new(guardian: Guardian.new)
            .filter_from_query_string("-locale:en")
    ...
    describe "when query string is `-locale:en,ja`" do
      it "returns topics without locale en or ja" do
        expect(
          TopicsFilter
            .new(guardian: Guardian.new)
    ...
    describe "when combining with other filters" do
      ...
      it "works with status:closed" do
        expect(
          TopicsFilter
            .new(guardian: Guardian.new)
  ...
  describe "when filtering by topic author" do
    ...
    describe "when query string is `created-by:@username`" do
      it "returns the topics created by the specified user" do
        expect(
          TopicsFilter
            .new(guardian: Guardian.new)
    ...
    describe "when query string is `created-by:@username created-by:@username2`" do
      it "returns the topics created by either of the specified users" do
        expect(
          TopicsFilter
            .new(guardian: Guardian.new)
            .filter_from_query_string(
    ...
    describe "when query string is `created-by:@username,invalid`" do
      it "onlies return the topics created by the user with the valid username" do
        expect(
          TopicsFilter
            .new(guardian: Guardian.new)
    ...
    describe "when query string is `created-by:@invalid`" do
      it "does not return any topics" do
        expect(
          TopicsFilter
            .new(guardian: Guardian.new)
    ...
    describe "when query string is `created-by:me`" do
      it "returns the topics created by the current user" do
        expect(
          TopicsFilter
            .new(guardian: Guardian.new(user))
      ...
      it "does not return any topics when there is no current user" do
        expect(
          TopicsFilter
            .new(guardian: Guardian.new)
            .filter_from_query_string("created-by:me")
  ...
  describe "when filtering by topic creator's group" do
    ...
    describe "when query string is `created-by:group1,group2`" do
      it "returns topics created by users in any of the specified groups" do
        expect(
          TopicsFilter
            .new(guardian: Guardian.new)
    ...
    describe "when query string is `created-by:group1,invalid`" do
      it "onlies return topics created by users in the valid group" do
        expect(
          TopicsFilter
            .new(guardian: Guardian.new)
    ...
    describe "with group visibility restrictions" do
      ...
      it "does not return topics when user cannot see the group" do
        expect(
          TopicsFilter
            .new(guardian: Guardian.new)
      ...
      it "returns topics when user is a member of the private group" do
  ...
  shared_examples "filtering for topics by counts" do |filter|
    describe "when query string is `#{filter}-min:1`" do
      it "onlies return topics with at least 1 #{filter}" do
        expect(
          TopicsFilter
            .new(guardian: Guardian.new)
    ...
    describe "when query string is `#{filter}-min:3`" do
      it "onlies return topics with at least 3 #{filter}" do
        expect(
          TopicsFilter
            .new(guardian: Guardian.new)
    ...
    describe "when query string is `#{filter}-max:1`" do
      it "onlies return topics with at most 1 #{filter}" do
        expect(
          TopicsFilter
            .new(guardian: Guardian.new)
    ...
    describe "when query string is `#{filter}-max:3`" do
      it "onlies return topics with at most 3 #{filter}" do
        expect(
          TopicsFilter
            .new(guardian: Guardian.new)
    ...
    describe "when query string is `#{filter}-min:1 #{filter}-max:2`" do
      it "onlies return topics with at least 1 like and at most 2 #{filter}" do
        expect(
          TopicsFilter
            .new(guardian: Guardian.new)
    ...
    describe "when query string is `#{filter}-min:3 #{filter}-min:2 #{filter}-max:1 #{filter}-max:3`" do
      it "onlies return topics with at least 2 #{filter} and at most 3 #{filter} as it ignores earlier filters which are duplicated" do
        expect(
          TopicsFilter
            .new(guardian: Guardian.new)
            .filter_from_query_string(
    ...
    describe "when query string is `#{filter}-min:invalid #{filter}-max:invalid`" do
      it "ignores the filters with invalid values" do
        expect(
          TopicsFilter
            .new(guardian: Guardian.new)
  ...
  shared_examples "filtering for topics by date column" do |filter, column, description|
    ...
    describe "when query string is `#{filter}-after:2022-01-01`" do
      it "onlies return topics with #{description} after 2022-01-01" do
        expect(
          TopicsFilter
            .new(guardian: Guardian.new)
    ...
    describe "when query string is `#{filter}-after:2023-01-1`" do
      it "onlies return topics with #{description} after 2023-01-01" do
        expect(
          TopicsFilter
            .new(guardian: Guardian.new)
    ...
    describe "when query string is `#{filter}-after:2023-6-01`" do
      it "onlies return topics with #{description} after 2023-06-01" do
        expect(
          TopicsFilter
            .new(guardian: Guardian.new)
    ...
    describe "when query string is `#{filter}-before:2023-01-01`" do
      it "onlies return topics with #{description} before 2023-01-01" do
        expect(
          TopicsFilter
            .new(guardian: Guardian.new)
    ...
    describe "when query string is `#{filter}-before:2000-01-01`" do
      it "onlies return topics with #{description} before 2000-01-01" do
        expect(
          TopicsFilter
            .new(guardian: Guardian.new)
    ...
    describe "when query string is `#{filter}-after:1`" do
      it "onlies return topics with #{description} after 1 day ago" do
        freeze_time do
    ...
    describe "when query string is `#{filter}-before:1`" do
      it "onlies return topics with #{description} before 1 day ago" do
        freeze_time do
    ...
    describe "when query string is `#{filter}-after:0`" do
      it "onlies return topics with #{description} after today" do
        freeze_time do
          _old_topic = Fabricate(:topic, column => 2.days.ago)
          recent_topic = Fabricate(:topic, column => Time.zone.now)
  ...
  describe "ordering topics filter" do
    ...
    shared_examples "ordering topics filters" do |order, order_description|
      describe "when query string is `order:#{order}`" do
        it "returns topics ordered by #{order_description} in descending order" do
          expect(
            TopicsFilter
              .new(guardian: Guardian.new)
      ...
      describe "when query string is `order:#{order}-asc`" do
        it "returns topics ordered by #{order_description} in ascending order" do
          expect(
            TopicsFilter
              .new(guardian: Guardian.new)
      ...
      describe "when query string is `order:#{order}-invalid`" do
        it "returns topics ordered by the database's default order" do
          expect(
            TopicsFilter
              .new(guardian: Guardian.new)
    ...
    describe "when ordering by user's last visit to topics" do
      ...
      describe "when query string is `order:read`" do
        it "returns topics ordered by last visited date in descending order for logged in users" do
          expect(
            TopicsFilter
              .new(guardian: Guardian.new(user))
        ...
        it "does not apply any special ordering for anonymous users" do
          topics =
            TopicsFilter
              .new(guardian: Guardian.new)
              .filter_from_query_string("order:read")
      ...
      describe "when query string is `order:read-asc`" do
        it "returns topics ordered by last visited date in ascending order for logged in users" do
          expect(
            TopicsFilter
              .new(guardian: Guardian.new(user))
    ...
    describe "composing multiple order filters" do
      ...
      describe "when query string is `order:created,views`" do
        it "returns topics ordered by creation date in descending order and then number of views in descending order" do
          expect(
            TopicsFilter
              .new(guardian: Guardian.new)
