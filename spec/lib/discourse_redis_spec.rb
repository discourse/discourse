...
RSpec.describe DiscourseRedis do
  ...
  describe "redis commands" do
    ...
    describe "pipelined / multi" do
      ...
      it "ignores pipelined commands against read-only Redis" do
      ...
      it "ignores multi commands against read-only Redis" do
    ...
    describe "when namespace is enabled" do
      ...
      it "adds the namespace to keys" do
    ...
    describe "#sadd?" do
      it "sends the command with the namespaced key to Redis" do
    ...
    describe "when namespace is disabled" do
      ...
      it "does not add a namespace to keys" do
        raw_redis.set("default:key", 1)
        raw_redis.set("test:key2", 1)
      ...
      it "ignores commands against read-only Redis" do
  ...
  describe DiscourseRedis::EvalHelper do
    it "evaluates the Lua script" do
