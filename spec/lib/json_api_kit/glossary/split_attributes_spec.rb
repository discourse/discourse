...
RSpec.describe JsonApiKit::Glossary do
  ...
  let(:split) do
    Class
      .new(JsonApiKit::VersionChange)
      .tap do |change_class|
        change_class.version "2026-09-02"
        change_class.description "The dimensions become width and height."
        change_class.resource(:pictures, &declarations)
      end
      .new(__FILE__)
  end
  let(:declarations) do
