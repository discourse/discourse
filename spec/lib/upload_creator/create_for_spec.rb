...
RSpec.describe UploadCreator, "#create_for" do
  ...
  describe "when upload is not an image" do
    ...
    it "stores the upload with the right extension" do
  ...
  describe "when image is not authorized" do
    describe "when image is for site setting" do
      ...
      it "creates the right upload" do
        upload =
  ...
  describe "when image has the wrong extension" do
    ...
    describe "for tiff format" do
      ...
      it "does not correct the coerce filename" do
  ...
  describe "pngquant" do
    ...
    it "applies pngquant to optimized images" do
      upload =
  ...
  describe "converting to jpeg" do
    ...
    it "does not store file as jpeg if it does not meet absolute byte saving requirements" do
    ...
    it "does not convert to jpeg when the image is uploaded from site setting" do
      upload =
        UploadCreator.new(
          large_file,
          large_filename,
    ...
    it "does not convert to jpeg for admin asset upload types" do
      upload =
        UploadCreator.new(
          large_file,
          large_filename,
    ...
    context "with jpeg image quality settings" do
      ...
      context "with png image quality settings" do
        ...
        it "does not convert pasted images to jpeg when png_to_jpg_quality is 100" do
          upload =
            UploadCreator.new(
              large_file,
              large_filename,
  ...
  describe "secure attachments" do
    ...
    it "marks attachments as secure" do
    ...
    it "does not mark theme uploads as secure" do
  ...
  context "when uploading to s3" do
    ...
    it "stores the file and return etag" do
    ...
    it "returns signed URL for secure attachments in S3" do
  ...
  context "with secure uploads functionality" do
    ...
    context "when SiteSetting.secure_uploads enabled" do
      ...
      context "when uploading in a public context (theme, site setting, avatar, custom_emoji, profile_background, card_background)" do
        ...
        it "does not make public-context uploads secure when login is required" do
  ...
  context "with custom emojis" do
    ...
    it "is not cropped if animated" do
      upload =
        UploadCreator.new(
          animated_file,
          animated_filename,
