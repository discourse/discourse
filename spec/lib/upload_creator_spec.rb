  ...
  describe "#create_for" do
    ...
    describe "when image is not authorized" do
      describe "when image is for site setting" do
        ...
        it "creates the expected upload" do
          upload =
    ...
    describe "when image has the wrong extension" do
      ...
      describe "for tiff format" do
        ...
        it "does not correct the coerced filename" do
    ...
    context "when uploading to s3" do
      ...
      it "stores the file and returns its ETag" do
      ...
      it "returns a signed URL for secure S3 attachments" do
      ...
      it "returns the CDN URL when enabled" do
    ...
    context "with custom emojis" do
      ...
      it "does not crop animated images" do
        upload =
          UploadCreator.new(
            animated_file,
            animated_filename,
    ...
    context "when the upload is an ICO favicon" do
      ...
      shared_examples "ICO upload conversion" do
        it "removes conversion tempfiles after an invalid ICO" do
        ...
        it "preserves odd-width bitmap colors and transparency masks" do
          expected_pixels = [
...

        {
          ...
          it "preserves the last image of #{grid_filename}" do
            upload =
      ...
      context "with libvips disabled" do
        ...
        include_examples "ICO upload conversion"
      end
