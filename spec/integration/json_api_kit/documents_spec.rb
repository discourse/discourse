  ...
  describe "a listing" do
    ...
    it "renders the first page of the listing" do
      expect(document).to eq(
        data: [topic_object(oldest, cursor: cursor_of_record(oldest))],
        included: [],
    ...
    context "when the page holds the last row of the listing" do
      ...
      it "links to no page after it" do
        expect(document).to eq(
          data: [
            topic_object(oldest, cursor: cursor_of_record(oldest)),
            topic_object(middle, cursor: cursor_of_record(middle)),
            topic_object(newest, cursor: cursor_of_record(newest)),
          ],
          included: [],
          links: links_of,
        )
    ...
    context "when the page follows another page" do
      ...
      it "links to the page before it" do
        expect(document).to eq(
          data: [topic_object(middle, cursor: cursor_of_record(middle))],
          included: [],
          links:
            links_of(
