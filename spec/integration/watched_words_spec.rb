...
RSpec.describe WatchedWord do
  ...
  context "with block" do
    ...
    it "matches UTF-8 characters" do
    ...
    it "blocks posts from an admin" do
      manager =
        NewPostManager.new(
          admin,
          raw: "Want some #{block_word.word} for cheap?",
    ...
    it "blocks posts from a moderator" do
      manager =
        NewPostManager.new(
          moderator,
          raw: "Want some #{block_word.word} for cheap?",
    ...
    it "blocks posts containing multiple blocked words" do
      manager =
        NewPostManager.new(
          moderator,
    ...
    it "blocks the word in private messages" do
      manager =
        NewPostManager.new(
          tl2_user,
          raw: "Want some #{block_word.word} for cheap?",
  ...
  context "with require_approval" do
    ...
    it "does not queue posts from an admin" do
      manager =
        NewPostManager.new(
          admin,
          raw: "My dog's name is #{require_approval_word.word}.",
    ...
    it "does not queue posts from a moderator" do
      manager =
        NewPostManager.new(
          moderator,
          raw: "My dog's name is #{require_approval_word.word}.",
  ...
  context "with flag" do
    ...
    it "flags posts containing multiple flagged words" do
      topic = Fabricate(:topic, user: tl2_user)
      post =
        Fabricate(
          :post,
    ...
    it "matches flagged words in the title" do
      should_flag_post(
        tl2_user,
    ...
    it "does not flag posts by an admin" do
    ...
    it "does not flag posts by a moderator" do
      should_not_flag_post(
        moderator,
        "I thought the #{flag_word.word} was bad.",
    ...
    it "does not flag a post when rebaking it" do
      post =
        Fabricate(
          :post,
          topic: Fabricate(:topic, user: tl2_user),
