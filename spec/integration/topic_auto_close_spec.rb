    ...
    context 'jobs may be queued' do
      ...
      context 'category has a default auto-close' do
        ...
        it 'should schedule the topic to auto-close' do
          ...
          expect(
            topic.public_topic_timer.execute_at
          ).to be_within_one_second_of(2.hours.from_now)
        ...
        context 'topic was created by staff user' do
          ...
          let(:staff_topic) do
            Fabricate(:topic, user: admin, category: category)
          end
          ...
          it 'should schedule the topic to auto-close' do
            ...
            expect(topic_status_update.execute_at).to be_within_one_second_of(
                  2.hours.from_now
                )
        ...
        context 'topic was created by a non-staff user' do
          ...
          let(:regular_user_topic) do
            Fabricate(:topic, user: regular_user, category: category)
          end
