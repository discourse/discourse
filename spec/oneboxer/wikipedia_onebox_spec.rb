...
describe Discourse::Oneboxer::WikipediaOnebox do
  ...
  it "generates the expected onebox for Wikipedia" do
    o = Discourse::Oneboxer::WikipediaOnebox.new('http://en.wikipedia.org/wiki/Ruby')
...
<div class='onebox-result'>
  ...
  <div class='onebox-result-body'>
    ...
    <h3><a href="http://en.wikipedia.org/wiki/Ruby" target="_blank"></a></h3>
