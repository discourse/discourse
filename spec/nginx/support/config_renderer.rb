...
module Nginx
  module Support
    class ConfigRenderer
      ...
      attr_reader :tmpdir, :sample_path, :upstream_port, :listen_port, :public_path

      def initialize(tmpdir:, sample_path:, upstream_port:, listen_port:, public_path: nil)
        @tmpdir = tmpdir
        @sample_path = sample_path
        @upstream_port = upstream_port
        @listen_port = listen_port
        @public_path = (public_path || File.join(tmpdir, "public")).to_s
      end
      ...
      def rewrite_sample(source)
        source =
          source
            ...
            .gsub("/var/www/discourse/public", public_path)
