...
describe SearchController do
  context 'integration' do
    ...
    it 'returns a 400 error if you search for null bytes' do
      ...
      get '/search/query.json', params: { term: term, include_blurb: true }
    ...
    it 'can search correctly' do
      ...
      get '/search/query.json', params: { term: 'awesome', include_blurb: true }
    ...
    it 'performs the query with a type filter' do
      ...
      get '/search/query.json',
          params: { term: user.username, type_filter: 'topic' }
      ...
      get '/search/query.json',
          params: { term: user.username, type_filter: 'user' }
    ...
    context 'searching by topic id' do
      it 'should not be restricted by minimum search term length' do
        ...
        get '/search/query.json',
            params: {
              term: post.topic_id, type_filter: 'topic', search_for_id: true
            }
      ...
      it 'should return the right result' do
        ...
        get '/search/query.json',
            params: {
              term: my_post.topic_id, type_filter: 'topic', search_for_id: true
            }
    ...
    context 'with a user' do
      ...
      it "raises an error if the user can't see the context" do
        get '/search/query.json',
            params: {
              term: 'test',
              search_context: { type: 'private_messages', id: user.username }
            }
  ...
  context '#click' do
    ...
    it 'records the click for an anonymous user' do
      ...
      _, search_log_id =
        SearchLog.log(
          term: SecureRandom.hex, search_type: :header, ip_address: ip_address
        )
