...
RSpec.describe SuperAdmin::SiteTextsController do
  fab!(:admin)
  fab!(:moderator)
  fab!(:user)
  ...
  describe "#index" do
    context "when logged in as an admin" do
      ...
      it "does not return restricted keys in search results" do
        ...
        expect(returned_ids & SuperAdmin::SiteTextsController::RESTRICTED_KEYS.to_a).to be_empty
  ...
  describe "#show" do
    context "when logged in as an admin" do
      ...
      it "returns 403 for restricted keys" do
        SuperAdmin::SiteTextsController::RESTRICTED_KEYS.each do |key|
          get "/admin/customize/site_texts/#{key}.json", params: { locale: }
