  ...
  context "when logged in" do
    context "as normal user" do
      ...
      context "with notifications for inaccessible topics" do
        ...
        it "filters inaccessible topics from recent notifications" do
        ...
        it "filters inaccessible topics from all notifications" do
          SiteSetting.navigation_menu = "sidebar"
      ...
      context "with notifications for disabled badges" do
        ...
        it "filters disabled badges from recent notifications" do
          get "/notifications.json", params: { recent: true }
        ...
        it "filters recent badge notifications when badges are disabled" do
        ...
        it "filters disabled badges from all notifications" do
          get "/notifications.json"
        ...
        it "filters all badge notifications when badges are disabled" do
          SiteSetting.enable_badges = false
