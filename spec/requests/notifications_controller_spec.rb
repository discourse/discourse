...
RSpec.describe NotificationsController do
  context "when logged in" do
    context "as normal user" do
      ...
      it "succeeds for recent" do
        get "/notifications", params: { recent: true }
        expect(response.status).to eq(200)
      end

      it "succeeds for history" do
      ...
      it "does not mark notifications as viewed if silent param is present" do
        expect(user.reload.unread_notifications).to eq(1)
        expect(user.reload.total_unread_notifications).to eq(1)
      ...
      it "does not mark notifications as viewed in readonly mode" do
      ...
      context "when navigation menu settings is non-legacy" do
        ...
        it "does not bump last seen reviewable in readonly mode" do
        ...
        it "does not bump last seen reviewable if the user can't see reviewables" do
          expect {
            get "/notifications.json", params: { recent: true, bump_last_seen_reviewable: true }
            expect(response.status).to eq(200)
          }.not_to change { user.reload.last_seen_reviewable_id }
        ...
        it "does not bump last seen reviewable if the silent param is present" do
          user.update!(admin: true)
        ...
        it "does not bump last seen reviewable if the bump_last_seen_reviewable param is not present" do
          user.update!(admin: true)
      ...
      context "with notifications for inaccessible topics" do
        ...
        it "doesn't include recent notifications from topics the user isn't allowed to see" do
        ...
        it "doesn't include historical notifications from topics the user isn't allowed to see" do
          SiteSetting.navigation_menu = "sidebar"
      ...
      context "with notifications for disabled badges" do
        ...
        it "filters recent badge notifications for badges that are disabled" do
          get "/notifications.json", params: { recent: true }
        ...
        it "filters all recent badge notifications when `enable_badges` is false" do
        ...
        it "filters historical badge notifications for badges that are disabled" do
          get "/notifications.json"
        ...
        it "filters all historical badge notifications when `enable_badges` is false" do
          SiteSetting.enable_badges = false
