...
describe Admin::PermalinksController do
  ...
  describe '#index' do
    ...
    it 'filters url and external url both' do
      ...
      Fabricate(
        :permalink,
        url: '/discourse/98', external_url: 'http://wikipedia.org'
      )
      Fabricate(
        :permalink,
        url: '/discuss/topic/45', external_url: 'http://discourse.org'
      )
      Fabricate(
        :permalink,
        url: '/discuss/topic/76', external_url: 'http://try.discourse.org'
      )
