  ...
  context 'while logged in as an admin' do
    ...
    describe '#index' do
      it 'returns valid info' do
        ...
        locale =
          json['site_settings'].select { |s| s['setting'] == 'default_locale' }
    ...
    describe '#update' do
      ...
      it 'sets the value when the param is present' do
        put '/admin/site_settings/test_setting.json',
            params: { test_setting: 'hello' }
        expect(response.status).to eq(200)
      ...
      describe 'upload site settings' do
        it 'can remove the site setting' do
          ...
          put '/admin/site_settings/test_upload.json',
              params: { test_upload: nil }
        ...
        it 'can reset the site setting to the default' do
          ...
          put '/admin/site_settings/test_upload.json',
              params: { test_upload: default_upload.url }
      ...
      it 'logs the change' do
        ...
        expect do
          ...
          UserHistory.where(action: UserHistory.actions[:change_site_setting])
            .count
        end
          .by(1)
      ...
      it 'does not allow changing of hidden settings' do
        ...
        put '/admin/site_settings/hidden_setting.json',
            params: { hidden_setting: 'not allowed' }
