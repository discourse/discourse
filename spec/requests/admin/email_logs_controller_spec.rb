...
RSpec.describe Admin::EmailLogsController do
  ...
  describe "#sent" do
    ...
    context "when logged in as an admin" do
      ...
      it "filters by smtp_transaction_response" do
      ...
      context "when type is group_smtp and filter param is address" do
        ...
        it "filters across recipient and CC addresses" do
  ...
  describe "#skipped" do
    ...
    context "when logged in as an admin" do
      ...
      it "returns skipped email logs" do
      ...
      context "when filtered by username" do
        it "returns the matching username response" do
      ...
      context "when filtered by address" do
        it "returns the matching address response" do
  ...
  describe "#incoming_from_bounced" do
    context "when logged in as an admin" do
      ...
      context "when bounced email log entry exists" do
        ...
        it "returns an incoming email sent to a VERP notification address" do
          Fabricate(
            :incoming_email,
            is_bounce: true,
            error: error_message,
        ...
        it "returns an incoming email sent to a reply-by-email subdomain" do
