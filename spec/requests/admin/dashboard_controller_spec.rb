...
RSpec.describe Admin::DashboardController do
  ...
  describe "#bulk_reports" do
    ...
    let(:raising_provider) do
      Class.new(AdminDashboard::Reports::SourceProvider) do
        class << self
          def source_name = "raising_source"
    ...
    let(:alt_provider) do
      Class.new(AdminDashboard::Reports::SourceProvider) do
        class << self
          ...
          def resolve_many(_identifiers, guardian:)
            {}
          end
        end
      end
    ...
    let(:fake_provider) do
      Class.new(AdminDashboard::Reports::SourceProvider) do
        class << self
          ...
          def accessible_ids(identifiers, guardian:)
