  ...
  describe "#email_login" do
    ...
    context "with valid token" do
      ...
      context "when user has only security key enabled" do
        ...
        it "denies login with an unavailable TOTP method" do
          post "/session/email-login/#{email_token.token}.json",
               params: {
        ...
        it "denies login with invalid security key credentials" do
          post "/session/email-login/#{email_token.token}.json",
               params: {
                 second_factor_token: {
                   signature: "bad_sig",
  ...
  describe "#create" do
    ...
    context "when email is confirmed" do
      ...
      context "when a user has security key-only 2FA login" do
        ...
        it "denies login with a malformed security key credential" do
          post "/session.json",
               params: {
                 login: user.username,
                 password: "myawesomepassword",
        ...
        it "denies login with an unknown security key credential" do
          post "/session.json",
               params: {
                 login: user.username,
                 password: "myawesomepassword",
