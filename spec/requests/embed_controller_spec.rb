...
describe EmbedController do
  ...
  context 'with a host' do
    ...
    it 'includes CSS from embedded_scss field' do
      ...
      css_link =
        html.at('link[data-target=embedded_theme]').attribute('href').value
    ...
    context 'success' do
      ...
      it 'tells the topic retriever to work when no previous embed is found' do
        ...
        get '/embed/comments',
            params: { embed_url: embed_url }, headers: headers
      end
      ...
      it 'displays the right view' do
        ...
        get '/embed/comments',
            params: { embed_url: embed_url_secure }, headers: headers
      ...
      it 'provides the topic retriever with the discourse username when provided' do
        TopicRetriever.expects(:new).with(
          embed_url,
          has_entry(author_username: discourse_username)
        )

        get '/embed/comments',
            params: {
              embed_url: embed_url, discourse_username: discourse_username
            },
            headers: headers
      end
    end
  ...
  context 'with multiple hosts' do
    before do
      ...
      Fabricate(
        :embeddable_host,
        host: 'https://example.com/1234', class_name: 'example'
      )
    end
