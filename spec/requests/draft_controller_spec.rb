...
describe DraftController do
  ...
  it 'saves a draft on update' do
    ...
    post '/draft.json',
         params: { draft_key: 'xyz', data: { my: 'data' }.to_json, sequence: 0 }
  ...
  it 'checks for an conflict on update' do
    ...
    post '/draft.json',
         params: {
           ...
           draft_key: 'topic',
           sequence: 0,
           data: { postId: post.id, originalText: post.raw, action: 'edit' }
             .to_json
         }
    ...
    post '/draft.json',
         params: {
           ...
           sequence: 0,
           data: {
             postId: post.id, originalText: 'something else', action: 'edit'
           }
             .to_json
         }
