...
RSpec.describe Jobs::CleanUpInactiveUsers do
  it 'should clean up new users that have been inactive' do
    ...
    user =
      Fabricate(
        :user,
        last_seen_at: 5.days.ago, trust_level: TrustLevel.levels[:newuser]
      )
    ...
    Fabricate(
      ...
      user:
        Fabricate(
          :user,
          trust_level: TrustLevel.levels[:newuser], last_seen_at: 5.days.ago
        )
    )
      .user
    ...
    Fabricate(
      :user,
      trust_level: TrustLevel.levels[:newuser], last_seen_at: 2.days.ago
    )
