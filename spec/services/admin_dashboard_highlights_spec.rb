...
describe AdminDashboardHighlights do
  describe ".build" do
    ...
    it "caches KPI reports for the current viewer" do
      described_class.build(guardian: guardian, start_date: "2026-04-01", end_date: "2026-04-28")
      ...
      cached =
        Report.find_cached(
          "signups",
          guardian: guardian,
          start_date: Time.zone.parse("2026-04-01"),
          end_date: Time.zone.parse("2026-04-28").end_of_day,
    ...
    describe "per-report caching" do
      ...
      it "recomputes when the date range changes" do
        ...
        Report.stubs(:cache)
        described_class.build(guardian: guardian, start_date: "2026-03-01", end_date: "2026-03-31")
      end
