  ...
  describe 'word_matches_for_action?' do
    ...
    context 'with watched words' do
      ...
      it 'is falsey without a match' do
        expect(
          WordWatcher.new('No liquorice for me, thanks...')
      ...
      it 'finds at start of string' do
        m =
          WordWatcher.new("#{anise.word} is garbage").word_matches_for_action?(
            :require_approval
          )
        expect(m[1]).to eq(anise.word)
      end
      ...
      it 'finds at end of string' do
        m =
          WordWatcher.new("who likes #{anise.word}").word_matches_for_action?(
            :require_approval
          )
        expect(m[1]).to eq(anise.word)
      end
      ...
      it 'finds non-letters in place of letters' do
        ...
        m =
          WordWatcher.new('This co(onut is delicious.')
            .word_matches_for_action?(:require_approval)
      ...
      it 'handles * for wildcards' do
        ...
        m =
          WordWatcher.new('I acknowledge you.').word_matches_for_action?(
            :require_approval
          )
      ...
      context 'word boundary' do
        it 'handles word boundary' do
          ...
          expect(
            WordWatcher.new('I Love, bananas.').word_matches_for_action?(
              :require_approval
            )[
              1
            ]
          ...
          expect(
            WordWatcher.new('I LOVE; apples.').word_matches_for_action?(
              :require_approval
            )[
              1
            ]
          ...
          expect(
            WordWatcher.new('love: is a thing.').word_matches_for_action?(
              :require_approval
            )[
              1
            ]
          ...
          expect(
            WordWatcher.new('I love. oranges').word_matches_for_action?(
              :require_approval
            )[
              1
            ]
          ...
          expect(
            WordWatcher.new('I :love. pineapples').word_matches_for_action?(
              :require_approval
            )[
              1
            ]
          ...
          expect(
            WordWatcher.new('peace ,love and understanding.')
              .word_matches_for_action?(:require_approval)[
              1
            ]
          ).to eq('love')
      ...
      context 'emojis' do
        it 'handles emoji' do
          ...
          m =
            WordWatcher.new('Lots of emojis here :joy:')
              .word_matches_for_action?(:require_approval)
        ...
        it 'handles unicode emoji' do
          ...
          m =
            WordWatcher.new('Halloween party! 🎃').word_matches_for_action?(
              :require_approval
            )
          expect(m[1]).to eq('🎃')
        end
        ...
        it 'handles emoji skin tone' do
          ...
          m =
            WordWatcher.new('To Infinity and beyond! 🚀 :woman:t5:')
              .word_matches_for_action?(:require_approval)
      ...
      context 'regular expressions' do
        ...
        it 'supports regular expressions on word boundaries' do
          Fabricate(
            :watched_word,
            word: /\btest\b/, action: WatchedWord.actions[:block]
          )
          m =
            WordWatcher.new('this is not a test.').word_matches_for_action?(
              :block
            )
        ...
        it 'supports regular expressions as a site setting' do
          ...
          m =
            WordWatcher.new('Evil Trout is cool').word_matches_for_action?(
              :require_approval
            )
          expect(m[1]).to eq('Trout')
          m =
            WordWatcher.new('Evil Troot is cool').word_matches_for_action?(
              :require_approval
            )
          expect(m[1]).to eq('Troot')
          m =
            WordWatcher.new('trooooooooot').word_matches_for_action?(
              :require_approval
            )
        ...
        it 'support uppercase' do
          ...
          m =
            WordWatcher.new('Amazing place').word_matches_for_action?(
              :require_approval
            )
          expect(m).to be_nil
          m =
            WordWatcher.new('Amazing applesauce').word_matches_for_action?(
              :require_approval
            )
