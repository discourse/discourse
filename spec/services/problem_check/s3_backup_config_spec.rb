  ...
  describe ".call" do
    ...
    context "when S3 backups are enabled" do
      ...
      context "when not configured to use IAM profile" do
        ...
        it "accepts complete credentials" do
        ...
        it "reports the missing S3 backup credentials" do
          SiteSetting.stubs(s3_access_key_id: "foo")
        ...
        it "reports the missing S3 backup bucket" do
          SiteSetting.stubs(s3_access_key_id: "foo")
          SiteSetting.stubs(s3_secret_access_key: "bar")
          SiteSetting.stubs(s3_backup_bucket: nil)
