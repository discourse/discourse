  ...
  describe "#call" do
    ...
    context "when already registered but force is true" do
      ...
      context "when registration succeeds" do
        ...
        it "omits logo fields from registration when the site has no logo URLs" do
          SiteSetting.logo = ""
        ...
        it "omits the description from registration when the site has none" do
