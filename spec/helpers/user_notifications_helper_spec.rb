...
RSpec.describe UserNotificationsHelper do
  ...
  describe "#logo_url" do
    describe "local store" do
      ...
      it "returns the local upload URL" do
      ...
      describe "when cdn path is configured" do
        ...
        it "returns the local CDN upload URL" do
          expect(helper.logo_url).to eq(
    ...
    describe "s3 store" do
      ...
      it "returns the S3 upload URL" do
        expect(helper.logo_url).to eq(
      ...
      describe "when global cdn path is configured" do
        it "preserves the S3 upload URL when a global CDN is configured" do
      ...
      describe "when cdn path is configured" do
        ...
        it "returns the S3 CDN upload URL" do
