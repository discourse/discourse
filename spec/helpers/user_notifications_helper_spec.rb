...
describe UserNotificationsHelper do
  describe '#email_excerpt' do
    ...
    it "doesn't count emoji images" do
      with_emoji =
        "<p>Hi <img src=\"/images/emoji/twitter/smile.png?v=#{Emoji::EMOJI_VERSION}\" title=\":smile:\" class=\"emoji\" alt=\":smile:\"></p>"
  ...
  describe '#logo_url' do
    describe 'local store' do
      ...
      describe 'when cdn path is configured' do
        before do
          GlobalSetting.expects(:cdn_url).returns('https://some.localcdn.com')
            .at_least_once
        end
