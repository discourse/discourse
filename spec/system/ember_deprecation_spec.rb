...
describe "JS Deprecation Handling", type: :system do
  ...
  it "shows warnings to admins for critical deprecations" do
    ...
    page.execute_script <<~JS
      ...
      const { CRITICAL_DEPRECATIONS } = require("discourse/services/deprecation-warning-handler");
  ...
  it "can show warnings triggered during initial render" do
    ...
    t.set_field(
      ...
      value: <<~JS,
        ...
        import { CRITICAL_DEPRECATIONS } from "discourse/services/deprecation-warning-handler";
