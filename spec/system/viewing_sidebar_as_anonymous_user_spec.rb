...
describe "Viewing sidebar as anonymous user" do
  ...
  describe "when viewing the tags section" do
    ...
    it "does not display the tags section when tagging has been disabled" do
    ...
    it "does not display the tags section when site has no top tags and `default_navigation_menu_tags` site setting has not been set" do
      Tag.delete_all
    ...
    it "displays the site's top tags when `default_navigation_menu_tags` site setting has not been set" do
      visit("/latest")
    ...
    it "displays the site's top tags when `default_navigation_menu_tags` site setting has been set but the tags configured are hidden to the user" do
    ...
    it "displays the tags configured in `default_navigation_menu_tags` site setting when it has been set" do
