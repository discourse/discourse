...
describe "Admin Customize Themes Config Area Page", type: :system do
  ...
  describe "checking for updates" do
    ...
    let(:url) { MockGitImporter.register("https://example.com/discourse-component-tt1.git", repo) }
  ...
  describe "performing an update" do
    ...
    let(:url) { MockGitImporter.register("https://example.com/discourse-component-tt2.git", repo) }
