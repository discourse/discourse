...
RSpec.describe Migrations::Tooling::Schema::DSL::Differ, :rails do
  ...
  describe "#diff" do
    it "returns empty result when everything matches" do
      ...
      Migrations::Tooling::Schema.table(:users) { include :id, :username }
    ...
    it "does not report copy_structure_from source tables as unknown" do
      ...
      Migrations::Tooling::Schema.table :user_archive do
    ...
    it "excludes ignored tables from unknown" do
      ...
      Migrations::Tooling::Schema.table(:users) { include :id }
      Migrations::Tooling::Schema.ignored { table :posts, "not needed" }
    ...
    it "detects missing tables" do
      ...
      Migrations::Tooling::Schema.table(:users) { include :id }
      Migrations::Tooling::Schema.table(:posts) { include :id }
    ...
    it "does not report synthetic tables as missing" do
      ...
      Migrations::Tooling::Schema.table(:log_entries) do
        synthetic!
    ...
    it "detects missing columns" do
      ...
      Migrations::Tooling::Schema.table(:users) { include :id, :username, :bio }
    ...
    it "accounts for globally ignored columns" do
      ...
      Migrations::Tooling::Schema.conventions { ignore_columns :updated_at }
      Migrations::Tooling::Schema.table(:users) { include :id, :username }
    ...
    it "skips column diff for tables missing from database" do
      ...
      Migrations::Tooling::Schema.table(:users) { include :id, :nonexistent_col }
    ...
    it "ignore_plugin_columns! with specific plugin names only ignores those plugins" do
      ...
      Migrations::Tooling::Schema.ignored { table :unused_table, "placeholder" }
