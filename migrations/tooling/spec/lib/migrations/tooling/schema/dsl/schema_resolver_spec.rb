...
RSpec.describe Migrations::Tooling::Schema::DSL::SchemaResolver, :rails do
  after { Migrations::Tooling::Schema.reset! }

  def build_schema(tables: {}, enums: {}, conventions: nil)
    schema = Migrations::Tooling::Schema
  ...
  describe "#resolve" do
    it "resolves a simple table with all DB columns" do
      ...
      expect(result).to be_a(Migrations::Tooling::Schema::Definition)
