  ...
  describe "#validate" do
    ...
    describe "column configuration validation" do
      context "when included columns are configured" do
        ...
        it "adds no error when some columns are included" do
        ...
        it "adds no error when columns are either included or modified" do
        ...
        it "adds no error when some columns are either included or modified except for globally excluded columns" do
        ...
        it "adds no error when some columns are included and additional columns are added" do
          users_columns[:include] = %w[id username]
