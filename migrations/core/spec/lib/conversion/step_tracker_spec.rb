...
RSpec.describe Migrations::Conversion::StepTracker do
  ...
  describe "#stats" do
    it "returns correct stats" do
      expect(tracker.stats).to eq(
        Migrations::Conversion::StepStats.new(progress: 1, warning_count: 0, error_count: 0),
      )
      ...
      expect(tracker.stats).to eq(
        Migrations::Conversion::StepStats.new(progress: 5, warning_count: 2, error_count: 3),
      )
    end
  end
