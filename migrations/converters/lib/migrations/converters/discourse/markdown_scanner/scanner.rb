    ...
    module Discourse
      module MarkdownScanner
        ...
        class Scanner
          ...
          # characters — a bare internal link like `/t/5` carries none — contributes
          # its own alternative via {Detectors::Base#presence_pattern}, otherwise its
          # posts would wrongly skip the walk.
          ...
          def scan_input
            ...
            while @pos < length
              ...
              if index > @pos
                ...
                @pos = index
                # The jumped-over run holds no stop character, so it holds no newline
                # — consuming it always lands us mid-line, never at a line start.
                @line_start = false
              end
